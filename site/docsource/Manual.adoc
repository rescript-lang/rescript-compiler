...
[NOTE]
.Document under http://bloomberg.github.io/bucklescript/Manual.html[_bloomberg.github.io_] matches with https://github.com/bloomberg/bucklescript[master branch].
====

They are also  distributed as a single HTML(`docs/Manual.html`) together with your <<Installation>> (with the exact version).
...
include::./Suggestions-on-writing-idiomatic-bucklescript-code.adoc[]
