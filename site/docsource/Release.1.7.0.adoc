...
BuckleScript employs fairly http://bucklescript.github.io/bucklescript/js-demo/#Curry_Optimization[advanced optimizations] for curried calling convention, however, the most efficient code is efficient code not relying on optimizations.
