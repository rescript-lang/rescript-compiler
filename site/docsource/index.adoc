...
users can try the compiler in the https://bucklescript.github.io/bucklescript-playground/js-demo[browser] and imagine how fast it would be for native backend.
