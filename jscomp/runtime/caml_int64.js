...
var caml_obj_runtime_1 = require('./caml_obj_runtime');
...
exports.caml_int64_compare = caml_int64_compare;
...
exports.caml_int64_neg = caml_int64_neg;
...
exports.caml_int64_add = caml_int64_add;
...
exports.caml_int64_sub = caml_int64_sub;
...
exports.caml_int64_mul = caml_int64_mul;
...
exports.caml_int64_shift_left = caml_int64_shift_left;
...
exports.caml_int64_shift_right_unsigned = caml_int64_shift_right_unsigned;
...
exports.caml_int64_shift_right = caml_int64_shift_right;
...
function caml_int64_udivmod(x, y) {
    var offset = 0;
    var modulus = caml_obj_runtime_1.caml_obj_dup(x);
    var divisor = caml_obj_runtime_1.caml_obj_dup(y);
...
exports.caml_int64_div = caml_int64_div;
...
exports.caml_int64_mod = caml_int64_mod;
//Provides: caml_int64_of_int32 const
function caml_int64_of_int32(x) {
    return [255, x & 0xffffff, (x >> 24) & 0xffffff, (x >> 31) & 0xffff];
}
exports.caml_int64_of_int32 = caml_int64_of_int32;
exports.caml_int64_of_int = caml_int64_of_int32;
exports.caml_int64_of_nativeint = caml_int64_of_int32;
//Provides: caml_int64_to_int32 const
function caml_int64_to_int32(x) {
    return x[1] | (x[2] << 24);
}
exports.caml_int64_to_int32 = caml_int64_to_int32;
exports.caml_int64_to_int = caml_int64_to_int32;
exports.caml_int64_to_nativeint = caml_int64_to_int32;
//Provides: caml_int64_to_float const
function caml_int64_to_float(x) {
    return ((x[3] << 16) * Math.pow(2, 32) + x[2] * Math.pow(2, 24)) + x[1];
}
exports.caml_int64_to_float = caml_int64_to_float;
...
exports.caml_int64_of_float = caml_int64_of_float;
function caml_int64_format(fmt, x) {
    var f = caml_format_1.parse_format(fmt);
    ...
    if (f.prec >= 0) {
        ...
        if (n > 0)
            buffer = caml_utils_1.repeat(n, '0') + buffer;
    }
    return caml_format_1.finish_formatting(f, buffer);
}
exports.caml_int64_format = caml_int64_format;
function caml_int64_of_string(s) {
    var r = caml_format_1.parse_sign_and_base(s);
    var i = r[0], sign = r[1], base = r[2];
    var base64 = caml_int64_of_int32(base);
    var threshold = caml_int64_udivmod([255, 0xffffff, 0xfffffff, 0xffff], base64)[1];
    var c = s.charCodeAt(i);
    var d = caml_format_1.parse_digit(c);
    if (d < 0 || d >= base)
