...
let caml_lex_engine_aux: (
  lex_tables,
  int,
  lexbuf,
  exn,
) => int = %raw(`function (tbl, start_state, lexbuf, exn){
...
let lex_engine: (lex_tables, int, lexbuf) => int = (tbls, i, buf) =>
...
let new_lex_engine: (lex_tables, int, lexbuf) => int = (tbl, i, buf) =>
