...
let caml_parse_engine : parse_tables -> parser_env -> (*Parsing.parser_input *)Caml_obj_extern.t -> Caml_obj_extern.t -> Caml_obj_extern.t = fun%raw tables (* parser_table *) env (* parser_env *) cmd (* parser_input*) arg (* Caml_obj_extern.t*) -> {|
    ...
    //var reduce = 10;
    // Parsing.parser_env
    var env_s_stack = 'env_s_stack'; // array
    var env_v_stack = 'env_v_stack'; // array
    var env_symb_start_stack = 'env_symb_start_stack'; // array
    var env_symb_end_stack = 'env_symb_end_stack'; // array
    var env_stacksize = 'env_stacksize';
    var env_stackbase = 'env_stackbase';
    var env_curr_char = 'env_curr_char';
    var env_lval = 'env_lval'; // Caml_obj_extern.t
    var env_symb_start = 'env_symb_start'; // position
    var env_symb_end = 'env_symb_end'; // position
    var env_asp = 'env_asp';
    var env_rule_len = 'env_rule_len';
    var env_rule_number = 'env_rule_number';
    var env_sp = 'env_sp';
    var env_state = 'env_state';
    var env_errflag = 'env_errflag';
    // Parsing.parse_tables
    // var _tbl_actions = 1;
    var tbl_transl_const = 'tbl_transl_const'; // array
    var tbl_transl_block = 'tbl_transl_block'; // array
    var tbl_lhs = 'tbl_lhs';
    var tbl_len = 'tbl_len';
    var tbl_defred = 'tbl_defred';
    var tbl_dgoto = 'tbl_dgoto';
    var tbl_sindex = 'tbl_sindex';
    var tbl_rindex = 'tbl_rindex';
    var tbl_gindex = 'tbl_gindex';
    var tbl_tablesize = 'tbl_tablesize';
    var tbl_table = 'tbl_table';
    var tbl_check = 'tbl_check';
