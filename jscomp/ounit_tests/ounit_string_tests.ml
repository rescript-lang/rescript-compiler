...
let suites =
  ...
  >::: [ ( __LOC__
       ...
       ; ( __LOC__
         ...
         OUnit.assert_bool __LOC__
         @@ List.for_all
              (fun x -> Ext_string.is_valid_source_name x = Good)
              [ "x.ml"; "x.mli"; "x.re"; "x.rei"; "A_x.ml"; "ab.ml"; "a_.ml"
              ; "a__.ml"; "ax.ml" ] ;
         OUnit.assert_bool __LOC__ @@ not
         @@ List.exists
              (fun x -> Ext_string.is_valid_source_name x = Good)
              [ ".re"; ".rei"; "..re"; "..rei"; "..ml"; ".mll~"; "...ml"
              ; "_.mli"; "_x.ml"; "__.ml"; "__.rei"; ".#hello.ml"
              ; ".#hello.rei"; "a-.ml"; "a-b.ml"; "-a-.ml"; "-.ml" ] )
       ; ( __LOC__
         >:: fun _ ->
         OUnit.assert_bool __LOC__
       ...
       ; (* __LOC__ >:: begin fun _ -> Ext_string.starts_with_and_number
            "js_fn_mk_01" ~offset:0 "js_fn_mk_" =~ 1 ;
            Ext_string.starts_with_and_number "js_fn_run_02" ~offset:0
            "js_fn_mk_" =~ -1 ; Ext_string.starts_with_and_number "js_fn_mk_03"
            ~offset:6 "mk_" =~ 3 ; Ext_string.starts_with_and_number
            "js_fn_mk_04" ~offset:6 "run_" =~ -1;
            Ext_string.starts_with_and_number "js_fn_run_04" ~offset:6 "run_"
            =~ 4; Ext_string.(starts_with_and_number "js_fn_run_04" ~offset:6
            "run_" = 3) =~ false end; *)
         ( __LOC__
         >:: fun _ ->
       ...
       ; (* __LOC__ >:: begin fun _ -> Ext_string.digits_of_str "11_js"
            ~offset:0 2 =~ 11 end; *)
         ( __LOC__
         >:: fun _ ->
         OUnit.assert_bool __LOC__
       ...
       ; ( __LOC__
         ...
         let slow_compare x y =
           ...
           else Pervasives.compare x_len y_len in
         let same_sign x y =
           if x = 0 then y = 0 else if x < 0 then y < 0 else y > 0 in
         for i = 0 to 3000 do
       ...
       ; ( __LOC__
         ...
         OUnit.assert_bool __LOC__ (Ext_string.no_slash_idx_from "xxx/g/" 4 = 5) ;
         OUnit.assert_bool __LOC__ (Ext_string.no_slash_idx_from "xxx/g/" 3 = 3) ;
         OUnit.assert_bool __LOC__
       ...
       ; ( __LOC__
         >:: fun _ -> Ext_namespace.namespace_of_package_name "xx" =~ "Xx" )
       ; ( __LOC__
         >:: fun _ ->
       ...
       ; ( __LOC__
         >:: fun _ ->
         Ext_namespace.js_name_of_basename false "a-b" =~ "a.js" ;
         Ext_namespace.js_name_of_basename false "a-" =~ "a.js" ;
         Ext_namespace.js_name_of_basename false "a--" =~ "a-.js" ;
         Ext_namespace.js_name_of_basename false "AA-b" =~ "AA.js" ;
         Ext_namespace.js_name_of_modulename Little_js "AA-b" =~ "aA.js" ;
         Ext_namespace.js_name_of_modulename Upper_js "AA-b" =~ "AA.js" ;
         Ext_namespace.js_name_of_modulename Upper_bs "AA-b" =~ "AA.bs.js" )
       ; ( __LOC__
         >:: fun _ ->
         let ( =~ ) =
           OUnit.assert_equal ~printer:(fun x ->
               match x with None -> "" | Some (a, b) -> a ^ "," ^ b) in
       ...
       ; ( __LOC__
         ...
         (* print_endline (Ext_buffer.contents buf); print_endline bench; *)
