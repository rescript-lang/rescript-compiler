...
let suites =
  ...
  >::: [ ( __LOC__
       ...
       ; (__LOC__ >:: fun _ -> OUnit.assert_equal parse_data_one data_one)
       ; (__LOC__ >:: fun _ -> OUnit.assert_equal parse_data_two data_two) ]
