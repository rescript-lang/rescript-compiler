...
let handleExternalInStru
  ...
  | [ v] ->
    ...
    | { pval_type; pval_prim; pval_attributes; no_inline_cross_module} ->
      ...
      if !send_pipe then
        let arity = Ast_core_type.get_curry_arity pval_type in 
        let [@warning "-8"] ((_obj::_params) as args) = Ast_core_type.get_curry_labels pval_type in 
                 ...
                 Str.value 
                   ...
                   Vb.mk ~loc 
                     ...
                     (let body = (Exp.apply ~loc 
                      ...
                      snd @@ 
                      Ext_list.fold_right
                        _params (0, Exp.fun_  Nolabel None (Pat.var ~loc { txt = "arg0"; loc} ) body) (
                        fun arg (i, obj) -> 
