  ...
  struct
    ...
    module Ext_filename :
      ...
      struct
        ...
        let node_modules_length = String.length "node_modules"[@@ocaml.doc
        ...
        let node_relative_path path1 path2 =
          ...
          then
            let rec skip i =
              if i >= len
              then failwith ("invalid path: " ^ path2)
              else (match path2.[i] with | '/'|'.' -> skip (i + 1) | _ -> i) in
            Ext_string.tail_from path2 (skip (v + node_modules_length))
          else
    ...
    module Js_exp_make :
      ...
      struct
        ...
        let merge_outer_comment comment (e : t) =
          ...
          | Some s -> { e with comment = (Some (comment ^ (sep ^ s))) }
        let make_block ?comment  tag tag_info es mutable_flag =
          (let comment =
           ...
           let es =
             match tag_info with
             | Blk_record des when (Array.length des) <> 0 ->
                 List.mapi
                   (fun i  -> fun (e : t)  -> merge_outer_comment (des.(i)) e)
                   es
             | Blk_module (Some des) -> List.map2 merge_outer_comment des es
             | _ -> es in
           {
      ...
      struct
        ...
        let bs_header =
          "// GENERATED CODE BY BUCKLESCRIPT VERSION " ^
            (Js_config.version ^ " , PLEASE EDIT WITH CARE")
        ...
        let cmj_data_sets =
          String_map.of_list
            ...
            ("caml_parser.cmj",
              (lazy
                 (Js_cmj_format.from_string
                    "BUCKLE20160310\132\149\166\190\000\000\001 \000\000\000=\000\000\000\220\000\000\000\206\176\208@1caml_parse_engine\160@@\208@5caml_set_parser_trace\160@\144\179@\160\176\001\003\245$prim@@\166\155\240 AA @\160\160\160'bs.call\176\192.caml_parser.ml\001\001\130\0015\221\0015\224\192\004\002\001\001\130\0015\221\0015\231@\144\160\160\160\176\145\1627$$caml_set_parser_trace@\176\192\004\012\001\001\130\0015\221\0015\232\192\004\r\001\001\130\0015\221\0016\001@@@\004\003@\160\160\160(bs.local\176\192\004\019\001\001\130\0015\221\0016\006\192\004\020\001\001\130\0015\221\0016\014@\144@@\144\176\193 \176\179\144\176E$bool@@\144@\002\005\245\225\000\001\003\195\176\179\004\006@\144@\002\005\245\225\000\001\003\198@\002\005\245\225\000\001\003\201\160\144\0041@@AB\144 @")));
            ("caml_primitive.cmj",
              (lazy
                 (Js_cmj_format.from_string
    ...
    module Js_of_lam_module :
      ...
      struct
        ...
        let make ?comment  (args : J.expression list) =
          E.make_block ?comment E.zero_int_literal (Blk_module None) args
            Immutable
        ...
        let query (prim : Lam_compile_env.primitive_description)
          ...
          (let prim_name = prim.prim_name in
           ...
           | "caml_output_value_to_buffer"|"caml_marshal_data_size"
             ...
             |"caml_ml_set_binary_mode" -> E.not_implemented prim_name
           | "js_function_length" ->
               (match args with
           ...
           | _ ->
               ...
               (Ext_log.warn __LOC__ "%s: %s when compiling %s\n" comment
                ...
                E.not_implemented prim_name) : J.expression)[@@ocaml.doc
          ...
          (match prim with
           ...
           | Pbigarrayref (unsafe,dimension,kind,layout) ->
               (match (dimension, kind, layout, unsafe) with
                ...
                | (_,_,_,_) ->
                    E.not_implemented
                      ("caml_ba_get_" ^ (string_of_int dimension)))
