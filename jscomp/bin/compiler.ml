            ...
            expr =
              (fun mapper  ->
                 fun e  ->
                   ...
                   | Pexp_extension
                       ({ txt = "js.raw"; loc },(PTyp _|PPat _|PStr _)) ->
