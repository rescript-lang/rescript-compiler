...
(** Immutable graph model. Layout accessors, iterators and membership
    functions. *)
...
module Make (G : Graph.Graphviz.GraphWithDotAttrs) : sig
  ...
  (** Creates a model using graphviz. [tmp_name] is the name of the temporary
      dot files.
...
module DotG :
  Sig.G
    with type V.label = XDot.node_layout
     and type E.label = XDot.edge_layout
