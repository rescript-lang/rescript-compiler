...
Theorem WP_parameter_relax : forall (u:vertex), forall (v:vertex),
  ...
  v1) with
  | (Finite n) => True
  | Infinite => forall (u1:vertex), (mem (u1, v1) (add (u, v) via)) ->
      ((get m1 u1) = Infinite)
  end).
...
destruct (get m v1) as [] _eqn; auto.
intros u1 hu1v1.
assert ((u1,v1)=(u,v) \/ mem (u1,v1) via).
generalize (add_def1 _ (u1,v1) (u,v) via); intuition.
destruct H as [H|H]. ae.
generalize (h3 v1 hv1); clear h3.
rewrite Heqt1; simpl.
