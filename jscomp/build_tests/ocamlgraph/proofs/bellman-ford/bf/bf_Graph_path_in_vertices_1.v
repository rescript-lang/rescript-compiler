...
Axiom path_last_elem_equal : forall (s1:vertex) (l:(list vertex)), (path s1
  l) -> ((last l) = s1).

(* Why3 goal *)
Theorem path_in_vertices : forall (s1:vertex) (l:(list vertex)), (path s1
  l) -> forall (v:vertex), (mem1 v l) -> (mem v vertices).
intuition.
