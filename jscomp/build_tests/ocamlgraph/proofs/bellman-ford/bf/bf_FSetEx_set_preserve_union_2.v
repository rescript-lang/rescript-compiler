...
Axiom set_empty : forall (a:Type), forall (a1:(set a)), (is_empty a1) <->
  (a1 = (empty :(set a))).

Axiom set_union_exchange : forall (a:Type), forall (a1:(set a)) (b:(set a)),
  ((union a1 b) = (union b a1)).

Axiom set_inter_exchange : forall (a:Type), forall (a1:(set a)) (b:(set a)),
  ((inter a1 b) = (inter b a1)).

Axiom set_inter_choice : forall (a:Type), forall (a1:(set a)) (b:(set a))
  (e:a), ((inter a1 b) = (empty :(set a))) -> ((mem e a1) -> ~ (mem e b)).

(* Why3 goal *)
Theorem set_preserve_union : forall (a:Type), forall (a1:(set a)) (b:(set a))
...
compute.
intuition; apply union_def1 in H0; apply union_def1.

destruct H0.

apply remove_def1 in H0.
destruct (classic (e = x)); tauto.
