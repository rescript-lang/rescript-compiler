...
(** Maximal Cardinality Search (MCS-M) algorithm
    ...
    Based on the article: Maximal Cardinality Search for Computing Minimal
    Triangulations of Graphs. by A. Berry, Jean R. S. Blair, Pinar Heggernes &
    Barry W. Peyton.
...
module MaximalCardinalitySearch : sig
  module P (G : Sig.P) : sig
    ...
    (** [triangulate g] computes a triangulation of [g] using the MCS-M
        algorithm *)
  end
