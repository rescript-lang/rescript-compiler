...
var int32_pairs = /* array */[
  /* tuple */[
    32,4.48415508583941463e-44
  ],/* tuple */[
    3,4.20389539297445121e-45
  ]
];
                      ...
                      return /* Nested :: */[
                              /* tuple */[
                                ...
                                /* tuple */[
                                  Curry._1(Printf.sprintf(/* Format */[
                                            /* String_literal */Block.__(11, [
                                                "int32_bits_of_float ",/* Int */Block.__(4, [
                                                    /* Int_d */0,/* No_padding */0,/* No_precision */0,/* End_of_format */0
                                                  ])
                                              ]),"int32_bits_of_float %d"
                                          ]), i),function () {
                                    return /* Eq */Block.__(0, [
                                              Caml_float.caml_int32_bits_of_float(f),i32
                                            ]);
                                  }
                                ],/* [] */0
                              ]
...
var suites = Pervasives.$at(/* Nested :: */[
      /* tuple */[
        "one",function () {
          return /* Eq */Block.__(0, [
                    Caml_int64.bits_of_float(1.0),one_float
                  ]);
        }
      ],[
        /* tuple */[
          "two",function () {
            return /* Eq */Block.__(0, [
                      Caml_int64.float_of_bits(one_float),1.0
                    ]);
          }
        ],/* [] */0
      ]
