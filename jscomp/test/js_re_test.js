  ...
  /* :: */[
    /* tuple */[
      ...
      (function () {
          ...
          var $$break = /* false */0;
          while(!$$break) {
            var match = re.exec("abbcdefabh");
            if (match !== null) {
              Js_null_undefined.bind(Caml_array.caml_array_get(match, 0), (function (match_) {
                      var next = "" + re.lastIndex;
                      console.log("Found " + (match_ + (". Next match starts at " + next)));
                      return /* () */0;
                    }));
            } else {
              $$break = /* true */1;
