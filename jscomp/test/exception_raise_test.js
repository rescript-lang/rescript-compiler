...
try {
  Curry._1(function (_){throw 2}, /* () */0);
}
catch (raw_e$2){
  var e = Caml_js_exceptions.internalToOCamlException(raw_e$2);
  eq("File \"exception_raise_test.ml\", line 134, characters 7-14", Caml_js_exceptions.caml_as_js_exn(e) !== undefined, true);
}
...
try {
  ...
  eq("File \"exception_raise_test.ml\", line 141, characters 7-14", Caml_js_exceptions.caml_as_js_exn(e$1) !== undefined, false);
}

eq("File \"exception_raise_test.ml\", line 144, characters 5-12", Curry._4(function (a,b,c,_){return a + b + c }, 1, 2, 3, 4), 6);
