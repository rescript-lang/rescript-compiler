...
try {
  ...
  if (v[0] === A) {
    ...
    var match = Caml_js_exceptions.caml_as_js_exn(v);
    if (match !== undefined) {
      a0 = Caml_option.valFromOption(match);
    } else {
      throw [
...
var suites = /* record */[/* contents : :: */[
    ...
    /* :: */[
      /* tuple */[
        "File \"exception_raise_test.ml\", line 118, characters 4-11",
        (function (param) {
            var match = Caml_js_exceptions.caml_as_js_exn(a1);
            if (match !== undefined) {
              return /* Eq */Block.__(0, [
...
try {
  ...
  eq("File \"exception_raise_test.ml\", line 133, characters 7-14", Caml_js_exceptions.caml_as_js_exn(e) !== undefined, true);
}
...
try {
  ...
  eq("File \"exception_raise_test.ml\", line 140, characters 7-14", Caml_js_exceptions.caml_as_js_exn(e$1) !== undefined, false);
}

eq("File \"exception_raise_test.ml\", line 143, characters 5-12", function (a,b,c,_){return a + b + c }(1, 2, 3, 4), 6);
