...
Mt.from_pair_suites("Digest_test", Pervasives.$at(/* constructor */{
          ...
          Arg0: /* tuple */[
            ...
            (function (param) {
                return /* constructor */{
                        tag: "Eq",
                        Arg0: Digest.to_hex(Digest.string("value")),
                        Arg1: "2063c1608d6e0baf80249c42e2be5804"
                      };
              })
          ],
          Arg1: /* constructor */{
            ...
            Arg0: /* tuple */[
              ...
              (function (param) {
                  return /* constructor */{
                          tag: "Eq",
                          Arg0: Digest.to_hex(Digest.string("The quick brown fox jumps over the lazy dog")),
                          Arg1: "9e107d9d372bb6826bd81d3542a419d6"
                        };
                })
            ],
            Arg1: /* constructor */{
              ...
              Arg0: /* tuple */[
                ...
                (function (param) {
                    return /* constructor */{
                            tag: "Eq",
                            Arg0: Digest.to_hex(Digest.string("The quick brown fox jumps over the lazy dog.")),
                            Arg1: "e4d909c290d0fb1ca068ffaddf22cbd0"
                          };
                  })
              ],
              Arg1: /* constructor */{
                ...
                Arg0: /* tuple */[
                  ...
                  (function (param) {
                      return /* constructor */{
                              tag: "Eq",
                              Arg0: Digest.to_hex(Digest.string("")),
                              Arg1: "d41d8cd98f00b204e9800998ecf8427e"
                            };
                    })
                ],
                Arg1: /* constructor */{
                  ...
                  Arg0: /* tuple */[
                    ...
                    (function (param) {
                        return /* constructor */{
                                ...
                                Arg1: "7065cc36bba1d155fb09f9d02f22e8bf"
                              };
                      })
                  ],
                  Arg1: /* constructor */{
                    ...
                    Arg0: /* tuple */[
                      ...
                      (function (param) {
                          return /* constructor */{
                                  tag: "Eq",
                                  Arg0: Digest.to_hex(Digest.string("The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.The quick brown fox jumps over the lazy dog.")),
                                  Arg1: "b9193d1df4b7a8f0a25ffdd1005c5b2b"
                                };
                        })
                    ],
                    Arg1: "[]"
                    ...
                    return /* tuple */[
                            ...
                            (function (param) {
                                return /* constructor */{
                                        tag: "Eq",
                                        Arg0: Digest.to_hex(Digest.string(Caml_bytes.bytes_to_string(Bytes.make(i, /* "a" */97)))),
                                        Arg1: Caml_array.caml_array_get(ref, i)
                                      };
                              })
                          ];
