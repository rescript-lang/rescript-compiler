      ...
      if (isid(c)) {
        ...
        while(true) {
          ...
          if (isid(peekch(/* () */0))) {
            ...
            return /* Sym */{
                    0: Curry._1(addsym, Bytes.to_string(Bytes.sub(s, 0, n$1 + 1 | 0))),
                    length: 1,
                    tag: 3
                  };
          }
...
var tokint = /* Sym */{
  0: Curry._1(addsym, "int"),
  length: 1,
  tag: 3
};

var tokchar = /* Sym */{
  0: Curry._1(addsym, "char"),
  length: 1,
  tag: 3
};

var tokret = /* Sym */{
  0: Curry._1(addsym, "return"),
  length: 1,
  tag: 3
};

var tokif = /* Sym */{
  0: Curry._1(addsym, "if"),
  length: 1,
  tag: 3
};

var tokelse = /* Sym */{
  0: Curry._1(addsym, "else"),
  length: 1,
  tag: 3
};

var tokwhile = /* Sym */{
  0: Curry._1(addsym, "while"),
  length: 1,
  tag: 3
};

var tokfor = /* Sym */{
  0: Curry._1(addsym, "for"),
  length: 1,
  tag: 3
};

var tokbreak = /* Sym */{
  0: Curry._1(addsym, "break"),
  length: 1,
  tag: 3
};
        ...
        switch (o) {
          ...
          case "*" : 
              ...
              if (Caml_obj.caml_equal(t, tokint)) {
                match$1 = Caml_obj.caml_equal(Curry._1(next$1, /* () */0), /* Op */{
                      0: "*",
                      length: 1,
                      tag: 0
                    }) ? /* tuple */[
  ...
  while(true) {
    if (nextis(/* Op */{
      ...
      if (match.tag === 3) {
        ...
        while(Caml_obj.caml_notequal(Curry._1(next$1, /* () */0), /* Op */{
                0: "{",
                length: 1,
                tag: 0
              })) {
