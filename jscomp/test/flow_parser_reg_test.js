...
function module_body(term_fn, env) {
  ...
  var acc = /* [] */0;
  var env$2 = env$1;
  var term_fn$2 = Curry.__1(term_fn$1);
  var _acc = acc;
  while(true) {
    var acc$1 = _acc;
    var t = Curry._2(Parser_env_048[/* token */0], /* None */0, env$2);
    var exit = 0;
    if (typeof t === "number") {
      if (t !== 105) {
        exit = 1;
...
function statement_list(env, term_fn, item_fn, param) {
  var _env = env;
  var term_fn$1 = Curry.__1(term_fn);
  var item_fn$1 = Curry.__1(item_fn);
  var _param = param;
  while(true) {
    var param$1 = _param;
    var env$1 = _env;
    var stmts = param$1[1];
    var string_tokens = param$1[0];
    var t = Curry._2(Parser_env_048[/* token */0], /* None */0, env$1);
    var exit = 0;
    if (typeof t === "number") {
      if (t !== 105) {
    ...
    if (exit === 1) {
      if (term_fn$1(t)) {
        ...
        var string_token_000 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$1);
        var string_token_001 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$1);
        var string_token = /* tuple */[
          string_token_000,
          string_token_001
        ];
        var possible_directive = item_fn$1(env$1);
        var stmts$1 = /* :: */[
          possible_directive,
          stmts
        ];
        ...
        if (typeof match === "number") {
          ...
          if (typeof match$2 === "number") {
            ...
            if (typeof match$3 === "number") {
              ...
              var strict = env$1[/* in_strict_mode */5] || +(match$3[0] === "use strict" && len === 12);
              var string_tokens$1 = /* :: */[
                string_token,
                string_tokens
              ];
  ...
  while(true) {
    ...
    if (exit === 1) {
      if (term_fn$2(t)) {
        ...
        _acc = /* :: */[
          statement_list_item(/* None */0, env$2),
          acc$1
        ];
        continue ;
