...
function init$1(env, start_loc, decorators, key, async, generator, $$static) {
  ...
  if (exit$1 === 2) {
    if (!async && !generator) {
      ...
      var value = Curry._2(Parser_env_048[/* token */0], undefined, env) === /* T_ASSIGN */75 && ($$static && options.esproposal_class_static_fields || !$$static && options.esproposal_class_instance_fields) ? (token$4(env, /* T_ASSIGN */75), Curry._1(Parse[/* expression */6], env)) : undefined;
      var end_loc = Curry._2(Parser_env_048[/* loc */2], undefined, env);
    ...
    switch (expr.tag | 0) {
      case 0 : 
          ...
          var elements = List.map((function (param) {
                  ...
                  if (param$1 !== undefined) {
                    ...
                    if (match.tag) {
                      var match$1 = match[0];
                      var argument = Curry._2(Parse[/* pattern_from_expr */17], env$2, match$1[1].argument);
                      return /* Spread */Block.__(1, [/* tuple */[
                                  match$1[0],
                                  /* record */{
                                    argument: argument
      ...
      case 1 : 
          ...
          var properties = List.map((function (param) {
                  ...
                  if (prop.tag) {
                    var match = prop[0];
                    var argument = Curry._2(Parse[/* pattern_from_expr */17], env$3, match[1].argument);
                    return /* SpreadProperty */Block.__(1, [/* tuple */[
                                match[0],
                                /* record */{
                                  argument: argument
                    ...
                    var pattern = Curry._2(Parse[/* pattern_from_expr */17], env$3, match$2.value);
