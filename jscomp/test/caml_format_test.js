...
function ff(l) {
  return Caml_format.format_int("%32d", l);
}
...
let l = Pervasives.$at(suites, Pervasives.$at($$Array.to_list($$Array.mapi((function (i, param) {
...
Mt.from_pair_suites("Caml_format_test", l);
