...
function f(l) {
  return Belt_Map.fromArray(l, Icmp);
}

function $eq$tilde(a, b) {
  return function (l) {
    return Belt_Map.eq(a, b, l);
  };
}

let l = Belt_Array.map(Array_data_util.randomRange(0, 39), (function (x) {
  return [
    x,
    x
  ];
...
let u0 = Belt_Map.fromArray(l, Icmp);
...
let l$1 = Belt_Array.makeByAndShuffle(10000, (function (x) {
  return [
    x,
    x
  ];
...
let u = Belt_Map.fromArray(l$1, Icmp);
