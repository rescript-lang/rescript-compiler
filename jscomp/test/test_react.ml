...
external config :
  ?display_name:string -> render:(unit -> component) -> unit -> config = ""
  [@@bs.obj]

type attrs

external attrs : ?alt:string -> ?autoPlay:bool -> unit -> attrs = "" [@@bs.obj]
...
(* FIXME: investigate cases: {[ [@@bs.module "package1" "same_name"]
   [@@bs.module "package2" "same_name"] ]} {[ [@@bs.module "package" "name1"]
...
external createClass : config -> component_class = "createClass"
  [@@bs.val "createClass"] [@@bs.module "react"]

external render : component_class -> element -> unit = ""
  [@@bs.val "render"] [@@bs.module "react-dom"]
