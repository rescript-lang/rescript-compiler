  ...
  if len2 > len1 then false
    ...
    try
      for i = 0 to len2 - 1 do
        if not @@ p xs.(i) prefix.(i) then raise X.H
      done ;
      true
    with X.H -> false
  ...
  eq __LOC__ a
    (Bytes.of_string
       "\000\001\002\003\004\005\006\007\b\t\005\006\007\b\t\n\
        \011\012\r\014\020\021\022\023\024\025\026\027\028\029\030\031 \
...
let () =
  ...
  eq __LOC__ a
    (Bytes.of_string
       "\000\001\002\003\004\n\
        \011\012\r\014\015\016\017\018\019\015\016\017\018\019\020\021\022\023\024\025\026\027\028\029\030\031 \
        !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abc")
