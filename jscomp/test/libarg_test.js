...
function f_bool(b) {
  return Curry._1(record(/* Format */[
                  /* String_literal */Block.__(11, [
                      "bool(",/* Bool */Block.__(9, [/* Char_literal */Block.__(12, [
                              /* ")" */41,/* End_of_format */0
                            ])])
                    ]),"bool(%b)"
                ]), b);
...
var spec_000 = /* tuple */[
  "-u",/* Unit */Block.__(0, [f_unit]),"Unit (0)"
];

var spec_001 = /* Nested :: */[
  /* tuple */[
    "-b",/* Bool */Block.__(1, [f_bool]),"Bool (1)"
  ],[
    /* tuple */[
      "-s",/* Set */Block.__(2, [r_set]),"Set (0)"
    ],[
      /* tuple */[
        "-c",/* Clear */Block.__(3, [r_clear]),"Clear (0)"
      ],[
        /* tuple */[
          "-str",/* String */Block.__(4, [f_string]),"String (1)"
        ],[
          /* tuple */[
            "-sstr",/* Set_string */Block.__(5, [r_string]),"Set_string (1)"
          ],[
            /* tuple */[
              "-i",/* Int */Block.__(6, [f_int]),"Int (1)"
            ],[
              /* tuple */[
                "-si",/* Set_int */Block.__(7, [r_int]),"Set_int (1)"
              ],[
                /* tuple */[
                  "-f",/* Float */Block.__(8, [f_float]),"Float (1)"
                ],[
                  /* tuple */[
                    "-sf",/* Set_float */Block.__(9, [r_float]),"Set_float (1)"
                  ],[
                    /* tuple */[
                      "-t",/* Tuple */Block.__(10, [/* Nested :: */[
                            /* Bool */Block.__(1, [f_bool]),[
                              /* String */Block.__(4, [f_string]),[
                                /* Int */Block.__(6, [f_int]),/* [] */0
                              ]
                            ]
                          ]]),"Tuple (3)"
                    ],[
                      /* tuple */[
                        "-sym",/* Symbol */Block.__(11, [
                            /* Nested :: */[
                              "a",[
                                "b",[
                                  "c",/* [] */0
                        ...
                        /* tuple */[
                          "-rest",/* Rest */Block.__(12, [f_rest]),"Rest (*)"
                        ],/* [] */0
                      ]
                    ]
                  ]
...
var args1 = /* array */[
  "prog","anon1","-u","-b","true","-s","anon2","-c","-str","foo","-sstr","bar","-i","19","-si","42","-f","3.14","-sf","2.72","anon3","-t","false","gee","1436","-sym","c","anon4","-rest","r1","r2"
];
                              ...
                              /* " " */32,/* Char */Block.__(0, [/* Char_literal */Block.__(12, [
                                      /* " " */32,/* String */Block.__(2, [
                                          /* Lit_padding */Block.__(0, [
                                              ...
                                              /* "\n" */10,/* Flush */Block.__(10, [/* End_of_format */0])
                                            ])
                                        ])
                                    ])])
                            ])
