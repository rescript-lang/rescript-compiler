...
var Meths = [
  /* Empty */0,is_empty$1,mem$1,add$1,singleton$1,remove$1,merge$1,compare$1,equal$1,iter$1,fold$1,for_all$1,exists$1,filter$1,partition$1,cardinal$1,bindings$1,min_binding$1,max_binding$1,min_binding$1,split$1,find$1,map$1,mapi$1
];
  ...
  if (param) {
    ...
    if (c) {
      if (c < 0) {
        ...
        return /* tuple */[
                match[0],match[1],join$2(match[2], v, d, r)
              ];
      }
      else {
        var match$1 = split$2(x, r);
        return /* tuple */[
                join$2(l, v, d, match$1[0]),match$1[1],match$1[2]
              ];
      }
    }
    else {
...
function partition$2(p, param) {
  if (param) {
    ...
    if (pvd) {
      return /* tuple */[
              join$2(lt, v, d, rt),concat$2(lf, rf)
            ];
    }
    else {
      return /* tuple */[
              concat$2(lt, rt),join$2(lf, v, d, rf)
            ];
    }
  }
  else {
...
var Labs = [
  /* Empty */0,is_empty$2,mem$2,add$2,singleton$2,remove$2,merge$2,compare$2,equal$2,iter$2,fold$2,for_all$2,exists$2,filter$2,partition$2,cardinal$2,bindings$2,min_binding$2,max_binding$2,min_binding$2,split$2,find$2,map$2,mapi$2
];
