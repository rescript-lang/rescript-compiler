...
function merge$3(f, s1, s2) {
  ...
  if (s1) {
    ...
    if (s1[/* h */4] >= height$1(s2)) {
      ...
      return concat_or_join$1(merge$3(f, s1[/* l */0], match[0]), v1, Curry._3(f, v1, Js_primitive.some(s1[/* d */2]), match[1]), merge$3(f, s1[/* r */3], match[2]));
    } else {
      exit = 1;
    }
  } else if (s2) {
  ...
  if (exit === 1) {
    if (s2) {
      ...
      return concat_or_join$1(merge$3(f, match$1[0], s2[/* l */0]), v2, Curry._3(f, v2, match$1[1], Js_primitive.some(s2[/* d */2])), merge$3(f, match$1[2], s2[/* r */3]));
    } else {
      throw [
            Caml_builtin_exceptions.assert_failure,
            /* tuple */[
  ...
  if (s1) {
    if (s2) {
      ...
      if (s1[/* h */4] >= s2[/* h */4]) {
        ...
        if (d2$1 !== undefined) {
          return concat_or_join$1(l, v1, Curry._3(f, v1, d1, Js_primitive.valFromOption(d2$1)), r);
        } else {
        ...
        if (d1$1 !== undefined) {
          return concat_or_join$1(l$1, v2, Curry._3(f, v2, Js_primitive.valFromOption(d1$1), d2), r$1);
        } else {
...
function merge$5(f, s1, s2) {
  ...
  if (s1) {
    ...
    if (s1[/* h */4] >= height$2(s2)) {
      ...
      return concat_or_join$2(merge$5(f, s1[/* l */0], match[0]), v1, Curry._3(f, v1, Js_primitive.some(s1[/* d */2]), match[1]), merge$5(f, s1[/* r */3], match[2]));
    } else {
      exit = 1;
    }
  } else if (s2) {
  ...
  if (exit === 1) {
    if (s2) {
      ...
      return concat_or_join$2(merge$5(f, match$1[0], s2[/* l */0]), v2, Curry._3(f, v2, match$1[1], Js_primitive.some(s2[/* d */2])), merge$5(f, match$1[2], s2[/* r */3]));
    } else {
      throw [
            Caml_builtin_exceptions.assert_failure,
            /* tuple */[
  ...
  if (s1) {
    if (s2) {
      ...
      if (s1[/* h */4] >= s2[/* h */4]) {
        ...
        if (d2$1 !== undefined) {
          return concat_or_join$2(l, v1, Curry._3(f, v1, d1, Js_primitive.valFromOption(d2$1)), r);
        } else {
        ...
        if (d1$1 !== undefined) {
          return concat_or_join$2(l$1, v2, Curry._3(f, v2, Js_primitive.valFromOption(d1$1), d2), r$1);
        } else {
