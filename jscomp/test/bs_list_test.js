...
eq("File \"bs_list_test.ml\", line 50, characters 5-12", Bs_List.toArray(Bs_List.concat(Bs_List.init(100, (function (i) {
                    return i;
...
Bs_List.forEachi(length_10_id, (function (i, x) {
...
eq("File \"bs_list_test.ml\", line 196, characters 5-12", Bs_List.reduceFromTail(length_10_id, 0, add), 45);
...
eq("File \"bs_list_test.ml\", line 204, characters 5-12", Bs_List.reduceFromTail2(length_10_id, length_8_id, 0, (function (acc, x, y) {
            return (acc + x | 0) + y | 0;
          })), 56);

eq("File \"bs_list_test.ml\", line 206, characters 5-12", Bs_List.reduceFromTail2(length_10_id, length_10_id, 0, (function (acc, x, y) {
            return (acc + x | 0) + y | 0;
          })), 90);
