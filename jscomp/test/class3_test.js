...
function point_init($$class) {
  var ids = CamlinternalOO.new_methods_variables($$class, shared$1, shared$6);
  var move = ids[0];
  var get_x = ids[1];
  var x = ids[2];
...
function adjusted_point_init($$class) {
  ...
  var ids = CamlinternalOO.new_methods_variables($$class, shared$2, shared$6);
  var move = ids[0];
  var get_x = ids[1];
...
var adjusted_point = CamlinternalOO.make_class(shared$9, adjusted_point_init);
...
function printable_point_init($$class) {
  var ids = CamlinternalOO.new_methods_variables($$class, shared$8, shared$6);
  var print = ids[0];
  var move = ids[1];
  var get_x = ids[2];
  var x = ids[3];
...
var printable_point = CamlinternalOO.make_class(shared$4, printable_point_init);
...
var printable_point2 = CamlinternalOO.make_class(shared$4, printable_point2_init);
...
var vpoint = CamlinternalOO.make_class(shared$9, vpoint_init);
...
function abstract_point2_001($$class) {
  var ids = CamlinternalOO.new_methods_variables($$class, shared$5, shared$6);
  var move = ids[0];
  var x = ids[1];
...
function point2_init($$class) {
  ...
  var inh = CamlinternalOO.inherits($$class, shared$6, 0, shared$5, abstract_point2, 1);
  var obj_init = inh[0];
  var x = inh[1];
...
function point_again_init($$class) {
  ...
  var inh = CamlinternalOO.inherits($$class, shared$6, 0, shared$3, restricted_point, 1);
  var obj_init = inh[0];
...
var point_again = CamlinternalOO.make_class(shared$7, point_again_init);
...
var point_again2 = CamlinternalOO.make_class(shared$7, point_again2_init);
...
var point_again3 = CamlinternalOO.make_class(shared$7, point_again3_init);
