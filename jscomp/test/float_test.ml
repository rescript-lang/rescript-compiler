...
let from_pairs ps =
  ...
  |> Array.mapi (fun i (a, b) ->
         (Printf.sprintf "pair %d" i, fun _ -> Mt.Approx (a, b)))
  |> Array.to_list
...
let () =
  ...
  @@ Mt.
       [ ( "mod_float"
         , fun _ -> Approx (mod_float 3.2 0.5, 0.200000000000000178) )
       ; ("modf_float1", fun _ -> Approx (a, 0.299999999999997158))
       ; ("modf_float2", fun _ -> Approx (b, 32.))
