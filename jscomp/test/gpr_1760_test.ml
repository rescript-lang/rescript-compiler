...
let a0 =   try (let _c = (/) 0 0 in 0) with _ -> 1 
...
let a5 = try (let _ = Int32.rem 0l 0l in 0) with _ -> 1 

let a6 = try (let _ = Int64.div 0L 0L in 0) with _ ->  1
let a7 =  try (let _ = Int64.rem 0L 0L in 0) with _ -> 1 


;;eq __LOC__ (a0,a1,a4,a5,a6,a7) 
  (1,1,1,1,1,1)
