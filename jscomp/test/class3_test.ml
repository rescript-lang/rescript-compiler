...
let () = my_int#register ; my_int#register ; Js.log @@ my_int#len
...
class printable_point2 x_init =
  ...
  object (self)
    ...
    initializer
    print_endline ("initializing" ^ __LOC__) ;
    v.(0) <- x
  end
...
let hh =
  ...
  p#move 3 ; p#bump ; p#bump ; p#get_x
...
let hhh =
  ...
  p#move 30 ; p#bump ; p#bump ; p#get_x
...
let hhhh =
  ...
  p#move 300 ; p#bump ; p#bump ; p#get_x
