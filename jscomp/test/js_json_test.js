...
if (/* tag */typeof ty$2 === "number" || ty$2.TAG !== /* JSONNumber */1) {
  exit = 1;
} else {
...
if (/* tag */typeof ty$3 === "number" || ty$3.TAG !== /* JSONNumber */1) {
  exit$1 = 1;
} else {
