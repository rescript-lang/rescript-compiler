...
if (typeof ty !== "object") {
  if (ty === "JSONNull") {
    add_test("File \"js_json_test.res\", line 55, characters 24-31", (() => ({
      TAG: "Ok",
      _0: true
    })));
  } else {
    console.log(ty);
    add_test("File \"js_json_test.res\", line 58, characters 11-18", (() => ({
      TAG: "Ok",
      _0: false
    })));
  }
...
if (typeof ty$1 !== "object") {
  add_test("File \"js_json_test.res\", line 68, characters 16-23", (() => ({
    TAG: "Ok",
    _0: false
  })));
...
if (exit === 1) {
  add_test("File \"js_json_test.res\", line 78, characters 18-25", (() => ({
    TAG: "Ok",
    _0: false
  })));
}
...
if (exit$1 === 1) {
  add_test("File \"js_json_test.res\", line 88, characters 18-25", (() => ({
    TAG: "Ok",
    _0: false
  })));
}
...
function test(v) {
  ...
  let ty = Js_json.classify(json);
  if (typeof ty === "object") {
    return add_test("File \"js_json_test.res\", line 100, characters 18-25", (() => ({
      TAG: "Ok",
      _0: false
    })));
  }
...
if (typeof ty$4 !== "object") {
  add_test("File \"js_json_test.res\", line 142, characters 16-23", (() => ({
    TAG: "Ok",
    _0: false
  })));
  ...
  if (typeof ta !== "object") {
    add_test("File \"js_json_test.res\", line 140, characters 18-25", (() => ({
      TAG: "Ok",
      _0: false
    })));
  } else if (ta.TAG === "JSONString") {
    if (ta._0 !== "test string") {
      add_test("File \"js_json_test.res\", line 131, characters 15-22", (() => ({
        TAG: "Ok",
        _0: false
      })));
    } else {
      ...
      if (typeof ty$5 !== "object") {
        add_test("File \"js_json_test.res\", line 137, characters 22-29", (() => ({
          TAG: "Ok",
          _0: false
        })));
      } else if (ty$5.TAG === "JSONNumber") {
        let b = ty$5._0;
        add_test("File \"js_json_test.res\", line 136, characters 38-45", (() => ({
          TAG: "Approx",
          _0: 123.0,
          _1: b
        })));
