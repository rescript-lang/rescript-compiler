...
eq('File "ffi_js.ml", line 33, characters 5-12', /* tuple */[
      6,
      $$high_order(1)(2, 3)
    ]);
...
eq('File "ffi_js.ml", line 44, characters 5-12', /* tuple */[
      Object.keys(int_config).length,
      2
    ]);

eq('File "ffi_js.ml", line 45, characters 5-12', /* tuple */[
      Object.keys(string_config).length,
      2
    ]);

eq('File "ffi_js.ml", line 46, characters 5-12', /* tuple */[
      Object.keys(v_obj).indexOf("hi_x"),
      -1
    ]);

eq('File "ffi_js.ml", line 47, characters 5-12', /* tuple */[
...
eq('File "ffi_js.ml", line 54, characters 5-12', /* tuple */[
      u[0],
      4
    ]);
