...
eq("File \"test/class_fib_open_recursion_test.ml\", line 33, characters 5-12", Caml_oo_curry.js2(-1044768619, 1, tmp, 40), 165580141);

Mt.from_pair_suites("test/class_fib_open_recursion_test.ml", suites[0]);
