...
Nodetest.describe("Belt.List", () => {
  ...
  Nodetest.test("head/tail etc.", () => {
    ...
    Node_test_util.ok("File \"belt_list_ntest.res\", line 276, characters 7-14", Caml_obj.equal(Belt_List.reduceReverse({
      hd: 1,
      tl: {
        hd: 2,
        tl: {
    ...
    Node_test_util.ok("File \"belt_list_ntest.res\", line 279, characters 7-14", Caml_obj.equal(Belt_List.reduce({
      hd: 1,
      tl: {
        hd: 2,
        tl: {
  ...
  Nodetest.test("keepMap", () => {
    ...
    Node_test_util.ok("File \"belt_list_ntest.res\", line 362, characters 6-13", Caml_obj.equal(Belt_List.keepMap({
      hd: 1,
      tl: {
        hd: 2,
        tl: {
