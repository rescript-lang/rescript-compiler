  ...
  if (e[0] >= 848054398) {
    ...
    if (match !== "[]") {
      ...
      if (typeof match$1 === "number" || match$1[0] !== 726615281) {
        ...
        return _get_variant(match$1[1], match.Arg1, l);
      }
    } else {
      return ;
    }
