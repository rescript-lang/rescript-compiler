    ...
    if (typeof x1 === "number") {
      ...
      switch (x1.tag | 0) {
        ...
        case 3 : 
            if (typeof x2 === "number") {
              return /* false */0;
            } else if (x2.tag === 3 && x1[1] === x2[1] && Caml_obj.caml_equal(x1[2], x2[2])) {
              _x2 = x2[0];
              _x1 = x1[0];
              continue ;
        ...
        case 13 : 
            if (typeof x2 === "number") {
              return /* false */0;
            } else if (x2.tag === 13 && equal$2(x1[0], x2[0])) {
              _x2 = x2[1];
              _x1 = x1[1];
              continue ;
