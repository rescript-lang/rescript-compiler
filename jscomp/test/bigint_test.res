...
let () = {
  ...
  eq(__LOC__, bigint_compare(0x1n, 0x001n), 0)
  eq(__LOC__, generic_compare(0x1n, 0x001n), 0)
  eq(__LOC__, bigint_compare(-0x1n, 0x001n), -1)
  eq(__LOC__, generic_compare(-0x1n, 0x001n), -1)
