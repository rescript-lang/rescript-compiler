...
function map(f, l) {
  return Caml_obj.caml_lazy_make((function (param) {
                ...
                return /* constructor */{
                        tag: "Cons",
                        Arg0: Curry._1(f, match.Arg0),
                        Arg1: map(f, match.Arg1)
                      };
              }));
}
  ...
  return Caml_obj.caml_lazy_make((function (param) {
                ...
                if (c === 0) {
                  return /* constructor */{
                          tag: "Cons",
                          Arg0: x1,
                          Arg1: merge(cmp, ll1, ll2)
                        };
                } else if (c < 0) {
                  return /* constructor */{
                          tag: "Cons",
                          Arg0: x1,
                          Arg1: merge(cmp, ll1, l2)
                        };
                } else {
                  return /* constructor */{
                          tag: "Cons",
                          Arg0: x2,
                          Arg1: merge(cmp, l1, ll2)
                        };
                }
              }));
}
...
var hamming = Caml_obj.caml_lazy_make((function (param) {
        return /* constructor */{
                tag: "Cons",
                Arg0: nn1,
                Arg1: merge(cmp, ham2, merge(cmp, ham3, ham5))
              };
      }));
