...
function mul(n, param) {
  var pl = param[0];
  return /* tuple */[
          Caml_int64.mod_(Caml_int64.mul(n, pl), digit),Caml_int64.add(Caml_int64.mul(n, param[1]), Caml_int64.div(Caml_int64.mul(n, pl), digit))
        ];
}
...
function map(f, l) {
  return Block.__(246, [function () {
              ...
              return /* Cons */[
                      Curry._1(f, match[0]),map(f, match[1])
                    ];
            }]);
}
...
Caml_obj.caml_update_dummy(hamming, Block.__(246, [function () {
          return /* Cons */[
                  nn1,merge(cmp, ham2, merge(cmp, ham3, ham5))
                ];
        }]));
