...
let suites =
  Mt.
    [ (* ArrayBuffer *)
      ( "array_buffer - make"
      , fun _ -> Eq (5, ArrayBuffer.make 5 |> ArrayBuffer.byteLength) )
    ; (* experimental "array_buffer - transfer", (fun _ -> Eq(5,
         ArrayBuffer.make 5 |> ArrayBuffer.transfer |>
         ArrayBuffer.byteLength)); "array_buffer - transferWithLength", (fun _
         -> let a = ArrayBuffer.make 5 in Eq(10, ArrayBuffer.transferWithLength
         a 10 |> ArrayBuffer.byteLength)); *)
    ...
    ; ( "array_buffer - slice"
      , fun _ ->
          Eq
            ( 2
            , ArrayBuffer.make 5
              |> ArrayBuffer.slice ~start:2 ~end_:4
              |> ArrayBuffer.byteLength ) )
    ; ( "array_buffer - sliceFrom"
      , fun _ ->
          Eq
            ( 3
            , ArrayBuffer.make 5 |> ArrayBuffer.sliceFrom 2
              |> ArrayBuffer.byteLength ) )
    ; (* Generic typed array *)
      ( "typed_array - unsafe_get"
      , fun _ -> Eq (4, Int8Array.unsafe_get (mkI8 [|1; 2; 3; 4; 5|]) 3) )
    ...
    ; ( "typed_array - byteOffset"
      , fun _ -> Eq (0, mkI8 [|1; 2; 3; 4; 5|] |> Int8Array.byteOffset) )
    ...
    ; (* These shouldn't compile "type_safe_sanity_check 1", (fun _ -> let a =
         Float32Array.make [| 1.; 2.; 3.; 4.; 5. |] in let _ = Int8Array.set a
         3 14 in

         Eq(14, Int8Array.get a 3) ); "type_safe_sanity_check 2", (fun _ -> let
         a = Int16Array.make [| 1; 2; 3; 4; 5 |] in let _ = Int8Array.set a 3
         14 in
      ...
      (* Array itnerface(-ish) *)
      ( "typed_array - length"
      , fun _ -> Eq (5, mkI8 [|1; 2; 3; 4; 5|] |> Int8Array.length) )
    ...
    ; ( "typed_array - fillInPlace"
      , fun _ ->
          Eq (mkI8 [|4; 4; 4|], mkI8 [|1; 2; 3|] |> Int8Array.fillInPlace 4) )
    ...
    ; ( "typed_array - reverseInPlace"
      , fun _ ->
          Eq (mkI8 [|3; 2; 1|], mkI8 [|1; 2; 3|] |> Int8Array.reverseInPlace)
      )
    ; ( "typed_array - sortInPlace"
      , fun _ ->
          Eq (mkI8 [|1; 2; 3|], mkI8 [|3; 1; 2|] |> Int8Array.sortInPlace) )
    ; ( "typed_array - sortInPlaceWith"
      , fun _ ->
          Eq
            ( mkI8 [|3; 2; 1|]
            , mkI8 [|3; 1; 2|]
              |> Int8Array.sortInPlaceWith (fun [@bs] a b -> b - a) ) )
    ; (* es2016 *)
      ( "typed_array - includes"
      , fun _ -> Eq (true, mkI8 [|1; 2; 3|] |> Int8Array.includes 3) )
    ; ( "typed_array - indexOf"
      , fun _ -> Eq (1, mkI8 [|1; 2; 3|] |> Int8Array.indexOf 2) )
    ; ( "typed_array - indexOfFrom"
      , fun _ -> Eq (3, mkI8 [|1; 2; 3; 2|] |> Int8Array.indexOfFrom 2 ~from:2)
      )
    ; ( "typed_array - join"
      , fun _ -> Eq ("1,2,3", mkI8 [|1; 2; 3|] |> Int8Array.join) )
    ; ( "typed_array - joinWith"
      , fun _ -> Eq ("1;2;3", mkI8 [|1; 2; 3|] |> Int8Array.joinWith ";") )
    ; ( "typed_array - lastIndexOf"
      , fun _ -> Eq (1, mkI8 [|1; 2; 3|] |> Int8Array.lastIndexOf 2) )
    ...
    ; ( "typed_array - copy"
      , fun _ ->
          Eq (mkI8 [|1; 2; 3; 4; 5|], mkI8 [|1; 2; 3; 4; 5|] |> Int8Array.copy)
      )
    ; ( "typed_array - sliceFrom"
      , fun _ ->
          Eq (mkI8 [|3; 4; 5|], mkI8 [|1; 2; 3; 4; 5|] |> Int8Array.sliceFrom 2)
      )
    ...
    ; ( "typed_array - toString"
      , fun _ -> Eq ("1,2,3", mkI8 [|1; 2; 3|] |> Int8Array.toString) )
    ; ( "typed_array - toLocaleString"
      , fun _ -> Eq ("1,2,3", mkI8 [|1; 2; 3|] |> Int8Array.toLocaleString) )
    ; (* es2015, iterator "typed_array - entries", (fun _ -> Eq(mkI8 [| (0,
         "a"); (1, "b"); (2, "c") |], mkI8 [| "a"; "b"; "c" |] |>
         Int8Array.entries |> Int8Array.from) ); *)
      ( "typed_array - every"
      , fun _ ->
          Eq (true, mkI8 [|1; 2; 3|] |> Int8Array.every (fun [@bs] n -> n > 0))
      )
    ; ( "typed_array - everyi"
      , fun _ ->
          Eq
            ( false
            , mkI8 [|1; 2; 3|] |> Int8Array.everyi (fun [@bs] _ i -> i > 0) )
      )
    ; ( "typed_array - filter"
      , fun _ ->
          Eq
            ( mkI8 [|2; 4|]
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.filter (fun [@bs] n -> n mod 2 = 0) ) )
    ; ( "typed_array - filteri"
      , fun _ ->
          Eq
            ( mkI8 [|1; 3|]
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.filteri (fun [@bs] _ i -> i mod 2 = 0) ) )
    ; ( "typed_array - find"
      , fun _ ->
          Eq
            ( Js.Undefined.return 2
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.find (fun [@bs] n -> n mod 2 = 0) ) )
    ; ( "typed_array - findi"
      , fun _ ->
          Eq
            ( Js.Undefined.return 1
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.findi (fun [@bs] _ i -> i mod 2 = 0) ) )
    ; ( "typed_array - findIndex"
      , fun _ ->
          Eq
            ( 1
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.findIndex (fun [@bs] n -> n mod 2 = 0) ) )
    ; ( "typed_array - findIndexi"
      , fun _ ->
          Eq
            ( 0
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.findIndexi (fun [@bs] _ i -> i mod 2 = 0) ) )
    ; ( "typed_array - forEach"
      , fun _ ->
          let sum = ref 0 in
          let _ =
            mkI8 [|1; 2; 3|]
            |> Int8Array.forEach (fun [@bs] n -> sum := !sum + n) in
          Eq (6, !sum) )
    ; ( "typed_array - forEachi"
      , fun _ ->
          ...
          let _ =
            mkI8 [|1; 2; 3|]
            |> Int8Array.forEachi (fun [@bs] _ i -> sum := !sum + i) in
          Eq (3, !sum) )
    ; (* es2015, iterator "typed_array - keys", (fun _ -> Eq(mkI8 [| 0; 1; 2
         |], mkI8 [| "a"; "b"; "c" |] |> Int8Array.keys |> Int8Array.from) ); *)
      ( "typed_array - map"
      , fun _ ->
          Eq
            ( mkI8 [|2; 4; 6; 8|]
            , mkI8 [|1; 2; 3; 4|] |> Int8Array.map (fun [@bs] n -> n * 2) ) )
    ; ( "typed_array - map"
      , fun _ ->
          Eq
            ( mkI8 [|0; 2; 4; 6|]
            , mkI8 [|1; 2; 3; 4|] |> Int8Array.mapi (fun [@bs] _ i -> i * 2) )
      )
    ; ( "typed_array - reduce"
      , fun _ ->
          Eq
            ( -10
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.reduce (fun [@bs] acc n -> acc - n) 0 ) )
    ; ( "typed_array - reducei"
      , fun _ ->
          Eq
            ( -6
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.reducei (fun [@bs] acc _ i -> acc - i) 0 ) )
    ; ( "typed_array - reduceRight"
      , fun _ ->
          Eq
            ( -10
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.reduceRight (fun [@bs] acc n -> acc - n) 0 ) )
    ; ( "typed_array - reduceRighti"
      , fun _ ->
          Eq
            ( -6
            , mkI8 [|1; 2; 3; 4|]
              |> Int8Array.reduceRighti (fun [@bs] acc _ i -> acc - i) 0 ) )
    ; ( "typed_array - some"
      , fun _ ->
          Eq
            ( false
            , mkI8 [|1; 2; 3; 4|] |> Int8Array.some (fun [@bs] n -> n <= 0) )
      )
    ; ( "typed_array - somei"
      , fun _ ->
          Eq
            ( true
            , mkI8 [|1; 2; 3; 4|] |> Int8Array.somei (fun [@bs] _ i -> i <= 0)
            ) )
    ; (* es2015, iterator "typed_array - values", (fun _ -> Eq(mkI8 [| "a";
         "b"; "c" |], mkI8 [| "a"; "b"; "c" |] |> Int8Array.values |>
         Int8Array.from) ); *)

      (* Int8Array *)
      ( "int8_array - _BYTES_PER_ELEMENT"
      , fun _ -> Eq (1, Int8Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "int8_array - make"
      , fun _ -> Eq (3, Int8Array.make [|1; 2; 3|] |> Int8Array.byteLength) )
    ; ( "int8_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Int8Array.fromBuffer
    ...
    ; ( "int8_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 2
            , Int8Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Int8Array.byteLength ) )
    ; ( "int8_array - fromLength"
      , fun _ -> Eq (3, Int8Array.fromLength 3 |> Int8Array.byteLength) )
    ; (* unable to test because nothing currently implements array_like
         "int8_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Int8Array.from |> Int8Array.byteLength)); *)
    ...
    ; (* Uint8Array *)
      ...
      , fun _ -> Eq (1, Uint8Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "uint8_array - make"
      , fun _ -> Eq (3, Uint8Array.make [|1; 2; 3|] |> Uint8Array.byteLength)
      )
    ; ( "uint8_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Uint8Array.fromBuffer
    ...
    ; ( "uint8_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 2
            , Uint8Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Uint8Array.byteLength ) )
    ; ( "uint8_array - fromLength"
      , fun _ -> Eq (3, Uint8Array.fromLength 3 |> Uint8Array.byteLength) )
    ; (* unable to test because nothing currently implements array_like
         "uint8_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Uint8Array.from |> Uint8Array.byteLength)); *)
    ...
    ; (* Uint8ClampedArray *)
      ...
      , fun _ -> Eq (1, Uint8ClampedArray._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "uint8clamped_array - make"
      , fun _ ->
          Eq
            ( 3
            , Uint8ClampedArray.make [|1; 2; 3|]
              |> Uint8ClampedArray.byteLength ) )
    ; ( "uint8clamped_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Uint8ClampedArray.fromBuffer
              |> Uint8ClampedArray.byteLength ) )
    ; ( "uint8clamped_array - fromBufferOffset"
      , fun _ ->
          ...
          Eq
            ( 24
            , Uint8ClampedArray.fromBufferOffset buffer 8
              |> Uint8ClampedArray.byteLength ) )
    ...
    ; (* unable to test because nothing currently implements array_like
         "uint8clamped_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Uint8ClampedArray.from |>
         Uint8ClampedArray.byteLength)); *)
    ...
    ; (* Int16Array *)
      ...
      , fun _ -> Eq (2, Int16Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "int16_array - make"
      , fun _ -> Eq (6, Int16Array.make [|1; 2; 3|] |> Int16Array.byteLength)
      )
    ; ( "int16_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Int16Array.fromBuffer
    ...
    ; ( "int16_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 4
            , Int16Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Int16Array.byteLength ) )
    ; ( "int16_array - fromLength"
      , fun _ -> Eq (6, Int16Array.fromLength 3 |> Int16Array.byteLength) )
    ; (* unable to test because nothing currently implements array_like
         "int16_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Int16Array.from |> Int16Array.byteLength)); *)
    ...
    ; (* Uint16Array *)
      ...
      , fun _ -> Eq (2, Uint16Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "uint16_array - make"
      , fun _ -> Eq (6, Uint16Array.make [|1; 2; 3|] |> Uint16Array.byteLength)
      )
    ; ( "uint16_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Uint16Array.fromBuffer
    ...
    ; ( "uint16_array - fromBufferOffset"
      , fun _ ->
          ...
          Eq
            ( 24
            , Uint16Array.fromBufferOffset buffer 8 |> Uint16Array.byteLength
            ) )
    ; ( "uint16_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 4
            , Uint16Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Uint16Array.byteLength ) )
    ; ( "uint16_array - fromLength"
      , fun _ -> Eq (6, Uint16Array.fromLength 3 |> Uint16Array.byteLength) )
    ; (* unable to test because nothing currently implements array_like
         "uint16_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Uint16Array.from |> Uint16Array.byteLength)); *)
    ...
    ; (* Int32Array *)
      ...
      , fun _ -> Eq (4, Int32Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "int32_array - make"
      , fun _ ->
          Eq
            ( 12
            , Int32Array.make ([|1; 2; 3|] |> Array.map Int32.of_int)
              |> Int32Array.byteLength ) )
    ; ( "int32_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Int32Array.fromBuffer
              |> Int32Array.byteLength ) )
    ...
    ; ( "int32_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 8
            , Int32Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Int32Array.byteLength ) )
    ; ( "int32_array - fromLength"
      , fun _ -> Eq (12, Int32Array.fromLength 3 |> Int32Array.byteLength) )
    ; (* unable to test because nothing currently implements array_like
         "int32_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Int32Array.from |> Int32Array.byteLength)); *)
      ( "int32_array - unsafe_set - typed_array sanity check"
      , fun _ ->
          let a =
            Int32Array.make ([|1; 2; 3; 4; 5|] |> Array.map Int32.of_int) in
    ...
    ; (* Uint32Array *)
      ...
      , fun _ -> Eq (4, Uint32Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "uint32_array - make"
      , fun _ -> Eq (12, Uint32Array.make [|1; 2; 3|] |> Uint32Array.byteLength)
      )
    ; ( "uint32_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Uint32Array.fromBuffer
    ...
    ; ( "uint32_array - fromBufferOffset"
      , fun _ ->
          ...
          Eq
            ( 24
            , Uint32Array.fromBufferOffset buffer 8 |> Uint32Array.byteLength
            ) )
    ; ( "uint32_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 8
            , Uint32Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Uint32Array.byteLength ) )
    ; ( "uint32_array - fromLength"
      , fun _ -> Eq (12, Uint32Array.fromLength 3 |> Uint32Array.byteLength) )
    ; (* unable to test because nothing currently implements array_like
         "uint32_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Uint32Array.from |> Uint32Array.byteLength)); *)
    ...
    ; (* Float32Array *)
      ...
      , fun _ -> Eq (4, Float32Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "float32_array - make"
      , fun _ ->
    ...
    ; ( "float32_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Float32Array.fromBuffer
    ...
    ; ( "float32_array - fromBufferOffset"
      , fun _ ->
          ...
          Eq
            ( 24
            , Float32Array.fromBufferOffset buffer 8 |> Float32Array.byteLength
            ) )
    ; ( "float32_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 8
            , Float32Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Float32Array.byteLength ) )
    ; ( "float32_array - fromLength"
      , fun _ -> Eq (12, Float32Array.fromLength 3 |> Float32Array.byteLength)
      )
    ; (* unable to test because nothing currently implements array_like
         "float32_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Float32Array.from |> Float32Array.byteLength)); *)
    ...
    ; (* Float64Array *)
      ...
      , fun _ -> Eq (8, Float64Array._BYTES_PER_ELEMENT) )
    ; (* byte length is a decent indicator of the kind of typed array *)
      ( "float64_array - make"
      , fun _ ->
    ...
    ; ( "float64_array - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> Float64Array.fromBuffer
    ...
    ; ( "float64_array - fromBufferOffset"
      , fun _ ->
          ...
          Eq
            ( 24
            , Float64Array.fromBufferOffset buffer 8 |> Float64Array.byteLength
            ) )
    ; ( "float64_array - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 16
            , Float64Array.fromBufferRange buffer ~offset:8 ~length:2
              |> Float64Array.byteLength ) )
    ; ( "float64_array - fromLength"
      , fun _ -> Eq (24, Float64Array.fromLength 3 |> Float64Array.byteLength)
      )
    ; (* unable to test because nothing currently implements array_like
         "float64_array - from", (fun _ -> Eq(3, [| "a"; "b"; "c" |] |>
         Js.Array.keys |> Float64Array.from |> Float64Array.byteLength)); *)
    ...
    ; ( "DataView - fromBuffer"
      , fun _ ->
          Eq
            ( 32
            , ArrayBuffer.make 32 |> DataView.fromBuffer |> DataView.byteLength
            ) )
    ...
    ; ( "DataView - fromBufferRange"
      , fun _ ->
          ...
          Eq
            ( 4
            , DataView.fromBufferRange buffer ~offset:8 ~length:4
              |> DataView.byteLength ) )
    ; ( "DataView - buffer"
      , fun _ ->
          let buffer = ArrayBuffer.make 32 in
    ...
    ; (* Testing against 2_147_483_649 would be better, but JS platform
         restrict us with int32 *)
