...
function Make(U) {
  ...
  return /* module */[
          ...
          /* map */U[/* map */11],
          /* mapi */U[/* mapi */12],
          /* rev_map */U[/* rev_map */13],
          /* fold_left */U[/* fold_left */14],
          /* fold_right */U[/* fold_right */15],
          /* iter2 */U[/* iter2 */16],
          /* map2 */U[/* map2 */17],
          /* rev_map2 */U[/* rev_map2 */18],
          /* fold_left2 */U[/* fold_left2 */19],
          /* fold_right2 */U[/* fold_right2 */20],
          /* for_all */U[/* for_all */21],
          /* exists */U[/* exists */22],
          /* for_all2 */U[/* for_all2 */23],
          /* exists2 */U[/* exists2 */24],
          /* mem */U[/* mem */25],
          /* memq */U[/* memq */26],
          /* find */U[/* find */27],
          /* filter */U[/* filter */28],
          /* find_all */U[/* find_all */29],
          /* partition */U[/* partition */30],
          /* assoc */U[/* assoc */31],
          /* assq */U[/* assq */32],
          /* mem_assoc */U[/* mem_assoc */33],
          /* mem_assq */U[/* mem_assq */34],
          /* remove_assoc */U[/* remove_assoc */35],
          /* remove_assq */U[/* remove_assq */36],
          /* split */U[/* split */37],
          /* combine */U[/* combine */38],
          /* sort */U[/* sort */39],
          /* stable_sort */U[/* stable_sort */40],
          /* fast_sort */U[/* fast_sort */41],
          /* sort_uniq */U[/* sort_uniq */42],
          /* merge */U[/* merge */43]
        ];
}
