...
var point = CamlinternalOO.make_class(shared$6, point_init);
...
function backup_ref_init($$class) {
  var inh = CamlinternalOO.inherits($$class, shared$3, 0, shared$1, ref, 1);
  var obj_init = inh[0];
  var inh$1 = CamlinternalOO.inherits($$class, shared$2, 0, [
        "restore",
        "save"
      ], backup, 1);
...
var widget = CamlinternalOO.make_class(shared$5, widget_init);
