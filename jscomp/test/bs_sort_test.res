...
let () = {
  ...
  b(__LOC__, S.isSorted([], cmp))

  b(__LOC__, S.isSorted([0], cmp))

  b(__LOC__, S.isSorted([0, 1], cmp))
  b(__LOC__, not(S.isSorted([1, 0], cmp)))
}
...
let () = {
  ...
  b(__LOC__, l, R.every(0, 1000, i => S.binarySearchBy(aa, i, cmp) == i))
  /* 0, 2, 4, ... 4000 */
  ...
  b(__LOC__, l, R.every(0, 1999, i => lnot(S.binarySearchBy(cc, 2 * i + 1, cmp)) == i + 1))
}
