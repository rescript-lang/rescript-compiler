...
assert_("File \"stack_comp_test.ml\", line 33, characters 32-39", to_list(s) === /* [] */0 && List.length(s.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 41, characters 41-48", to_list(s) === /* [] */0 && List.length(s.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 49, characters 10-17", List.length(s$1.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 68, characters 10-17", List.length(s$3.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 81, characters 10-17", List.length(s1.c) === 10);

assert_("File \"stack_comp_test.ml\", line 82, characters 10-17", List.length(s2.c) === 10);
...
for(var i$4 = 1; i$4 <= 10; ++i$4){
  Stack.push(i$4, s$4);
  assert_("File \"stack_comp_test.ml\", line 96, characters 12-19", List.length(s$4.c) === i$4);
  assert_("File \"stack_comp_test.ml\", line 97, characters 12-19", s$4.c !== /* [] */0);
}

for(var i$5 = 10; i$5 >= 1; --i$5){
  assert_("File \"stack_comp_test.ml\", line 100, characters 12-19", List.length(s$4.c) === i$5);
  assert_("File \"stack_comp_test.ml\", line 101, characters 12-19", s$4.c !== /* [] */0);
  Stack.pop(s$4);
}

assert_("File \"stack_comp_test.ml\", line 104, characters 10-17", List.length(s$4.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 117, characters 10-17", List.length(s1$1.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 119, characters 10-17", List.length(s1$1.c) === 0);

assert_("File \"stack_comp_test.ml\", line 119, characters 45-52", to_list(s1$1) === /* [] */0);

assert_("File \"stack_comp_test.ml\", line 120, characters 10-17", List.length(s2$1.c) === 0);
...
assert_("File \"stack_comp_test.ml\", line 126, characters 10-17", List.length(s1$2.c) === 4);
...
assert_("File \"stack_comp_test.ml\", line 128, characters 10-17", List.length(s1$2.c) === 4);
...
assert_("File \"stack_comp_test.ml\", line 129, characters 10-17", List.length(s2$2.c) === 4);
