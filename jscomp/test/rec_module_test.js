  ...
  while(true) {
    ...
    if (param) {
      ...
      if (l) {
        ...
        return Js_primitive.some(param[/* v */1]);
      }
    } else {
      return undefined;
    }
...
function mem(x, _param) {
  while(true) {
    var param = _param;
    if (param) {
      var c = Curry._2(AAA[/* compare */0], x, param[/* v */1]);
      if (c === 0) {
        return true;
      } else {
  ...
  while(true) {
    ...
    if (s1) {
      if (s2) {
        ...
        var v1 = s1[/* v */1];
        var l1 = s1[/* l */0];
        var c = Curry._2(AAA[/* compare */0], v1, s2[/* v */1]);
        if (c === 0) {
          if (subset(l1, l2)) {
            _s2 = r2;
            _s1 = r1;
...
function map(f, t) {
  if (t) {
    ...
    if (l === l$prime && v === v$prime && r === r$prime) {
      ...
      var v$1 = v$prime;
      var r$1 = r$prime;
      if ((l$1 === /* Empty */0 || Curry._2(AAA[/* compare */0], max_elt(l$1), v$1) < 0) && (r$1 === /* Empty */0 || Curry._2(AAA[/* compare */0], v$1, min_elt(r$1)) < 0)) {
