...
var A = CamlinternalMod.init_mod([
      "rec_module_test.ml",
      3,
      6
    ], [[0]]);

var B = CamlinternalMod.init_mod([
      "rec_module_test.ml",
      11,
      6
    ], [[0]]);
...
CamlinternalMod.update_mod([[0]], A, [even]);
...
CamlinternalMod.update_mod([[0]], B, [odd]);
...
var BB = CamlinternalMod.init_mod([
      "rec_module_test.ml",
      31,
      6
    ], [[
...
function add(x, t) {
  if (t) {
    ...
    var v = t[1];
    var l = t[0];
    var c = Caml_curry.app2(AAA[0], x, v);
    if (c) {
      if (c < 0) {
...
function mem(x, _param) {
  while(true) {
    var param = _param;
    if (param) {
      var c = Caml_curry.app2(AAA[0], x, param[1]);
      if (c) {
...
function compare(s1, s2) {
  ...
  while(true) {
    ...
    if (e1) {
      if (e2) {
        var c = Caml_curry.app2(AAA[0], e1[0], e2[0]);
        if (c !== 0) {
          return c;
        }
        else {
  ...
  while(true) {
    ...
    if (s1) {
      if (s2) {
        ...
        var v1 = s1[1];
        var l1 = s1[0];
        var c = Caml_curry.app2(AAA[0], v1, s2[1]);
        if (c) {
          if (c < 0) {
            if (subset(/* Node */{
                    0: l1,
    ...
    if (match) {
      ...
      if (match$1) {
        ...
        if (match$2) {
          ...
          if (match$3) {
            if (match$3[1]) {
              var l$1 = List.sort_uniq(AAA[0], l);
...
CamlinternalMod.update_mod([[0]], AAA, [compare$1]);
...
var suites_000 = /* tuple */[
  ...
  function () {
    return /* Eq */{
            ...
            1: /* tuple */[
              Caml_curry.app1(A[0], 2),
              Caml_curry.app1(AA[0], 4),
              Caml_curry.app1(B[0], 2),
              Caml_curry.app1(BB[0], 4)
            ],
            length: 2,
            tag: 0
          };
