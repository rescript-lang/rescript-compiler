...
type dependency = Jsx.dependency
...
@module("react")
external useEffect: (@uncurry (unit => option<unit => unit>), array<dependency>) => unit = "useEffect"
...
external useLayoutEffectOnEveryRender: (@uncurry (unit => option<unit => unit>)) => unit =
  "useLayoutEffect"
@module("react")
external useLayoutEffect: (@uncurry (unit => option<unit => unit>), array<dependency>) => unit =
  "useLayoutEffect"
...
@module("react")
external useMemo: (@uncurry (unit => 'any), array<dependency>) => 'any = "useMemo"
...
@module("react")
external useCallback: ('f, array<dependency>) => 'f = "useCallback"
...
external useInsertionEffectOnEveryRender: (@uncurry (unit => option<unit => unit>)) => unit =
  "useInsertionEffect"
@module("react")
external useInsertionEffect: (@uncurry (unit => option<unit => unit>), array<dependency>) => unit =
  "useInsertionEffect"
@module("react")
