...
Mt_global.collect_neq(id, suites, "File \"random_test.ml\", line 12, characters 6-13", (Random.self_init(void 0), Random.$$int(10000)), (Random.self_init(void 0), Random.$$int(1000)));
...
for(var i = 0; i <= 9; ++i){
  Caml_array.caml_array_set(v, i, Random.bool(void 0));
}
