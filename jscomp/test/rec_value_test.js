...
Caml_obj.caml_update_dummy(x, /* Nested :: */[
      1,x
    ]);
...
Caml_obj.caml_update_dummy(a, /* Nested :: */[
      2,b
    ]);

Caml_obj.caml_update_dummy(b, /* Nested :: */[
      3,c
    ]);

Caml_obj.caml_update_dummy(c, /* Nested :: */[
      3,a
    ]);

var xx = [];

Caml_obj.caml_update_dummy(xx, /* Nested :: */[
      1,xx
    ]);
...
var suites_001 = /* Nested :: */[
  /* tuple */[
    ...
    /* tuple */[
      ...
      /* tuple */[
        'File "rec_value_test.ml", line 111, characters 2-9',function () {
          return /* Eq */Block.__(0, [
                    /* Nested :: */[
                      1,[
                        2,/* [] */0
        ...
        /* tuple */[
          'File "rec_value_test.ml", line 114, characters 2-9',function () {
            return /* Eq */Block.__(0, [
                      /* Nested :: */[
                        2,[
                          3,/* [] */0
          ...
          /* tuple */[
            'File "rec_value_test.ml", line 117, characters 2-9',function () {
              return /* Eq */Block.__(0, [
                        /* Nested :: */[
                          1,[
                            2,[
            ...
            /* tuple */[
              'File "rec_value_test.ml", line 120, characters 2-9',function () {
                return /* Eq */Block.__(0, [
                          /* Nested :: */[
                            1,[
                              55,[
              ...
              /* tuple */[
                'File "rec_value_test.ml", line 123, characters 2-9',function () {
                  return /* Eq */Block.__(0, [
                            /* Nested :: */[
                              2,[
                                3,/* [] */0
                ...
                /* tuple */[
                  'File "rec_value_test.ml", line 126, characters 2-9',function () {
                    return /* Eq */Block.__(0, [
                              3,3
                            ]);
                  }
                  ...
                  /* tuple */[
                    'File "rec_value_test.ml", line 129, characters 2-9',function () {
                      if (rec_variant_b.tag) {
                        throw [
                              Caml_builtin_exceptions.assert_failure,[
                                "rec_value_test.ml",132,11
                              ]
                            ];
                      }
                      else {
                        return /* Eq */Block.__(0, [
                                  Curry._1(rec_variant_b[1], /* () */0),rec_variant_a
                                ]);
                      }
                    }
                  ],[
                    /* tuple */[
                      'File "rec_value_test.ml", line 134, characters 2-9',function () {
                        if (rec_variant_a.tag) {
                          return /* Eq */Block.__(0, [
                                    Curry._1(rec_variant_a[1], /* () */0),rec_variant_b
                                  ]);
                        }
                        else {
                          throw [
                                Caml_builtin_exceptions.assert_failure,[
                                  "rec_value_test.ml",137,11
                                ]
                              ];
                        }
                      }
