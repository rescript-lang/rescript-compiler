...
var suites_32 = List.map(function (param) {
      ...
      return /* tuple */[
              Curry._1(Printf.sprintf(/* Format */[
                        /* String_literal */Block.__(11, [
                            "swap32 ",/* Int */Block.__(4, [
                                /* Int_d */0,/* No_padding */0,/* No_precision */0,/* End_of_format */0
                              ])
                          ]),"swap32 %d"
                      ]), a),function () {
                return /* Eq */Block.__(0, [
                          Caml_int32.caml_int32_bswap(a),b
                        ]);
              }
            ];
  ...
  return $$Array.to_list($$Array.mapi(function (i, param) {
                  ...
                  return /* tuple */[
                          Curry._2(Format.asprintf(/* Format */[
                            ...
                            return /* Eq */Block.__(0, [
                                      Curry._1(Format.asprintf(x), Curry._1(swap, a)),b
                                    ]);
                          }
                        ];
                }, param[2]));
