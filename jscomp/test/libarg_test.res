...
let record = fmt /* args */ => accum := list{fmt, ...accum.contents}
...
let spec = {
  ...
  list{
    ...
    ("-t", Tuple(list{Bool(f_bool), String(f_string), Int(f_int)}), "Tuple (3)"),
    ("-sym", Symbol(list{"a", "b", "c"}, f_symbol), "Symbol (1)"),
