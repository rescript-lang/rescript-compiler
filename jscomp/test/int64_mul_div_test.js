...
Mt.from_pair_suites("Int64_mul_div_test", PervasivesU.$at(from_pairs("random", pairs), PervasivesU.$at(from_pairs("small", small_pairs), PervasivesU.$at(List.mapi((function (i, param) {
  let f = param[1];
  let i64 = param[0];
  return [
    "to_float_" + i,
