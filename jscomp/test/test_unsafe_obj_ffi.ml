...
(** imagine you have
    ...
    we can not use tuple since ambiguity (there is no single tuple), list or
    array is okay, prefer array to list
...
x ## hey A.[| 1;2;3;4 |]
    ...
    such cases, if it is already a property read, there ? how about
