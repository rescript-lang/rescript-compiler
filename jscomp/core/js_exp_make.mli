...
val int_comp : Lam_compat.comparison -> binary_op
val bool_comp : Lam_compat.comparison -> binary_op
val string_comp : Js_op.binop -> binary_op
val float_comp :  Lam_compat.comparison -> binary_op
val js_comp :  Lam_compat.comparison -> binary_op
