...
val literal : Ast_untagged_variants.literal -> t
...
val is_a_literal_case : literal_cases:Ast_untagged_variants.literal list -> block_cases:Ast_untagged_variants.block_type list -> t -> t
