...
let primitive ppf (prim : Lam.primitive) = match prim with 
  ...
  | Punboxnull -> fprintf ppf "[unboxnull]"
  ...
  | Pintcomp(Ceq, Cmp_int) -> fprintf ppf "==[int]"
  | Pintcomp(Cneq, Cmp_int) -> fprintf ppf "!=[int]"
  | Pintcomp(Ceq, Cmp_opt) -> fprintf ppf "=[int]"
  | Pintcomp(Cneq, Cmp_opt) -> fprintf ppf "<>[int]"
  | Pintcomp(Clt, _) -> fprintf ppf "<"
  | Pintcomp(Cle, _) -> fprintf ppf "<="
  | Pintcomp(Cgt, _) -> fprintf ppf ">"
  | Pintcomp(Cge, _) -> fprintf ppf ">="
