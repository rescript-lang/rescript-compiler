...
class virtual map =
  object ((o : 'self_type))
    ...
    method string_clause : string_clause -> string_clause =
      fun (_x, _x_i1) ->
        let _x = o#string _x in
        let _x_i1 = o#case_clause _x_i1 in (_x, _x_i1)
 ...
 *)
    ...
    method int_clause : int_clause -> int_clause =
      fun (_x, _x_i1) ->
        let _x = o#int _x in let _x_i1 = o#case_clause _x_i1 in (_x, _x_i1)
  ...
  *)
    ...
    *)
    ...
    method case_clause : case_clause -> case_clause =
      fun { switch_body = _x; should_break = _x_i1; comment = _x_i2 } ->
        let _x = o#block _x in
        let _x_i1 = o#bool _x_i1 in
        let _x_i2 = o#option (fun o -> o#string) _x_i2
        in { switch_body = _x; should_break = _x_i1; comment = _x_i2; }
    method block : block -> block = (* TODO: option remove *)
