...
let name_of_primitive = function
  ...
  | Pbigintorder -> "Pbigintorder"
  | Pbigintmin -> "Pbigintmin"
  | Pbigintmax -> "Pbigintmax"
  | Pstringlength -> "Pstringlength"
  | Pstringrefu -> "Pstringrefu"
  | Pstringrefs -> "Pstringrefs"
  | Pstringorder -> "Pstringorder"
  | Pstringmin -> "Pstringmin"
  | Pstringmax -> "Pstringmax"
