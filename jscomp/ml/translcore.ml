...
let transl_primitive_application loc prim env ty args =
  ...
  try
    ...
    | [ arg1; _ ]
      when Hashtbl.mem infix_table prim_name ->
        specialize_op (Hashtbl.find infix_table prim_name)
          env arg1.exp_type
    | _ ->
