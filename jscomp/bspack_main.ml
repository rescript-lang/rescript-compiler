...
let decorate_module base mli_name ml_name mli_content ml_content = 
...
let decorate_module_only base ml_name ml_content = 
  let base = String.capitalize base in 
  output_string stdout "module \n";
  output_string stdout base ; 
  output_string stdout "\n= struct\n";
...
let decorate_interface_only base mli_content mli_name = 
  let base = String.capitalize base in 
