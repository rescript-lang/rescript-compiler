...
// In case of type error, check the type of 'someFunWithNullThenOptionalArgs' in 'Core.re' and './CoreTS'.
...
// In case of type error, check the type of 'someFunWithNullUndefinedArg' in 'Core.re' and './CoreTS'.
