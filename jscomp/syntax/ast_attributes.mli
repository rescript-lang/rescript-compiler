...
val external_needs_to_be_encoded : t -> bool
val has_inline_in_stru : t -> bool
val has_inline_payload_in_sig : t -> attr option
...
val iter_process_bs_string_as_ast : t -> Parsetree.expression option
val has_bs_optional : t -> bool
val iter_process_bs_int_as : t -> int option

val iter_process_bs_string_or_int_as :
  t -> [`Int of int | `Str of string | `Json_str of string] option

val process_derive_type : t -> derive_attr * t
val iter_process_derive_type : t -> derive_attr
val bs : attr
val is_bs : attr -> bool
