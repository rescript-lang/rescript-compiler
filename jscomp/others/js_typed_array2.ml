...
# 215 "js_typed_array2.cppo.ml"
  ...
  *)
  ...
  (* *Array.of is redundant, use make *) 
# 216 "js_typed_array2.cppo.ml"
end

module Float64Array = struct
  
# 219 "js_typed_array2.cppo.ml"
