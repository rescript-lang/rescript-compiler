...
(* Mutator functions
*)
external copyWithin : 'a t -> to_:int -> 'a t = "" [@@bs.send] (** ES2015 *)
...
external pop : 'a t -> 'a option = "" [@@bs.send] [@@bs.return {undefined_to_opt}]
external push : 'a t -> 'a -> int = "" [@@bs.send]
external pushMany : 'a t -> 'a array -> int = "push" [@@bs.send] [@@bs.splice]

external reverseInPlace : 'a t -> 'a t = "reverse" [@@bs.send]

external shift : 'a t -> 'a option = "" [@@bs.send] [@@bs.return {undefined_to_opt}]
...
external unshift : 'a t -> 'a -> int = "" [@@bs.send]
...
external slice : 'a t -> start:int -> end_:int -> 'a t = "" [@@bs.send]
external copy : 'a t -> 'a t = "slice" [@@bs.send]
external sliceFrom : 'a t -> int -> 'a t = "slice" [@@bs.send]

external toString : 'a t -> string = "" [@@bs.send]
external toLocaleString : 'a t -> string = "" [@@bs.send]
...
external every : 'a t -> ('a  -> bool[@bs.uncurry]) -> bool = "" [@@bs.send]
...
external filter : 'a t -> ('a -> bool [@bs.uncurry]) -> 'a t = "" [@@bs.send]
external filteri : 'a t -> ('a -> int  -> bool[@bs.uncurry]) -> 'a t = "filter" [@@bs.send]

external find : 'a t -> ('a -> bool [@bs.uncurry]) -> 'a option = "" [@@bs.send] [@@bs.return {undefined_to_opt}] (** ES2015 *)
external findi : 'a t -> ('a -> int -> bool [@bs.uncurry]) -> 'a option  = "find" [@@bs.send] [@@bs.return {undefined_to_opt}] (** ES2015 *)

external findIndex : 'a t -> ('a -> bool [@bs.uncurry]) -> int = "" [@@bs.send] (** ES2015 *)
external findIndexi : 'a t -> ('a -> int -> bool [@bs.uncurry]) -> int = "findIndex" [@@bs.send] (** ES2015 *)

external forEach : 'a t -> ('a -> unit [@bs.uncurry]) -> unit = "" [@@bs.send]
...
external map : 'a t -> ('a  -> 'b [@bs.uncurry]) -> 'b t = "" [@@bs.send]
external mapi : 'a t -> ('a -> int ->  'b [@bs.uncurry]) -> 'b t = "map" [@@bs.send]

external reduce : 'a t ->  ('b -> 'a  -> 'b [@bs.uncurry]) -> 'b -> 'b = "" [@@bs.send]
external reducei : 'a t -> ('b -> 'a -> int -> 'b [@bs.uncurry]) -> 'b -> 'b = "reduce" [@@bs.send]

external reduceRight : 'a t ->  ('b -> 'a  -> 'b [@bs.uncurry]) -> 'b -> 'b = "" [@@bs.send]
external reduceRighti : 'a t -> ('b -> 'a -> int -> 'b [@bs.uncurry]) -> 'b -> 'b = "reduceRight" [@@bs.send]

external some : 'a t -> ('a  -> bool [@bs.uncurry]) -> bool = "" [@@bs.send]
