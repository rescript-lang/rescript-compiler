...
external \".!()": (t<'a>, int) => 'a = "%array_unsafe_get"

external \".!()<-": (t<'a>, int, 'a) => unit = "%array_unsafe_set"
...
let reduceReverse2U = (a, b, x, f) => {
  ...
  for i in len - 1 downto 0 {
    r.contents = f(. r.contents, \".!()"(a, i), \".!()"(b, i))
  }
  r.contents
}
