...
external toLocaleDateStringWithLocale : t -> locale:string -> ?options:'a Js.t -> unit -> string = "toLocaleDateString" [@@bs.send] (* TODO: has overloads with somewhat poor browser support *)
