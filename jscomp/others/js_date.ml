...
external toLocaleDateStringWithLocale : t -> locale:string -> ?options:'a -> unit -> string = "toLocaleDateString" [@@bs.send] (* TODO: has overloads with somewhat poor browser support *)
