...
(* warning: the optional flag legacy_behavior is EXPERIMENTAL and will be
   removed in the next version. You must not set it explicitly. It is only used
   by the type-checker implementation. *)
...
val symm :
  ...
  -> ('a2, 'b2, 'c2, 'd2, 'e2, 'f2, 'a1, 'b1, 'c1, 'd1, 'e1, 'f1) fmtty_rel
