...
*/
@new
external fromBuffer: ArrayBuffer.t => t = "Uint8Array"
...
*/
@new
external fromBufferToEnd: (ArrayBuffer.t, ~byteOffset: int) => t = "Uint8Array"
...
*/
@new
external fromBufferWithRange: (ArrayBuffer.t, ~byteOffset: int, ~length: int) => t = "Uint8Array"
