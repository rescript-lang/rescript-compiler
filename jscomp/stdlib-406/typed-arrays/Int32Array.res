...
*/
@new
external fromBuffer: ArrayBuffer.t => t = "Int32Array"
...
*/
@new
external fromBufferToEnd: (ArrayBuffer.t, ~byteOffset: int) => t = "Int32Array"
...
*/
@new
external fromBufferWithRange: (ArrayBuffer.t, ~byteOffset: int, ~length: int) => t = "Int32Array"
