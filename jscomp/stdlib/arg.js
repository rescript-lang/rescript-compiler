...
function usage_b(buf, speclist, errmsg) {
  Caml_curry.app1(Printf.bprintf(buf, [
            /* Format */0,
            [
              /* String */2,
              /* No_padding */0,
  ...
  return List.iter(function (param) {
              ...
              if (doc.length) {
                if (spec[0] === 11) {
                  return Caml_curry.app3(Printf.bprintf(buf$1, [
                                  /* Format */0,
                                  [
                                    /* String_literal */11,
                                    "  ",
                  ...
                  return Caml_curry.app2(Printf.bprintf(buf$1, [
                                  /* Format */0,
                                  [
                                    /* String_literal */11,
                                    "  ",
...
function usage(speclist, errmsg) {
  return Caml_curry.app1(Printf.eprintf([
                  /* Format */0,
                  [
                    /* String */2,
                    /* No_padding */0,
      ...
      case 0 : 
          ...
          switch (s) {
            ...
            case "-help" : 
                break;
            default:
              Caml_curry.app2(Printf.bprintf(b, [
                        /* Format */0,
                        [
                          /* String */2,
                          /* No_padding */0,
          ...
          break;
      case 1 : 
          Caml_curry.app4(Printf.bprintf(b, [
                    /* Format */0,
                    [
                      /* String */2,
                      /* No_padding */0,
    ...
    if (s.length >= 1 && s[0] === "-") {
      ...
      try {
        ...
        return function (param) {
          switch (param[0]) {
            case 0 : 
                return Caml_curry.app1(param[1], /* () */0);
            case 1 : 
                if (current$1[1] + 1 < l) {
            ...
            case 4 : 
                if (current$1[1] + 1 < l) {
                  Caml_curry.app1(param[1], argv[current$1[1] + 1]);
                  return ++ current$1[1];
                }
                else {
                  throw [
            ...
            case 11 : 
                ...
                if (current$1[1] + 1 < l) {
                  ...
                  if (List.mem(arg$5, symb)) {
                    Caml_curry.app1(param[2], argv[current$1[1] + 1]);
                    return ++ current$1[1];
                  }
                  else {
                    throw [
            ...
            case 12 : 
                ...
                while(current$1[1] < l - 1) {
                  Caml_curry.app1(f, argv[current$1[1] + 1]);
                  ++ current$1[1];
                };
                return /* () */0;
