...
let implementation ~use_super_errors ?(react_ppx_version = V3) prefix impl str :
    Js.Unsafe.obj =
      ...
      obj
        [|
          ...
          ( "shake_compile",
            inject
            @@ Js.wrap_meth_callback (fun _ code ->
                   shake_compile impl ~use_super_errors:false
                     (Js.to_string code)) );
          ...
          ( "shake_compile_super_errors",
            inject
            @@ Js.wrap_meth_callback (fun _ code ->
                   shake_compile impl ~use_super_errors:true (Js.to_string code))
          );
