...
@bs.send.pipe(: t) external collapseToStart: @as(json`true`) _ => unit = "collapse"
...
@bs.send.pipe(: t)
external compareBoundaryPoints: (int /* compareHow enum */, t) => int /* compareResult enum */ = ""
let compareBoundaryPoint: (
  Webapi__Dom__Types.compareHow,
  t,
  t,
) => Webapi__Dom__Types.compareResult = (how, range, self) =>
...
@bs.send.pipe(: t)
external getBoundingClientRect: Dom.domRect = "" /* experimental, but widely supported */
@bs.send.pipe(: t)
external getClientRects: array<Dom.domRect> = "" /* experimental, but widely supported */
