...
function reduce(s, accu, f) {
  return reduceU(s, accu, (function (a, b) {
    return f(a, b);
  }));
}
...
function partitionShared(n, p) {
  return partitionSharedU(n, (function (a) {
    return p(a);
  }));
}
...
function keepShared(n, p) {
  return keepSharedU(n, (function (a) {
    return p(a);
  }));
}
...
function partitionCopy(n, p) {
  return partitionCopyU(n, (function (a) {
    return p(a);
  }));
}
