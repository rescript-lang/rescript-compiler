  ...
  var trickleup = function (_i, e) {
    while(true) {
      ...
      if (Curry._2(cmp, Caml_array.get(a, father), e) < 0) {
        ...
        Caml_array.set(a, 0, e);
        return ;
      }
      Caml_array.set(a, i, e);
      return ;
    };
  };
  var l = a.length;
    ...
    var loop = function (_i1, _s1, _i2, _s2, _d) {
      while(true) {
        ...
        if (Curry._2(cmp, s1, s2) <= 0) {
          ...
          blit(src2, i2, dst, d + 1 | 0, src2r - i2 | 0);
          return ;
        }
        ...
        blit(a, i1, dst, d + 1 | 0, src1r - i1 | 0);
        return ;
      };
    };
    loop(src1ofs, Caml_array.get(a, src1ofs), src2ofs, Caml_array.get(src2, src2ofs), dstofs);
  };
