...
function Make(Ord) {
  ...
  let find_first_aux = (_v0, f, _param) => {
    while (true) {
      let param = _param;
      let v0 = _v0;
      if (typeof param !== "object") {
  ...
  let find_first_opt_aux = (_v0, f, _param) => {
    while (true) {
      let param = _param;
      let v0 = _v0;
      if (typeof param !== "object") {
  ...
  let find_last_aux = (_v0, f, _param) => {
    while (true) {
      let param = _param;
      let v0 = _v0;
      if (typeof param !== "object") {
  ...
  let find_last_opt_aux = (_v0, f, _param) => {
    while (true) {
      let param = _param;
      let v0 = _v0;
      if (typeof param !== "object") {
  ...
  let try_join = (l, v, r) => {
    if ((l === "Empty" || Ord.compare(max_elt(l), v) < 0) && (r === "Empty" || Ord.compare(v, min_elt(r)) < 0)) {
      return join(l, v, r);
    } else {
