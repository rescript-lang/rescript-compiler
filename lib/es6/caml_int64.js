...
function ten_times($$this) {
  var this_hi = $$this[/* hi */0];
  var exit = 0;
  if (!(this_hi !== -2147483648 && this_hi !== 0)) {
    exit = 2;
  }
  if (exit === 2 && $$this[/* lo */1] === 0) {
    return zero;
  }
  var this_lo = $$this[/* lo */1];
  if (this_hi < 0) {
    return neg(ten_times(neg($$this)));
  } else {
    var a48 = (this_hi >>> 16);
    var a32 = this_hi & 65535;
    var a16 = (this_lo >>> 16);
    var a00 = this_lo & 65535;
    var b48 = 0;
    var b32 = 0 & 65535;
    var b16 = 0;
    var b00 = 10 & 65535;
...
function to_string(self) {
  if (isSafeInteger(self)) {
    ...
    var rem = sub(self, ten_times(approx_div1));
    var rem_lo = rem[/* lo */1];
    var rem_hi = rem[/* hi */0];
