...
function lex_engine(tbls, i, buf) {
  return caml_lex_engine_aux(tbls, i, buf, Caml_js_exceptions.internalFromExtension({
    RE_EXN_ID: "Failure",
    _1: empty_token_lit
  }));
}
...
function new_lex_engine(tbl, i, buf) {
  return caml_new_lex_engine_aux(tbl, i, buf, Caml_js_exceptions.internalFromExtension({
    RE_EXN_ID: "Failure",
    _1: empty_token_lit
  }));
}
