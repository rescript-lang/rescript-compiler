...
function make_self_init(param) {
  return make(Caml_sys.caml_sys_random_seed(void 0));
}
...
function int64(s, bound) {
  ...
  while(true) {
    ...
    if (!Caml_int64.gt(Caml_int64.sub(r, v), Caml_int64.add(Caml_int64.sub(Int64.max_int, n), Caml_int64.one))) {
      return v;
    }
    continue ;
  };
...
function self_init(param) {
  return full_init$1(Caml_sys.caml_sys_random_seed(void 0));
}
