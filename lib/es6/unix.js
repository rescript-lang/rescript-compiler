...
Callback.register_exception("Unix.Unix_error", {
      ExceptionID: Unix_error.ExceptionID,
      _1: /* E2BIG */0,
      _2: "",
      _3: "",
      Debug: Unix_error.Debug
    });

Printexc.register_printer((function (param) {
        if (param.ExceptionID !== Unix_error.ExceptionID) {
          return ;
        }
        var e = param._1;
        var msg;
...
function handle_unix_error(f, arg) {
  try {
    ...
    if (exn.ExceptionID === Unix_error.ExceptionID) {
      var arg$1 = exn._3;
        ...
        while(true) {
          ...
          if (param) {
            ...
            try {
              ...
              if (exn$2.ExceptionID === Unix_error.ExceptionID) {
                var err = exn$2._1;
  ...
  try {
    ...
    if (exn.ExceptionID === /* Invalid_argument */-3) {
      ...
      List.iter((function (s) {
              ...
              switch (s.tag | 0) {
                case /* AI_SOCKTYPE */1 :
                    opt_socktype.contents = s[0];
                    return ;
                case /* AI_PROTOCOL */2 :
                    opt_protocol.contents = s[0];
                    return ;
                default:
                  return ;
              }
