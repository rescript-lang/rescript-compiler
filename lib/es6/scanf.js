...
function next_char(ib) {
  try {
    var c = Curry._1(ib.ic_get_next_char, void 0);
  ...
  if (Curry._1(digitp, c)) {
    ...
    while(true) {
      ...
      if (Curry._1(digitp, c$1)) {
        var width$3 = store_char(width$2, ib$1, c$1);
        _width = width$3;
        continue ;
      } else {
        if (c$1 !== 95) {
        ...
        var width$4 = ignore_char(width$2, ib$1);
        _width = width$4;
        continue ;
      }
    };
    ...
    if (c >= 58) {
      switch (c) {
        ...
        case 120 :
            ...
            var c1 = get_digit(void 0);
            var c2 = get_digit(void 0);
      ...
      var c1$1 = get_digit$1(void 0);
      var c2$1 = get_digit$1(void 0);
    ...
    switch (fmt.tag | 0) {
      ...
      case /* String */2 :
          ...
          var scan$3 = function (width, param, ib) {
            return scan_string(void 0, width, ib);
          };
      ...
      case /* Bool */9 :
          var scan$9 = function (param, param$1, ib) {
            ...
            return scan_string(void 0, m, ib);
          };
      ...
      case /* Format_subst */14 :
          ...
          var match$3;
          try {
            var match$4 = CamlinternalFormat.fmt_ebb_of_string(void 0, s$1);
            var match$5 = CamlinternalFormat.fmt_ebb_of_string(void 0, s$1);
            match$3 = /* tuple */[
      ...
      case /* Scan_char_set */20 :
          ...
          scan_chars_in_char_set(char_set, void 0, width$1, ib);
          var s$3 = token(ib);
          return /* Cons */[
                  s$3,
