...
function kscanf(ib, ef, param) {
  ...
  var k = function (readers, f) {
    ...
    try {
      ...
      if (exc.CamlExt.CamlId === Scan_failure.CamlId || exc.CamlExt.CamlId === Caml_builtin_exceptions.failure.CamlId || exc.CamlExt.CamlId === Caml_builtin_exceptions.end_of_file.CamlId) {
        args = /* Exc */Block.__(1, [exc]);
      } else {
        if (exc.CamlExt.CamlId === Caml_builtin_exceptions.invalid_argument.CamlId) {
