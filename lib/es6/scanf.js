...
function kscanf(ib, ef, param) {
  ...
  var k = function (readers, f) {
    ...
    try {
      ...
      if (exc.CamlExt === Scan_failure || exc.CamlExt === Caml_builtin_exceptions.failure || exc.CamlExt === Caml_builtin_exceptions.end_of_file) {
        args = /* Exc */Block.__(1, [exc]);
      } else {
        if (exc.CamlExt === Caml_builtin_exceptions.invalid_argument) {
