...
var env = {
  ...
  v_stack: Caml_array.caml_make_vect(100, void 0),
...
function grow_stacks(param) {
  ...
  var new_v = Caml_array.caml_make_vect(newsize, void 0);
...
function clear_parser(param) {
  $$Array.fill(env.v_stack, 0, env.stacksize, void 0);
  env.lval = void 0;
...
function symbol_start(param) {
  return symbol_start_pos(void 0).pos_cnum;
}

function symbol_end(param) {
  return symbol_end_pos(void 0).pos_cnum;
}
