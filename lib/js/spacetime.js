...
var enabled = Caml_missing_polyfill.not_implemented("caml_spacetime_enabled");
...
function create(path) {
  if (Caml_missing_polyfill.not_implemented("caml_spacetime_enabled")) {
    var channel = Pervasives.open_out(path);
    Caml_missing_polyfill.not_implemented("caml_register_channel_for_spacetime");
    var t = /* record */[
      /* channel */channel,
      /* closed */false
    ];
