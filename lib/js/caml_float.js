...
var caml_int_float_of_bits = (function(x){
    return new Float32Array(new Int32Array([x]).buffer)[0] 
    });

var caml_int_bits_of_float = (function(x){
...
exports.caml_int_float_of_bits = caml_int_float_of_bits;
exports.caml_int_bits_of_float = caml_int_bits_of_float;
