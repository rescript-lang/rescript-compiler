...
function partitionShared0(n, p) {
  if (n !== null) {
    ...
    var v = n.key;
    var r = n.right;
    var match = partitionShared0(l, p);
    var lf = match[1];
    var lt = match[0];
    var pv = p(v);
    var match$1 = partitionShared0(r, p);
    var rf = match$1[1];
    var rt = match$1[0];
    if (pv) {
      return /* tuple */[
  ...
  while(true) {
    ...
    if (s1 !== null) {
      if (s2 !== null) {
        ...
        if (c) {
          if (c < 0) {
            if (subset0(cmp, create(l1, v1, null), l2)) {
              _s1 = r1;
              continue ;
          ...
          } else if (subset0(cmp, create(null, v1, r1), r2)) {
            _s1 = l1;
            continue ;
...
function ofArray0(cmp, xs) {
  ...
  if (len) {
    ...
    var result = ofSortedArrayAux(xs, 0, next);
