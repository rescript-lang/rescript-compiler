...
function map(n, f) {
  if (n !== null) {
    var newLeft = map(n.left, f);
    var newD = f(n.value);
    var newRight = map(n.right, f);
    return {
            left: newLeft,
            key: n.key,
            value: newD,
...
function mapWithKey(n, f) {
  if (n !== null) {
    var key = n.key;
    var newLeft = mapWithKey(n.left, f);
    var newD = f(key, n.value);
    var newRight = mapWithKey(n.right, f);
    return {
            left: newLeft,
            key: key,
            value: newD,
...
function filterShared(n, p) {
  if (n !== null) {
    var v = n.key;
    var d = n.value;
    var newLeft = filterShared(n.left, p);
    var pvd = p(v, d);
    var newRight = filterShared(n.right, p);
    if (pvd) {
...
function filterMap(n, p) {
  if (n !== null) {
    var v = n.key;
    var d = n.value;
    var newLeft = filterMap(n.left, p);
    var pvd = p(v, d);
    var newRight = filterMap(n.right, p);
    if (pvd) {
