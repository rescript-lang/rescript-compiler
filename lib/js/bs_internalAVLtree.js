...
function filterShared0(n, p) {
  if (n !== null) {
    var v = n.key;
    var d = n.value;
    var newLeft = filterShared0(n.left, p);
    var pvd = p(v, d);
    var newRight = filterShared0(n.right, p);
    if (pvd) {
...
function getUndefined0(_n, x, cmp) {
  while(true) {
    var n = _n;
    if (n !== null) {
      var v = n.key;
...
function getWithDefault0(_n, x, def, cmp) {
  while(true) {
    var n = _n;
    if (n !== null) {
      var v = n.key;
...
exports.minKey0 = minKey0;
exports.minKeyUndefined0 = minKeyUndefined0;
exports.maxKey0 = maxKey0;
exports.maxKeyUndefined0 = maxKeyUndefined0;
exports.minimum0 = minimum0;
exports.minUndefined0 = minUndefined0;
exports.maximum0 = maximum0;
exports.maxUndefined0 = maxUndefined0;
...
exports.eq0 = eq0;
exports.get0 = get0;
exports.getUndefined0 = getUndefined0;
exports.getWithDefault0 = getWithDefault0;
exports.getExn0 = getExn0;
exports.mem0 = mem0;
