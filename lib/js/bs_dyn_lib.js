    ...
    while(true) {
      ...
      if (typeof v === "number") {
        ...
        switch (v.tag | 0) {
          ...
          case 12 : 
              ...
              $$Array.iteri((function(tab_level,values){
                  return function (i, item) {
                    ...
                    add(0, " =\n");
                    construct_string(b, Caml_io.caml_array_safe_get(values, i), tab_level + 2 | 0);
                    return add(0, ";\n");
                  }
          ...
          case 13 : 
              var values$1 = v[2];
              add(tab_level, Caml_io.caml_array_safe_get(v[0][/* constructors */0], v[1]));
              if (values$1.length !== 0) {
                add(tab_level, "(\n");
                $$Array.iteri((function(tab_level,values$1){
                    return function (i, _) {
                      return construct_string(b, Caml_io.caml_array_safe_get(values$1, i), tab_level + 2 | 0);
                    }
