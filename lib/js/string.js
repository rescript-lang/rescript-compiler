...
function unsafe_blits(dst, _pos, sep, seplen, _param) {
  while(true) {
    ...
    if (param) {
      ...
      var hd = param[0];
      if (tl) {
        Caml_string.caml_blit_string(hd, 0, dst, pos, hd.length);
        Caml_string.caml_blit_string(sep, 0, dst, pos + hd.length | 0, seplen);
        _param = tl;
...
function concat(sep, l) {
  if (l) {
    ...
    return Caml_string.bytes_to_string(unsafe_blits(Caml_string.caml_create_bytes(sum_lengths(0, seplen, l)), 0, sep, seplen, l));
  } else {
    return "";
  }
}
...
function uppercase_ascii(s) {
  return Caml_string.bytes_to_string(Bytes.uppercase_ascii(Caml_string.bytes_of_string(s)));
}

function lowercase_ascii(s) {
  return Caml_string.bytes_to_string(Bytes.lowercase_ascii(Caml_string.bytes_of_string(s)));
}

function capitalize_ascii(s) {
  return Caml_string.bytes_to_string(Bytes.capitalize_ascii(Caml_string.bytes_of_string(s)));
}

function uncapitalize_ascii(s) {
  return Caml_string.bytes_to_string(Bytes.uncapitalize_ascii(Caml_string.bytes_of_string(s)));
}
