...
function concat(sep, l) {
  if (l) {
    ...
    List.iter((function (s) {
            Pervasives.incr(num);
            len.contents = len.contents + s.length | 0;
            return /* () */0;
          }), l);
    var r = Caml_bytes.caml_create_bytes(len.contents + Caml_int32.imul(sep.length, num.contents - 1 | 0) | 0);
    Caml_bytes.caml_blit_string(hd, 0, r, 0, hd.length);
    var pos = /* record */{
      contents: hd.length
    };
    List.iter((function (s) {
            Caml_bytes.caml_blit_string(sep, 0, r, pos.contents, sep.length);
            pos.contents = pos.contents + sep.length | 0;
            Caml_bytes.caml_blit_string(s, 0, r, pos.contents, s.length);
            pos.contents = pos.contents + s.length | 0;
            return /* () */0;
          }), l[1]);
