  ...
  while(true) {
    ...
    if (s1 < s2) {
      ...
      if (i1$1 < src1r) {
        ...
        Caml_array.caml_array_blit(src2, i2, dst, d$1, src2r - i2 | 0);
      ...
      if (i1$2 < src1r && i2$1 < src2r) {
        ...
        Caml_array.caml_array_blit(src2, i2$1, dst, d$2, src2r - i2$1 | 0);
        return (d$2 + src2r | 0) - i2$1 | 0;
      } else {
        Caml_array.caml_array_blit(src, i1$2, dst, d$2, src1r - i1$2 | 0);
      ...
      if (i2$2 < src2r) {
        ...
        Caml_array.caml_array_blit(src, i1, dst, d$3, src1r - i1 | 0);
...
function inter(src, src1ofs, src1len, src2, src2ofs, src2len, dst, dstofs) {
  var src1r = src1ofs + src1len | 0;
  var src2r = src2ofs + src2len | 0;
  var _i1 = src1ofs;
  var _s1 = src[src1ofs];
  ...
  while(true) {
    ...
    if (s1 < s2) {
      ...
      if (i1$2 < src1r && i2$1 < src2r) {
        ...
        Caml_array.caml_array_blit(src, i1$2, dst, d, src1r - i1$2 | 0);
      ...
      if (i2$2 < src2r) {
        ...
        Caml_array.caml_array_blit(src, i1, dst, d, src1r - i1 | 0);
