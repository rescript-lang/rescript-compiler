...
function forEachReverse(a, f) {
  return forEachReverseU(a, Curry.__1(f));
}
...
function mapReverseU(a, f) {
  var l = a.length;
  var r = new Array(l);
  var lastIndex = l - 1 | 0;
  for(var i = 0; i <= lastIndex; ++i){
    r[i] = f(a[lastIndex - i | 0]);
  }
  return r;
}

function mapReverse(a, f) {
  return mapReverseU(a, Curry.__1(f));
}
...
function keepReverse(a, f) {
  return keepReverseU(a, Curry.__1(f));
}
...
function keepReverseWithIndexU(a, f) {
  var l = a.length;
  var r = new Array(l);
  var j = 0;
  for(var i = l - 1 | 0; i >= 0; --i){
...
function keepReverseWithIndex(a, f) {
  return keepReverseWithIndexU(a, Curry.__2(f));
}
...
function keepMapReverse(a, f) {
  return keepMapReverseU(a, Curry.__1(f));
}
...
function forEachReverseWithIndexU(a, f) {
  for(var i = a.length - 1 | 0; i >= 0; --i){
    f(i, a[i]);
  }
...
function forEachReverseWithIndex(a, f) {
  return forEachReverseWithIndexU(a, Curry.__2(f));
}
...
function mapReverseWithIndexU(a, f) {
  var l = a.length;
  var r = new Array(l);
  var lastIndex = l - 1 | 0;
  for(var i = 0; i <= lastIndex; ++i){
    r[i] = f(i, a[lastIndex - i | 0]);
  }
  return r;
}

function mapReverseWithIndex(a, f) {
  return mapReverseWithIndexU(a, Curry.__2(f));
}
...
exports.forEachReverseU = forEachReverseU;
...
exports.keepU = keepU;
exports.keep = keep;
exports.keepReverseU = keepReverseU;
exports.keepReverse = keepReverse;
exports.keepWithIndexU = keepWithIndexU;
exports.keepWithIndex = keepWithIndex;
exports.keepReverseWithIndexU = keepReverseWithIndexU;
exports.keepReverseWithIndex = keepReverseWithIndex;
exports.keepMapU = keepMapU;
exports.keepMap = keepMap;
exports.keepMapReverseU = keepMapReverseU;
exports.keepMapReverse = keepMapReverse;
exports.forEachWithIndexU = forEachWithIndexU;
exports.forEachWithIndex = forEachWithIndex;
exports.forEachReverseWithIndexU = forEachReverseWithIndexU;
exports.forEachReverseWithIndex = forEachReverseWithIndex;
exports.mapWithIndexU = mapWithIndexU;
exports.mapWithIndex = mapWithIndex;
exports.mapReverseWithIndexU = mapReverseWithIndexU;
exports.mapReverseWithIndex = mapReverseWithIndex;
