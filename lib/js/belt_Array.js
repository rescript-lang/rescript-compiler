...
function joinWithU(a, sep, toString) {
  ...
  while(true) {
    ...
    let i = _i;
    if (i === lastIndex) {
      return res + Curry._1(toString, a[i]);
    }
    _res = res + (Curry._1(toString, a[i]) + sep);
    _i = i + 1 | 0;
    continue;
  };
}
