...
function make(hintSize) {
  return Bs_internalBucketsType.make(/* () */0, /* () */0, hintSize);
}
...
var forEachU = Bs_internalBuckets.forEachU;

var forEach = Bs_internalBuckets.forEach;

var reduceU = Bs_internalBuckets.reduceU;

var reduce = Bs_internalBuckets.reduce;

var keepMapInPlaceU = Bs_internalBuckets.keepMapInPlaceU;
