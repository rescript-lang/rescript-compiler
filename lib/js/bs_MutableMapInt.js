...
function mapU(d, f) {
  return {
          data: Bs_internalAVLtree.mapU(d.data, f)
        };
}
...
function mapWithKeyU(d, f) {
  return {
          data: Bs_internalAVLtree.mapWithKeyU(d.data, f)
        };
}
...
function reduceU(d, acc, f) {
  return Bs_internalAVLtree.reduceU(d.data, acc, f);
}
...
function everyU(d, f) {
  return Bs_internalAVLtree.everyU(d.data, f);
}

function every(d, f) {
  return Bs_internalAVLtree.everyU(d.data, Curry.__2(f));
}

function someU(d, f) {
  return Bs_internalAVLtree.someU(d.data, f);
}

function some(d, f) {
  return Bs_internalAVLtree.someU(d.data, Curry.__2(f));
}
...
function has(d, v) {
  return Bs_internalMapInt.has(d.data, v);
}
...
function cmpU(d0, d1, f) {
  return Bs_internalMapInt.cmpU(d0.data, d1.data, f);
}
...
function eqU(d0, d1, f) {
  return Bs_internalMapInt.eqU(d0.data, d1.data, f);
}
...
function get(d, x) {
  return Bs_internalMapInt.get(d.data, x);
}

function getUndefined(d, x) {
  return Bs_internalMapInt.getUndefined(d.data, x);
}

function getWithDefault(d, x, def) {
  return Bs_internalMapInt.getWithDefault(d.data, x, def);
}

function getExn(d, x) {
  return Bs_internalMapInt.getExn(d.data, x);
}
