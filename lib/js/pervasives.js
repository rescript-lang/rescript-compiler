...
function open_out_gen(mode, perm, name) {
  var c = Caml_io.caml_ml_open_descriptor_out(Caml_missing_polyfill.not_implemented("caml_sys_open"));
  Caml_missing_polyfill.not_implemented("caml_ml_set_channel_name");
  return c;
}
...
function output_bytes(oc, s) {
  return Caml_missing_polyfill.not_implemented("caml_ml_output_bytes");
}
...
function open_in_gen(mode, perm, name) {
  var c = Caml_io.caml_ml_open_descriptor_in(Caml_missing_polyfill.not_implemented("caml_sys_open"));
  Caml_missing_polyfill.not_implemented("caml_ml_set_channel_name");
  return c;
}
