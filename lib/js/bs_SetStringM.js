...
function minimum(d) {
  return Bs_internalAVLset.minimum0(d.data);
}

function minUndefined(d) {
  return Bs_internalAVLset.minUndefined0(d.data);
}

function maximum(d) {
  return Bs_internalAVLset.maximum0(d.data);
}

function maxUndefined(d) {
  return Bs_internalAVLset.maxUndefined0(d.data);
}
...
function split(d, key) {
  ...
  var i = Bs_SortString.binarySearch(arr, key);
  var len = arr.length;
  if (i < 0) {
    var next = (-i | 0) - 1 | 0;
    return /* tuple */[
  ...
  if (dataa$1 !== null) {
    if (datab$1 !== null) {
      ...
      if (tmp[sizea - 1 | 0] < tmp[sizea] || tmp[totalSize - 1 | 0] < tmp[0]) {
        ...
        var k = Bs_SortString.intersect(tmp, 0, sizea, tmp, sizea, sizeb, tmp2, 0);
        return {
  ...
  if (dataa$1 !== null) {
    if (datab$1 !== null) {
      ...
      if (tmp[sizea - 1 | 0] < tmp[sizea] || tmp[totalSize - 1 | 0] < tmp[0]) {
        ...
        var k = Bs_SortString.diff(tmp, 0, sizea, tmp, sizea, sizeb, tmp2, 0);
        return {
                data: Bs_internalAVLset.ofSortedArrayAux(tmp2, 0, k)
              };
      }
  ...
  if (dataa$1 !== null) {
    if (datab$1 !== null) {
      ...
      if (tmp[sizea - 1 | 0] < tmp[sizea]) {
        ...
        var k = Bs_SortString.union(tmp, 0, sizea, tmp, sizea, sizeb, tmp2, 0);
        return {
                data: Bs_internalAVLset.ofSortedArrayAux(tmp2, 0, k)
              };
      }
