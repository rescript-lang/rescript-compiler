  ...
  if (hl > (hr + 2 | 0)) {
    if (l) {
      ...
      if (height(ll) >= height(lr)) {
        ...
        throw new Error("File \"map.cppo.ml\", line 34, characters 21-27");
      }
    } else {
      throw new Error("File \"map.cppo.ml\", line 28, characters 17-23");
    }
  } else if (hr > (hl + 2 | 0)) {
    if (r) {
      var rr = r[3];
      ...
      if (height(rr) >= height(rl)) {
        ...
        throw new Error("File \"map.cppo.ml\", line 46, characters 21-27");
      }
    } else {
      throw new Error("File \"map.cppo.ml\", line 40, characters 17-23");
    }
  } else {
    return /* Node */[
            l,
...
function min_bindingAssert(_param) {
  while(true) {
    var param = _param;
    if (param) {
      var l = param[0];
      ...
      throw new Error("File \"map.cppo.ml\", line 83, characters 15-21");
    }
  };
}

function minBinding(_param) {
  while(true) {
    var param = _param;
    if (param) {
      var l = param[0];
...
function remove_min_binding(param) {
  if (param) {
    ...
    throw new Error("File \"map.cppo.ml\", line 98, characters 15-21");
  }
}
...
function remove(x, param) {
  if (param) {
    ...
    if (x === v) {
      ...
      if (t1) {
        if (t2) {
          var match = min_bindingAssert(t2);
...
function merge(f, s1, s2) {
  ...
  if (exit === 1) {
    if (s2) {
      ...
      throw new Error("File \"map.cppo.ml\", line 225, characters 6-12");
    }
  }
