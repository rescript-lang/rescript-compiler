              ...
              if (Array.isArray(a)) {
                ...
                var do_key = function (param, key) {
                  ...
                  if (!b.hasOwnProperty(key) || caml_compare(param[0][key], b[key]) > 0) {
                    var match = min_key[0];
                    if (match !== undefined && key >= Js_primitive.valFromOption(match)) {
                      return 0;
                    } else {
                      min_key[0] = Js_primitive.some(key);
                      return /* () */0;
                    }
                  } else {
                    return 0;
                ...
                if (match !== undefined) {
                  if (match$1 !== undefined) {
                    return Caml_primitive.caml_string_compare(Js_primitive.valFromOption(match), Js_primitive.valFromOption(match$1));
                  } else {
                    return -1;
                  }
