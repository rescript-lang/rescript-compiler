              ...
              if (tag_a !== tag_b) {
                ...
                if (len_a === len_b) {
                  if (Array.isArray(a)) {
                    ...
                    var a$2 = a;
                    var b$2 = b;
                    var min_key_lhs = [/* contents */undefined];
                    var min_key_rhs = [/* contents */undefined];
                    var do_key = function (param, key) {
                      var min_key = param[2];
                      var b = param[1];
                      if (!b.hasOwnProperty(key) || caml_compare(param[0][key], b[key]) > 0) {
                        var match = min_key[/* contents */0];
                        if (match !== undefined && key >= match) {
                          return 0;
                        } else {
                          min_key[/* contents */0] = key;
                          return /* () */0;
                        }
                      } else {
                        return 0;
                    ...
                    for_in(a$2, do_key_a);
                    for_in(b$2, do_key_b);
                    var match = min_key_lhs[/* contents */0];
                    var match$1 = min_key_rhs[/* contents */0];
                    if (match !== undefined) {
