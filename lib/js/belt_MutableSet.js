...
function intersect(a, b) {
  ...
  if (match !== null) {
    if (match$1 !== null) {
      ...
      var tmp = (match.value, new Array(totalSize));
      ...
      if (cmp(tmp[sizea - 1 | 0], tmp[sizea]) < 0 || cmp(tmp[totalSize - 1 | 0], tmp[0]) < 0) {
        ...
        var tmp2 = (match.value, new Array(sizea < sizeb ? sizea : sizeb));
...
function diff(a, b) {
  ...
  if (dataa !== null) {
    if (match !== null) {
      ...
      var totalSize = sizea + sizeb | 0;
      var tmp = (dataa.value, new Array(totalSize));
      ...
      if (cmp(tmp[sizea - 1 | 0], tmp[sizea]) < 0 || cmp(tmp[totalSize - 1 | 0], tmp[0]) < 0) {
        ...
        var tmp2 = (dataa.value, new Array(sizea));
  ...
  if (dataa !== null) {
    if (datab !== null) {
      ...
      if (cmp(tmp[sizea - 1 | 0], tmp[sizea]) < 0) {
        ...
        var tmp2 = (dataa.value, new Array(totalSize));
