...
function remove0(nt, x, cmp) {
  ...
  if (c === 0) {
    ...
    if ((
      ...
      nt.right = remove0(match$3, x, cmp);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
...
function removeCheck0(nt, x, removed, cmp) {
  ...
  if (c === 0) {
    ...
    if ((
      ...
      nt.left = removeCheck0(match$2, x, removed, cmp);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
    ...
    if ((
      ...
      nt.right = removeCheck0(match$3, x, removed, cmp);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
...
function diff(a, b) {
  var cmp = a.cmp;
  var dataa = a.data;
  var match = dataa === null ? /* None */0 : [dataa];
  var match$1 = b.data;
  if (match !== /* None */0) {
    if ((
        match$1 === null ? /* None */0 : [match$1]
...
function union(a, b) {
  ...
  var datab = b.data;
  var match = dataa === null ? /* None */0 : [dataa];
  var match$1 = datab === null ? /* None */0 : [datab];
  if (match !== /* None */0) {
    if (match$1 !== /* None */0) {
      var sizea = Belt_internalAVLset.lengthNode(dataa);
