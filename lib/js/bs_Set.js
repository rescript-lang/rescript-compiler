...
function addArray(m, e) {
  var dict = m.dict;
  var data = m.data;
  var newData = Bs_internalSet.addArray0(dict[/* cmp */0], data, e);
  if (newData === data) {
    return m;
  } else {
    return {
...
function removeArray(m, e) {
  var dict = m.dict;
  var data = m.data;
  var newData = Bs_internalSet.removeArray0(data, e, dict[/* cmp */0]);
  if (newData === data) {
    return m;
  } else {
    return {
...
function cmp(m, n) {
  ...
  var mdata = m.data;
  var ndata = n.data;
  return Bs_internalSet.cmp0(mdata, ndata, dict[/* cmp */0]);
}
...
function split(m, e) {
  var dict = m.dict;
  var data = m.data;
  var match = Bs_internalSet.split0(dict[/* cmp */0], data, e);
  return /* tuple */[
          {
            dict: dict,
            data: match[0]
...
function findOpt(m, e) {
  var dict = m.dict;
  var data = m.data;
  return Bs_internalSet.findOpt0(dict[/* cmp */0], data, e);
}

function findNull(m, e) {
  var dict = m.dict;
  var data = m.data;
  return Bs_internalSet.findNull0(dict[/* cmp */0], data, e);
}
...
var addArray0 = Bs_internalSet.addArrayMutate;

var removeArray0 = Bs_internalSet.removeArray0;
...
var findNull0 = Bs_internalSet.findNull0;
