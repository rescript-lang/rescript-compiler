...
function concat(t1, t2) {
  if (t1) {
    if (t2) {
      return join(t1, min_elt0(t2), remove_min_elt(t2));
    } else {
      return t1;
    }
  } else {
...
function remove0(cmp, x, param) {
  if (param) {
    ...
    if (c) {
      ...
      if (t1) {
        if (t2) {
          return bal(t1, min_elt0(t2), remove_min_elt(t2));
        } else {
          return t1;
        }
      } else {
...
function equal0(cmp, s1, s2) {
  return +(compare0(cmp, s1, s2) === 0);
}
...
function for_all0(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (p(param[1])) {
        if (for_all0(p, param[0])) {
          _param = param[2];
          continue ;
...
function compare(m, n) {
  var m_cmp = m[/* cmp */0];
  return compare0(m_cmp[/* cmp */0], m[/* data */1], n[/* data */1]);
}

function equal(m, n) {
  var m_cmp = m[/* cmp */0];
  return equal0(m_cmp[/* cmp */0], m[/* data */1], n[/* data */1]);
}
...
function min_elt(m) {
  return min_elt0(m[/* data */1]);
}

function max_elt(m) {
  return max_elt0(m[/* data */1]);
}
...
function find(e, m) {
  var m_cmp = m[/* cmp */0];
  return find0(m_cmp[/* cmp */0], e, m[/* data */1]);
}
...
exports.min_elt0   = min_elt0;
exports.min_elt    = min_elt;
exports.max_elt0   = max_elt0;
