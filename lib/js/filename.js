...
function quote(a) {
  ...
  for(let i = 0; i < l; ++i){
    if (Caml_string.get(a, i) === /* '\'' */39) {
      $$Buffer.add_string(b, quotequote);
    } else {
      $$Buffer.add_char(b, Caml_string.get(a, i));
    }
  }
  $$Buffer.add_char(b, /* '\'' */39);
...
function basename$2(a) {
  return generic_basename(is_dir_sep$1, current_dir_name$2, a);
}

function dirname$2(a) {
  return generic_dirname(is_dir_sep$1, current_dir_name$2, a);
}
