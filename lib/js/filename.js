...
function chop_suffix(name, suff) {
  ...
  if (n < 0) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Filename.chop_suffix"
        ];
  }
  else {
...
function chop_extension(name) {
  ...
  while(true) {
    ...
    if (i < 0 || Curry._2(is_dir_sep$1, name, i)) {
      throw [
            Caml_builtin_exceptions.invalid_argument,"Filename.chop_extension"
          ];
    }
...
function temp_file_name(temp_dir, prefix, suffix) {
  ...
  return concat(temp_dir, Curry._3(Printf.sprintf(/* Format */[
                      /* String */Block.__(2, [
                          /* No_padding */0,/* Int */Block.__(4, [
                              /* Int_x */6,/* Lit_padding */Block.__(0, [
                                  /* Zeros */2,6
                                ]),/* No_precision */0,/* String */Block.__(2, [
...
function open_temp_file($staropt$star, $staropt$star$1, prefix, suffix) {
  var mode = $staropt$star ? $staropt$star[0] : /* Nested :: */[
      /* Open_text */7,/* [] */0
    ];
  ...
  while(true) {
    ...
    try {
      return /* tuple */[
              name,Pervasives.open_out_gen(/* Nested :: */[
                    /* Open_wronly */1,[
                      /* Open_creat */3,[
                        /* Open_excl */5,mode
                      ]
