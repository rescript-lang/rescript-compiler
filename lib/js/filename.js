...
function temp_file($staropt$star, prefix, suffix) {
  var temp_dir = $staropt$star !== /* None */0 ? $staropt$star[/* None */0] : current_temp_dir_name[0];
  var _counter = 0;
  while(true) {
...
function open_temp_file($staropt$star, $staropt$star$1, prefix, suffix) {
  var mode = $staropt$star !== /* None */0 ? $staropt$star[/* None */0] : /* :: */[
      /* Open_text */7,
      /* [] */0
    ];
  var temp_dir = $staropt$star$1 !== /* None */0 ? $staropt$star$1[/* None */0] : current_temp_dir_name[0];
  var _counter = 0;
  while(true) {
    var counter = _counter;
    var name = temp_file_name(temp_dir, prefix, suffix);
