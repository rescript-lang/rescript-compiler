...
var current_temp_dir_name = /* record */[/* contents */temp_dir_name$1];

function set_temp_dir_name(s) {
  current_temp_dir_name[/* contents */0] = s;
  return /* () */0;
}

function get_temp_dir_name(param) {
  return current_temp_dir_name[/* contents */0];
}

function temp_file($staropt$star, prefix, suffix) {
  var temp_dir = $staropt$star !== undefined ? $staropt$star : current_temp_dir_name[/* contents */0];
  var _counter = 0;
  while(true) {
...
function open_temp_file($staropt$star, $staropt$star$1, $staropt$star$2, prefix, suffix) {
  ...
  var temp_dir = $staropt$star$2 !== undefined ? $staropt$star$2 : current_temp_dir_name[/* contents */0];
  var _counter = 0;
  while(true) {
    var counter = _counter;
    var name = temp_file_name(temp_dir, prefix, suffix);
