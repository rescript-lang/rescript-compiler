...
Printexc.register_printer((function (param) {
        if (param[0] === Unix_error) {
          ...
          return Curry._3(Printf.sprintf(/* constructor */{
                          ...
                          Arg1: "Unix.Unix_error(Unix.%s, %S, %S)"
                        }), msg, param[2], param[3]);
        }
      ...
      List.iter((function (param) {
              if (typeof param === "string") {
                ...
                switch (/* XXX */param.tag) {
                  case "AI_SOCKTYPE" :
                      opt_socktype[0] = param.Arg0;
                      return /* () */0;
                  case "AI_PROTOCOL" :
                      opt_protocol[0] = param.Arg0;
                      return /* () */0;
                  default:
                    return /* () */0;
                }
