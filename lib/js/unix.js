...
function close_process_in(inchan) {
  var pid = find_proc_id("close_process_in", {
        TAG: /* Process_in */1,
        _0: inchan
      });
  Pervasives.close_in(inchan);
...
function close_process_out(outchan) {
  var pid = find_proc_id("close_process_out", {
        TAG: /* Process_out */2,
        _0: outchan
      });
  try {
...
function close_process(param) {
  var outchan = param[1];
  var inchan = param[0];
  var pid = find_proc_id("close_process", {
        TAG: /* Process */0,
        _0: inchan,
        _1: outchan
      });
...
function close_process_full(param) {
  ...
  var outchan = param[1];
  var inchan = param[0];
  var pid = find_proc_id("close_process_full", {
        TAG: /* Process_full */3,
        _0: inchan,
        _1: outchan,
        _2: errchan
