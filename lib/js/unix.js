...
Printexc.register_printer(function (param) {
      if (param[0] === Unix_error) {
        ...
        return /* Some */[Curry._3(Printf.sprintf(/* Format */[
                          /* String_literal */Block.__(11, [
                              "Unix.Unix_error(Unix.",/* String */Block.__(2, [
...
function read(_, buf, ofs, len) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.read"
        ];
  }
  else {
    return function () {
...
function write(_, buf, ofs, len) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.write"
        ];
  }
  else {
    return function () {
...
function single_write(_, buf, ofs, len) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.single_write"
        ];
  }
  else {
    return function () {
...
function recv(_, buf, ofs, len, _$1) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.recv"
        ];
  }
  else {
    return function () {
...
function recvfrom(_, buf, ofs, len, _$1) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.recvfrom"
        ];
  }
  else {
    return function () {
...
function send(_, buf, ofs, len, _$1) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.send"
        ];
  }
  else {
    return function () {
...
function sendto(_, buf, ofs, len, _$1, _$2) {
  if (ofs < 0 || len < 0 || ofs > (buf.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Unix.sendto"
        ];
  }
  else {
    return function () {
...
function getaddrinfo(node, service, opts) {
  try {
    ...
    if (exn[0] === Caml_builtin_exceptions.invalid_argument) {
      ...
      var get_port = function (ty, _) {
        if (service$1 === "") {
          ...
          try {
            return /* Nested :: */[
                    /* tuple */[
                      ty,Caml_format.caml_int_of_string(service$1)
                    ],/* [] */0
                  ];
          }
          catch (exn){
      ...
      var addresses;
      if (node$1 === "") {
        addresses = List.mem(/* AI_PASSIVE */2, opts$1) ? /* Nested :: */[
            /* tuple */[
              inet_addr_any,"0.0.0.0"
            ],/* [] */0
          ] : /* Nested :: */[
            /* tuple */[
              inet_addr_loopback,"127.0.0.1"
            ],/* [] */0
          ];
      }
      else {
      ...
      return List.flatten(List.map(function (param) {
                      ...
                      return List.map(function (param) {
                                  return /* record */[
                                          /* ai_family : PF_INET */1,/* ai_socktype */ty,/* ai_protocol */opt_protocol[0],/* ai_addr : ADDR_INET */Block.__(1, [
                                              param[0],port
  ...
  try {
    ...
    if (exn[0] === Caml_builtin_exceptions.invalid_argument) {
      ...
      if (addr$1.tag) {
        ...
        return /* record */[
                /* ni_hostname */"",/* ni_service */addr$1[0]
              ];
      }
    }
    else {
...
function open_process_in(cmd) {
  ...
  try {
    open_proc(cmd, /* Process_in */Block.__(1, [inchan]), 0, in_write, /* Nested :: */[
          in_read,/* [] */0
        ]);
  }
  catch (e){
...
function open_process_out(cmd) {
  ...
  try {
    open_proc(cmd, /* Process_out */Block.__(2, [outchan]), out_read, 1, /* Nested :: */[
          out_write,/* [] */0
        ]);
  }
  catch (e){
...
function open_process_full(cmd, env) {
  ...
  try {
    ...
    open_proc_full(cmd, env, /* Process_full */Block.__(3, [
          ...
          ]), out_read, in_write, err_write, /* Nested :: */[
          in_read,[
            out_write,[
              err_read,/* [] */0
            ]
...
function open_connection() {
  ...
  try {
    ...
    return /* tuple */[
            Caml_io.caml_ml_open_descriptor_in(sock),Caml_io.caml_ml_open_descriptor_out(sock)
          ];
  }
  catch (exn){
    (function () {
