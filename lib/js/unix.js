...
function getaddrinfo(node, service, opts) {
  try {
    ...
    if (exn[0] === Caml_builtin_exceptions.invalid_argument) {
      ...
      var opts$1 = opts;
      var opt_socktype = [/* contents */undefined];
      var opt_protocol = [/* contents */0];
      var opt_passive = [/* contents */false];
      List.iter((function (param) {
              if (typeof param === "number") {
                if (param === /* AI_PASSIVE */2) {
                  opt_passive[/* contents */0] = true;
                  return /* () */0;
                } else {
                  return /* () */0;
                }
                ...
                switch (param.tag | 0) {
                  case /* AI_SOCKTYPE */1 :
                      opt_socktype[/* contents */0] = param[0];
                      return /* () */0;
                  case /* AI_PROTOCOL */2 :
                      opt_protocol[/* contents */0] = param[0];
                      return /* () */0;
                  default:
                    return /* () */0;
                }
      ...
      var match = opt_socktype[/* contents */0];
      var ports;
      if (match !== undefined) {
        var ty = match;
        ports = ty !== 1 ? (
      ...
      return List.flatten(List.map((function (param) {
                        ...
                        return List.map((function (param) {
                                      return [
                                              /* ai_family : PF_INET */1,
                                              /* ai_socktype */ty,
                                              /* ai_protocol */opt_protocol[/* contents */0],
