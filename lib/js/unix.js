...
function map_file(fd, posOpt, kind, layout, shared, dims) {
  var pos = posOpt !== void 0 ? posOpt : Caml_int64.zero;
...
function system(cmd) {
  var id = Caml_external_polyfill.resolve("unix_fork")(void 0);
  if (id !== 0) {
...
function file_descr_not_standard(_fd) {
  while(true) {
    ...
    _fd = Caml_external_polyfill.resolve("unix_dup")(void 0, fd);
    continue ;
  };
}
...
var popen_processes = Hashtbl.create(void 0, 7);
...
function open_process_in(cmd) {
  var match = Caml_external_polyfill.resolve("unix_pipe")(true, void 0);
  var in_write = match[1];
  var inchan = Caml_external_polyfill.resolve("caml_ml_open_descriptor_in")(match[0]);
  try {
    open_proc(cmd, void 0, /* Process_in */Block.__(1, [inchan]), 0, in_write, 2);
  }
  catch (e){
...
function open_process_out(cmd) {
  ...
  try {
    open_proc(cmd, void 0, /* Process_out */Block.__(2, [outchan]), out_read, 1, 2);
  }
  catch (e){
...
function open_process(cmd) {
  ...
  var match$1;
  try {
    match$1 = Caml_external_polyfill.resolve("unix_pipe")(true, void 0);
  }
  catch (e){
  ...
  try {
    open_proc(cmd, void 0, /* Process */Block.__(0, [
            inchan,
            outchan
          ]), out_read, in_write, 2);
  }
...
function open_process_full(cmd, env) {
  ...
  var match$2;
  try {
    match$2 = Caml_external_polyfill.resolve("unix_pipe")(true, void 0);
  }
  catch (e$1){
    Caml_external_polyfill.resolve("unix_close")(in_read);
    Caml_external_polyfill.resolve("unix_close")(in_write);
...
function establish_server(server_fun, sockaddr) {
  ...
  while(true) {
    ...
    if (id !== 0) {
      ...
      if (Caml_external_polyfill.resolve("unix_fork")(void 0) !== 0) {
