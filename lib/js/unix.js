...
function open_process_in(cmd) {
  ...
  var in_read = match[0];
  var inchan = Caml_sys_fs.caml_ml_open_descriptor_in(in_read);
  try {
    ...
    Caml_sys_fs.caml_ml_close_channel(inchan);
    Caml_missing_polyfill.not_implemented("unix_close not implemented by bucklescript yet\n");
    throw e;
  }
  Caml_missing_polyfill.not_implemented("unix_close not implemented by bucklescript yet\n");
...
function open_process_out(cmd) {
  ...
  var outchan = Caml_sys_fs.caml_ml_open_descriptor_out(out_write);
  try {
    ...
    Caml_sys_fs.caml_ml_close_channel(outchan);
    Caml_missing_polyfill.not_implemented("unix_close not implemented by bucklescript yet\n");
    throw e;
  }
  Caml_missing_polyfill.not_implemented("unix_close not implemented by bucklescript yet\n");
...
function open_process_full(cmd, env) {
  ...
  try {
    ...
    var inchan = Caml_sys_fs.caml_ml_open_descriptor_in(in_read);
    var outchan = Caml_sys_fs.caml_ml_open_descriptor_out(out_write);
    var errchan = Caml_sys_fs.caml_ml_open_descriptor_in(err_read);
...
function close_process_full(param) {
  ...
  Caml_sys_fs.caml_ml_close_channel(errchan);
  return waitpid_non_intr(pid)[1];
}
...
function open_connection() {
  ...
  try {
    ...
    return /* tuple */[
            Caml_sys_fs.caml_ml_open_descriptor_in(sock),
            Caml_sys_fs.caml_ml_open_descriptor_out(sock)
          ];
  }
  catch (exn){
    Caml_missing_polyfill.not_implemented("unix_close not implemented by bucklescript yet\n");
...
function establish_server(server_fun, _) {
  ...
  while(true) {
    ...
    if (id !== 0) {
      ...
      var inchan = Caml_sys_fs.caml_ml_open_descriptor_in(s);
      var outchan = Caml_sys_fs.caml_ml_open_descriptor_out(s);
...
var in_channel_of_descr = Caml_sys_fs.caml_ml_open_descriptor_in;

var out_channel_of_descr = Caml_sys_fs.caml_ml_open_descriptor_out;
