...
function clear(h) {
  return Bs_internalBuckets.clear0(h.data);
}

function reset(h) {
  return Bs_internalBuckets.reset0(h.data);
}
...
function iter(f, h) {
  return Bs_internalBuckets.iter0(f, h.data);
}

function fold(f, h, init) {
  return Bs_internalBuckets.fold0(f, h.data, init);
}
