    ...
    if (l2 !== "[]") {
      ...
      if (Curry._2(order, h1, h2)) {
        return /* constructor */{
                tag: "::",
                Arg0: h1,
                Arg1: merge(order, l1.Arg1, l2)
              };
      } else {
        return /* constructor */{
                tag: "::",
                Arg0: h2,
                Arg1: merge(order, l1, l2.Arg1)
              };
      }
    } else {
      return l1;
  ...
  var initlist = function (param) {
    if (param !== "[]") {
      ...
      if (match !== "[]") {
        ...
        return /* constructor */{
                tag: "::",
                Arg0: Curry._2(order, e, e2) ? /* constructor */({
                      tag: "::",
                      Arg0: e,
                      Arg1: /* constructor */{
                        tag: "::",
  ...
  var merge2 = function (x) {
    if (x !== "[]") {
      ...
      if (match !== "[]") {
        return /* constructor */{
                tag: "::",
                Arg0: merge(order, x.Arg0, match.Arg0),
                Arg1: merge2(match.Arg1)
              };
      } else {
        return x;
      }
