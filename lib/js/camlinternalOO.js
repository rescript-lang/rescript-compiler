...
var params = /* record */[
  /* compact_table : true */1,/* copy_parent : true */1,/* clean_when_copying : true */1,/* retry_count */3,/* bucket_small_size */16
];
...
var dummy_table = /* record */[
  /* size */0,/* methods : array */[/* () */0],/* methods_by_name : Empty */0,/* methods_by_label : Empty */0,/* previous_states : [] */0,/* hidden_meths : [] */0,/* vars : Empty */0,/* initializers : [] */0
];
...
function new_table(pub_labels) {
  ...
  return /* record */[
          /* size */2,/* methods */methods,/* methods_by_name : Empty */0,/* methods_by_label : Empty */0,/* previous_states : [] */0,/* hidden_meths : [] */0,/* vars : Empty */0,/* initializers : [] */0
        ];
}
...
function narrow(table, vars, virt_meths, concr_meths) {
  ...
  table[/* previous_states */4] = /* Nested :: */[
    /* tuple */[
      table[/* methods_by_name */2],table[/* methods_by_label */3],table[/* hidden_meths */5],table[/* vars */6],virt_meth_labs,vars$1
...
function add_initializer(table, f) {
  table[/* initializers */7] = /* Nested :: */[
    f,table[/* initializers */7]
  ];
  return /* () */0;
}
...
function inherits(cla, vals, virt_meths, concr_meths, param, top) {
  ...
  widen(cla);
  return Caml_array.caml_array_concat(/* Nested :: */[
              /* array */[init],[
...
function make_class(pub_meths, class_init) {
  ...
  init_class(table);
  return /* tuple */[
          Curry._1(env_init, 0),class_init,env_init,0
        ];
}
...
function dummy_class(loc) {
  var undef = function () {
    throw [
          Caml_builtin_exceptions.undefined_recursive_module,loc
        ];
  };
  return /* tuple */[
          undef,undef,undef,0
...
function build_path(n, keys, tables) {
  var res = /* record */[
    /* key */0,/* data : Empty */0,/* next : Empty */0
  ];
  var r = res;
  for(var i = 0; i <= n; ++i){
    r = /* Cons */[
...
function stats() {
  return /* record */[
          /* classes */table_count[0],/* methods */method_count[0],/* inst_vars */inst_var_count[0]
        ];
}
