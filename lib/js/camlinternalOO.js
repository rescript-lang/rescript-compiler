...
var Bs_MapInt = require("./bs_MapInt.js");
var Caml_array = require("./caml_array.js");
var Caml_int32 = require("./caml_int32.js");
var Caml_string = require("./caml_string.js");
var Bs_MapString = require("./bs_MapString.js");
...
function get_method_label(table, name) {
  var match = Bs_MapString.findNull(table[/* methods_by_name */2], name);
  if (match !== null) {
    return match;
  } else {
    var label = new_method(table);
    table[/* methods_by_name */2] = Bs_MapString.update(table[/* methods_by_name */2], name, label);
    table[/* methods_by_label */3] = Bs_MapInt.update(table[/* methods_by_label */3], label, /* true */1);
    return label;
  }
}
...
function set_method(table, label, element) {
  ...
  if (Bs_MapInt.findExn(table[/* methods_by_label */3], label)) {
    var array = table;
    var label$1 = label;
...
function narrow(table, vars, virt_meths, concr_meths) {
  ...
  table[/* vars */6] = Bs_MapString.fold(table[/* vars */6], Bs_MapString.empty, (function (tvars, lab, info) {
          if (List.mem(lab, vars$1)) {
            return Bs_MapString.update(tvars, lab, info);
          } else {
            return tvars;
          }
        }));
  ...
  List.iter2((function (met, label) {
          by_name[0] = Bs_MapString.update(by_name[0], met, label);
          by_label[0] = Bs_MapInt.update(by_label[0], label, Bs_MapInt.findWithDefault(table[/* methods_by_label */3], label, /* true */1));
          return /* () */0;
        }), concr_meths$1, concr_meth_labs);
  List.iter2((function (met, label) {
          by_name[0] = Bs_MapString.update(by_name[0], met, label);
          by_label[0] = Bs_MapInt.update(by_label[0], label, /* false */0);
          return /* () */0;
...
function widen(table) {
  ...
  table[/* vars */6] = List.fold_left((function (s, v) {
          return Bs_MapString.update(s, v, Bs_MapString.findExn(table[/* vars */6], v));
        }), match[3], match[5]);
...
function new_variable(table, name) {
  var match = Bs_MapString.findNull(table[/* vars */6], name);
  if (match !== null) {
    return match;
  } else {
    var index = new_slot(table);
    if (name !== "") {
      table[/* vars */6] = Bs_MapString.update(table[/* vars */6], name, index);
    }
    return index;
  }
}
...
function get_variable(table, name) {
  return Bs_MapString.findExn(table[/* vars */6], name);
}

function get_variables(table, names) {
  return $$Array.map((function (param) {
                return Bs_MapString.findExn(table[/* vars */6], param);
              }), names);
}
...
function create_table(public_methods) {
  if (public_methods) {
    ...
    $$Array.iteri((function (i, met) {
            var lab = (i << 1) + 2 | 0;
            table[/* methods_by_name */2] = Bs_MapString.update(table[/* methods_by_name */2], met, lab);
            table[/* methods_by_label */3] = Bs_MapInt.update(table[/* methods_by_label */3], lab, /* true */1);
            return /* () */0;
          }), public_methods);
    return table;
  } else {
  ...
  return Caml_array.caml_array_concat(/* :: */[
              ...
              /* :: */[
                $$Array.map((function (param) {
                        return Bs_MapString.findExn(cla[/* vars */6], param);
                      }), to_array(vals)),
                /* :: */[
