...
function get_method_label(table, name) {
  var match = Bs_MapString.getUndefined(table[/* methods_by_name */2], name);
  if (match !== undefined) {
    return match;
  } else {
    var label = new_method(table);
    table[/* methods_by_name */2] = Bs_MapString.set(table[/* methods_by_name */2], name, label);
    table[/* methods_by_label */3] = Bs_MapInt.set(table[/* methods_by_label */3], label, /* true */1);
    return label;
  }
}
...
function narrow(table, vars, virt_meths, concr_meths) {
  ...
  table[/* vars */6] = Bs_MapString.reduceU(table[/* vars */6], Bs_MapString.empty, (function (tvars, lab, info) {
          if (List.mem(lab, vars$1)) {
            return Bs_MapString.set(tvars, lab, info);
          } else {
            return tvars;
          }
        }));
  ...
  List.iter2((function (met, label) {
          by_name[0] = Bs_MapString.set(by_name[0], met, label);
          by_label[0] = Bs_MapInt.set(by_label[0], label, Bs_MapInt.getWithDefault(table[/* methods_by_label */3], label, /* true */1));
          return /* () */0;
        }), concr_meths$1, concr_meth_labs);
  List.iter2((function (met, label) {
          by_name[0] = Bs_MapString.set(by_name[0], met, label);
          by_label[0] = Bs_MapInt.set(by_label[0], label, /* false */0);
          return /* () */0;
...
function widen(table) {
  ...
  table[/* vars */6] = List.fold_left((function (s, v) {
          return Bs_MapString.set(s, v, Bs_MapString.getExn(table[/* vars */6], v));
        }), match[3], match[5]);
...
function new_variable(table, name) {
  var match = Bs_MapString.getUndefined(table[/* vars */6], name);
  if (match !== undefined) {
    return match;
  } else {
    var index = new_slot(table);
    if (name !== "") {
      table[/* vars */6] = Bs_MapString.set(table[/* vars */6], name, index);
    }
    return index;
  }
}
...
function create_table(public_methods) {
  if (public_methods) {
    ...
    $$Array.iteri((function (i, met) {
            var lab = (i << 1) + 2 | 0;
            table[/* methods_by_name */2] = Bs_MapString.set(table[/* methods_by_name */2], met, lab);
            table[/* methods_by_label */3] = Bs_MapInt.set(table[/* methods_by_label */3], lab, /* true */1);
            return /* () */0;
          }), public_methods);
    return table;
  } else {
