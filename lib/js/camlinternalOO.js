...
function get_method_label(table, name) {
  var match = Bs_MapString.getNull(table[/* methods_by_name */2], name);
  if (match !== null) {
    return match;
  } else {
...
function set_method(table, label, element) {
  ...
  if (Bs_MapInt.getExn(table[/* methods_by_label */3], label)) {
    var array = table;
    var label$1 = label;
...
function narrow(table, vars, virt_meths, concr_meths) {
  ...
  List.iter2((function (met, label) {
          ...
          by_label[0] = Bs_MapInt.update(by_label[0], label, Bs_MapInt.getWithDefault(table[/* methods_by_label */3], label, /* true */1));
          return /* () */0;
...
function widen(table) {
  ...
  table[/* vars */6] = List.fold_left((function (s, v) {
          return Bs_MapString.update(s, v, Bs_MapString.getExn(table[/* vars */6], v));
        }), match[3], match[5]);
...
function new_variable(table, name) {
  var match = Bs_MapString.getNull(table[/* vars */6], name);
  if (match !== null) {
    return match;
  } else {
...
function get_variable(table, name) {
  return Bs_MapString.getExn(table[/* vars */6], name);
}

function get_variables(table, names) {
  return $$Array.map((function (param) {
                return Bs_MapString.getExn(table[/* vars */6], param);
              }), names);
}
  ...
  return Caml_array.caml_array_concat(/* :: */[
              ...
              /* :: */[
                $$Array.map((function (param) {
                        return Bs_MapString.getExn(cla[/* vars */6], param);
                      }), to_array(vals)),
                /* :: */[
