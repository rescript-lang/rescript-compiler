...
function get_method_label(table, name) {
  ...
  if (match) {
    ...
    table[/* methods_by_label */3] = Bs_MapInt.add(label, true, table[/* methods_by_label */3]);
    return label;
  }
}
...
function narrow(table, vars, virt_meths, concr_meths) {
  ...
  List.iter2((function (met, label) {
          ...
          by_label[0] = Bs_MapInt.add(label, Bs_MapInt.findWithDefault(true, label, table[/* methods_by_label */3]), by_label[0]);
          return /* () */0;
        }), concr_meths$1, concr_meth_labs);
  List.iter2((function (met, label) {
          by_name[0] = Bs_MapString.add(met, label, by_name[0]);
          by_label[0] = Bs_MapInt.add(label, false, by_label[0]);
          return /* () */0;
...
function create_table(public_methods) {
  if (public_methods) {
    ...
    $$Array.iteri((function (i, met) {
            ...
            table[/* methods_by_label */3] = Bs_MapInt.add(lab, true, table[/* methods_by_label */3]);
            return /* () */0;
          }), public_methods);
    return table;
  } else {
