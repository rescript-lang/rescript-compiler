...
var Array1 = /* module */[
  /* create */create,/* of_array */of_array,/* map_file */map_file$1
];
...
function of_array$1(kind, layout, data) {
  ...
  for(var i = 0 ,i_finish = dim1 - 1 | 0; i <= i_finish; ++i){
    ...
    if (row.length !== dim2) {
      throw [
            Caml_builtin_exceptions.invalid_argument,"Bigarray.Array2.of_array: non-rectangular data"
          ];
    }
...
var Array2 = /* module */[
  /* create */create$1,/* slice_left */slice_left,/* slice_right */slice_right,/* of_array */of_array$1,/* map_file */map_file$2
];
...
function of_array$2(kind, layout, data) {
  ...
  for(var i = 0 ,i_finish = dim1 - 1 | 0; i <= i_finish; ++i){
    ...
    if (row.length !== dim2) {
      throw [
            Caml_builtin_exceptions.invalid_argument,"Bigarray.Array3.of_array: non-cubic data"
          ];
    }
    for(var j = 0 ,j_finish = dim2 - 1 | 0; j <= j_finish; ++j){
      var col = row[j];
...
var Array3 = /* module */[
  /* create */create$2,/* slice_left_1 */slice_left_1,/* slice_right_1 */slice_right_1,/* slice_left_2 */slice_left_2,/* slice_right_2 */slice_right_2,/* of_array */of_array$2,/* map_file */map_file$3
];
...
function array1_of_genarray(a) {
  if (function () {
    ...
    throw [
          Caml_builtin_exceptions.invalid_argument,"Bigarray.array1_of_genarray"
        ];
  }
}
...
function array2_of_genarray(a) {
  if (function () {
    ...
    throw [
          Caml_builtin_exceptions.invalid_argument,"Bigarray.array2_of_genarray"
        ];
  }
}
...
function array3_of_genarray(a) {
  if (function () {
    ...
    throw [
          Caml_builtin_exceptions.invalid_argument,"Bigarray.array3_of_genarray"
        ];
  }
}
