  ...
  if (typeof s === "number") {
    switch (s) {
      ...
      case /* Pp_end */1 :
          ...
          if (match$1) {
            state.pp_format_stack = match$1._1;
            return ;
          } else {
            return ;
          }
      case /* Pp_tend */2 :
          ...
          if (match$2) {
            state.pp_tbox_stack = match$2._1;
            return ;
          } else {
            return ;
          }
      case /* Pp_newline */3 :
          ...
          if (match$3) {
            return break_new_line(state, 0, match$3._0._1);
          } else {
            return Curry._1(state.pp_out_newline, undefined);
          }
      ...
      case /* Pp_close_tag */5 :
          ...
          var marker = Curry._1(state.pp_mark_close_tag, match$5._0);
          pp_output_string(state, marker);
          state.pp_mark_stack = match$5._1;
          return ;
    ...
    switch (s.tag | 0) {
      ...
      case /* Pp_begin */3 :
          ...
          state.pp_format_stack = /* :: */{
            ...
            _1: state.pp_format_stack
          };
          return ;
      case /* Pp_tbegin */4 :
          state.pp_tbox_stack = /* :: */{
            _0: s._0,
            _1: state.pp_tbox_stack
          };
          return ;
      case /* Pp_open_tag */5 :
          var tag_name = s._0;
...
function pp_close_tag(state, param) {
  ...
  if (match) {
    Curry._1(state.pp_print_close_tag, match._0);
    state.pp_tag_stack = match._1;
    return ;
  }
...
function pp_make_formatter(f, g, h, i, j) {
  ...
  var sys_scan_stack = /* :: */{
    _0: sys_scan_stack_000,
    _1: scan_stack_bottom
  };
  return {
...
function add_symbolic_output_item(sob, item) {
  sob.symbolic_output_contents = /* :: */{
    _0: item,
    _1: sob.symbolic_output_contents
  };
...
function output_acc(ppf, acc) {
  ...
  switch (acc.tag | 0) {
    ...
    case /* Acc_formatting_gen */1 :
        ...
        output_acc(ppf, p$2);
        return pp_open_tag(ppf, compute_tag(output_acc, acc$prime._0));
...
function strput_acc(ppf, acc) {
  ...
  switch (acc.tag | 0) {
    ...
    case /* Acc_formatting_gen */1 :
        ...
        strput_acc(ppf, p$2);
        return pp_open_tag(ppf, compute_tag(strput_acc, acc$prime._0));
    case /* Acc_string_literal */2 :
        var p$3 = acc._0;
        var exit$1 = 0;
        if (typeof p$3 === "number" || p$3.tag) {
