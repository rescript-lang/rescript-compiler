    ...
    switch (param) {
      case /* Pp_stab */0 :
          ...
          if (match) {
            ...
            tabs[/* contents */0] = add_tab(state[/* pp_margin */5] - state[/* pp_space_left */8] | 0, tabs[/* contents */0]);
            return /* () */0;
          } else {
            return /* () */0;
          }
    ...
    switch (param.tag | 0) {
      ...
      case /* Pp_tbreak */2 :
          ...
          if (match$8) {
            ...
            var match$9 = tabs$1[/* contents */0];
            var tab;
            if (match$9) {
              try {
                tab = find(insertion_point, tabs$1[/* contents */0]);
              }
              catch (exn){
...
function pp_open_tbox(state, param) {
  ...
  if (state[/* pp_curr_depth */13] < state[/* pp_max_boxes */14]) {
    var elem = [
      /* elem_size */0,
      /* token : Pp_tbegin */Block.__(4, [/* Pp_tbox */[[/* contents : [] */0]]]),
      /* length */0
    ];
...
function make_symbolic_output_buffer(param) {
  return [/* symbolic_output_contents : [] */0];
}
...
function pp_print_text(ppf, s) {
  var len = s.length;
  var left = [/* contents */0];
  var right = [/* contents */0];
  var flush = function (param) {
    pp_print_string(ppf, $$String.sub(s, left[/* contents */0], right[/* contents */0] - left[/* contents */0] | 0));
    right[/* contents */0] = right[/* contents */0] + 1 | 0;
    left[/* contents */0] = right[/* contents */0];
    return /* () */0;
  };
  while(right[/* contents */0] !== len) {
    var match = Caml_string.get(s, right[/* contents */0]);
    if (match !== 10) {
      if (match !== 32) {
        right[/* contents */0] = right[/* contents */0] + 1 | 0;
      } else {
