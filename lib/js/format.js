...
function pp_print_list($staropt$star, pp_v, ppf, param) {
  var _$staropt$star = $staropt$star;
  var pp_v$1 = Curry.__2(pp_v);
  var ppf$1 = ppf;
  var _param = param;
  while(true) {
    var param$1 = _param;
    var $staropt$star$1 = _$staropt$star;
    var pp_sep = $staropt$star$1 ? $staropt$star$1[0] : pp_print_cut;
    if (param$1) {
      var vs = param$1[1];
      var v = param$1[0];
      if (vs) {
        pp_v$1(ppf$1, v);
        Curry._2(pp_sep, ppf$1, /* () */0);
        _param = vs;
