...
function break_new_line(state, offset, width) {
  ...
  var real_indent = Caml_obj.caml_int_min(state[/* pp_max_indent */7], indent);
...
function pp_set_margin(state, n) {
  if (n >= 1) {
    ...
    var new_max_indent = state[/* pp_max_indent */7] <= state[/* pp_margin */5] ? state[/* pp_max_indent */7] : Caml_obj.caml_int_max(Caml_obj.caml_int_max(state[/* pp_margin */5] - state[/* pp_min_space_left */6] | 0, state[/* pp_margin */5] / 2 | 0), 1);
