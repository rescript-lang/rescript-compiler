...
function break_new_line(state, offset, width) {
  Curry._1(state.pp_out_newline, void 0);
...
function pp_force_break_line(state) {
  ...
  if (!match) {
    return Curry._1(state.pp_out_newline, void 0);
  }
  var match$1 = match[0];
  var width = match$1[1];
...
function clear_tag_stack(state) {
  return List.iter((function (param) {
                return pp_close_tag(state, void 0);
              }), state.pp_tag_stack);
}
...
function pp_print_newline(state, param) {
  ...
  return Curry._1(state.pp_out_flush, void 0);
}
...
function pp_print_list(_$staropt$star, pp_v, ppf, _param) {
  while(true) {
    ...
    var pp_sep = $staropt$star !== void 0 ? $staropt$star : pp_print_cut;
    if (!param) {
      return ;
    }
    var vs = param[1];
...
function output_formatting_lit(ppf, fmting_lit) {
  if (typeof fmting_lit === "number") {
    switch (fmting_lit) {
      case /* Close_box */0 :
          return pp_close_box(ppf, void 0);
      case /* Close_tag */1 :
          return pp_close_tag(ppf, void 0);
      case /* FFlush */2 :
          return pp_print_flush(ppf, void 0);
      case /* Force_newline */3 :
          return pp_force_newline(ppf, void 0);
      case /* Flush_newline */4 :
          return pp_print_newline(ppf, void 0);
      case /* Escaped_at */5 :
    ...
    case /* Acc_delay */6 :
        ...
        if (typeof p$7 !== "number" && !p$7.tag) {
          ...
          if (typeof match$6 !== "number" && match$6.tag === /* Magic_size */1) {
            ...
            return pp_print_as_size(ppf, match$6[1], Curry._1(acc[1], void 0));
          }
          
        }
        strput_acc(ppf, p$7);
        return pp_print_string(ppf, Curry._1(acc[1], void 0));
    case /* Acc_flush */7 :
        strput_acc(ppf, acc[0]);
        return pp_print_flush(ppf, void 0);
    case /* Acc_invalid_arg */8 :
...
function ksprintf(k, param) {
  ...
  return CamlinternalFormat.make_printf(k$1, void 0, /* End_of_acc */0, param[0]);
}
