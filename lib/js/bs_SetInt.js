  ...
  if (hl > (hr + 2 | 0)) {
    if (l) {
      ...
      if (height(ll) >= height(lr)) {
        ...
        throw new Error("File \"bs_SetInt.ml\", line 38, characters 21-27");
      }
    } else {
      throw new Error("File \"bs_SetInt.ml\", line 32, characters 17-23");
    }
  } else if (hr > (hl + 2 | 0)) {
    if (r) {
      var rr = r[2];
      ...
      if (height(rr) >= height(rl)) {
        ...
        throw new Error("File \"bs_SetInt.ml\", line 50, characters 21-27");
      }
    } else {
      throw new Error("File \"bs_SetInt.ml\", line 44, characters 17-23");
    }
  } else {
    return /* Node */[
            l,
...
function min_eltAssert(_param) {
  while(true) {
    ...
    if (param) {
      ...
      throw new Error("File \"bs_SetInt.ml\", line 100, characters 15-21");
    }
  };
}
...
function remove_min_elt(param) {
  if (param) {
    ...
    throw new Error("File \"bs_SetInt.ml\", line 118, characters 15-21");
  }
}
