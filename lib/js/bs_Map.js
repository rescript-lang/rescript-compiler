...
function split(map, x) {
  var dict = map.dict;
  var map$1 = map.data;
  var match = split0(map$1, x, dict[/* cmp */0]);
  var match$1 = match[0];
  return /* tuple */[
          /* tuple */[
            {
...
function every(m, f) {
  return Bs_internalAVLtree.every0(m.data, f);
}

function some(m, f) {
  return Bs_internalAVLtree.some0(m.data, f);
}
...
function get(map, x) {
  var X = map.dict;
  return Bs_internalAVLtree.findOpt0(map.data, x, X[/* cmp */0]);
}

function getNull(map, x) {
  var X = map.dict;
  return Bs_internalAVLtree.findNull0(map.data, x, X[/* cmp */0]);
}

function getWithDefault(map, x, def) {
  var X = map.dict;
  return Bs_internalAVLtree.findWithDefault0(map.data, x, def, X[/* cmp */0]);
}

function getExn(map, x) {
  var X = map.dict;
  return Bs_internalAVLtree.findExn0(map.data, x, X[/* cmp */0]);
}

function has(map, x) {
  var X = map.dict;
  return Bs_internalAVLtree.mem0(map.data, x, X[/* cmp */0]);
}

function checkInvariantInternal(m) {
  return Bs_internalAVLtree.checkInvariantInternal(m.data);
}
...
var has0 = Bs_internalAVLtree.mem0;

var cmp0 = Bs_internalAVLtree.cmp0;

var eq0 = Bs_internalAVLtree.eq0;

var forEach0 = Bs_internalAVLtree.iter0;

var reduce0 = Bs_internalAVLtree.fold0;

var every0 = Bs_internalAVLtree.every0;

var some0 = Bs_internalAVLtree.some0;

var filter0 = Bs_internalAVLtree.filterShared0;

var partition0 = Bs_internalAVLtree.partitionShared0;

var size0 = Bs_internalAVLtree.length0;

var toList0 = Bs_internalAVLtree.toList0;

var minimum0 = Bs_internalAVLtree.minKVOpt0;

var maximum0 = Bs_internalAVLtree.maxKVOpt0;

var get0 = Bs_internalAVLtree.findOpt0;

var getNull0 = Bs_internalAVLtree.findNull0;

var getWithDefault0 = Bs_internalAVLtree.findWithDefault0;

var getExn0 = Bs_internalAVLtree.findExn0;
