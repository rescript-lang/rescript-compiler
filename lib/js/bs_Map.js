...
function max_binding(map) {
  return max_binding0(map[/* data */1]);
}
...
function find(x, map) {
  var X = map[/* cmp */0];
  return find0(X[/* cmp */0], x, map[/* data */1]);
}
...
exports.min_binding0 = min_binding0;
exports.min_binding  = min_binding;
exports.max_binding0 = max_binding0;
