...
function for_all(f, map) {
  return for_all0(f, map[/* data */1]);
}
...
function bindings(map) {
  return bindings_aux(/* [] */0, map[/* data */1]);
}

function min_binding(map) {
  return min_binding0(map[/* data */1]);
}

function max_binding(map) {
  var _param = map[/* data */1];
  while(true) {
    var param = _param;
    if (param) {
      var r = param[3];
...
function compare(cmp, m1, m2) {
  ...
  var m1$1 = m1[/* data */1];
  var m2$1 = m2[/* data */1];
  var _e1 = cons_enum(m1$1, /* End */0);
  var _e2 = cons_enum(m2$1, /* End */0);
  while(true) {
    var e2 = _e2;
    var e1 = _e1;
    if (e1) {
