...
function init_mod(loc, shape) {
  ...
  var loop = function (shape, struct_, idx) {
    if (typeof shape === "number") {
      ...
      for(var i = 0 ,i_finish = len - 1 | 0; i <= i_finish; ++i){
        loop(Caml_io.caml_array_safe_get(comps, i), v, i);
      }
      return /* () */0;
    }
  };
  var res = /* array */[];
  loop(shape, res, 0);
  return Caml_io.caml_array_safe_get(res, 0);
}
...
function update_mod(shape, o, n) {
  var aux = function (shape, o, n, parent, i) {
    if (typeof shape === "number") {
      ...
      for(var i$1 = 0 ,i_finish = comps.length - 1 | 0; i$1 <= i_finish; ++i$1){
        aux(Caml_io.caml_array_safe_get(comps, i$1), o[i$1], n[i$1], o, i$1);
      }
      return /* () */0;
    }
  };
  if (typeof shape === "number") {
    ...
    for(var i = 0 ,i_finish = comps.length - 1 | 0; i <= i_finish; ++i){
      aux(Caml_io.caml_array_safe_get(comps, i), o[i], n[i], o, i);
    }
    return /* () */0;
  }
}
