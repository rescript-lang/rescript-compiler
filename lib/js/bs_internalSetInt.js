...
function add(x, t) {
  if (t !== null) {
    ...
    if (x === v) {
      ...
      return Bs_internalAVLset.bal(add(x, t.left), v, t.right);
    } else {
      return Bs_internalAVLset.bal(t.left, v, add(x, t.right));
    }
  } else {
    return {
            left: null,
