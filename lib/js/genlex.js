...
function make_lexer(keywords) {
    ...
    while(true) {
      ...
      if (match !== undefined) {
            ...
            if (switcher >= 58) {
              ...
              switch (switcher + 65 | 0) {
                ...
                case 34 : 
                    Stream.junk(strm__);
                    reset_buffer(/* () */0);
                    return Js_primitive.some(/* String */Block.__(4, [string(strm__)]));
                case 39 : 
                    Stream.junk(strm__);
                    var c$1;
                    try {
                    ...
                    if (match$1 !== undefined) {
                      if (match$1 !== 39) {
                        ...
                        Stream.junk(strm__);
                        return Js_primitive.some(/* Char */Block.__(5, [c$1]));
                      }
                    } else {
                      throw [
                            Stream.$$Error,
                ...
                case 40 : 
                    ...
                    if (match$2 !== undefined && match$2 === 42) {
                      ...
                      return Js_primitive.some(keyword_or_error(/* "(" */40));
                    }
                case 45 : 
                    Stream.junk(strm__);
                    var strm__$2 = strm__;
        ...
        switch (exit) {
          case 1 : 
              Stream.junk(strm__);
              return Js_primitive.some(keyword_or_error(c));
          case 2 : 
              Stream.junk(strm__);
              reset_buffer(/* () */0);
              store(c);
                  ...
                  if (c$3 >= 91) {
                    ...
                    if (switcher$2 > 27 || switcher$2 < 0) {
                      if (switcher$2 >= 97) {
                        ...
                        return Js_primitive.some(ident_or_keyword(get_string(/* () */0)));
                      }
  ...
  var number = function (strm__) {
    while(true) {
      ...
      if (match !== undefined) {
        ...
        if (c >= 58) {
          ...
          while(true) {
            ...
            if (exit$1 === 1) {
              return Js_primitive.some(/* Float */Block.__(3, [Caml_format.caml_float_of_string(get_string(/* () */0))]));
            }
      ...
      if (exit === 1) {
        return Js_primitive.some(/* Int */Block.__(2, [Caml_format.caml_int_of_string(get_string(/* () */0))]));
      }
