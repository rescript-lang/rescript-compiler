...
var buffer = [/* contents */initial_buffer];

var bufpos = [/* contents */0];

function reset_buffer(param) {
  buffer[/* contents */0] = initial_buffer;
  bufpos[/* contents */0] = 0;
  return /* () */0;
}

function store(c) {
  if (bufpos[/* contents */0] >= buffer[/* contents */0].length) {
    var newbuffer = Caml_bytes.caml_create_bytes((bufpos[/* contents */0] << 1));
    Bytes.blit(buffer[/* contents */0], 0, newbuffer, 0, bufpos[/* contents */0]);
    buffer[/* contents */0] = newbuffer;
  }
  buffer[/* contents */0][bufpos[/* contents */0]] = c;
  bufpos[/* contents */0] = bufpos[/* contents */0] + 1 | 0;
  return /* () */0;
}

function get_string(param) {
  var s = Bytes.sub_string(buffer[/* contents */0], 0, bufpos[/* contents */0]);
  buffer[/* contents */0] = initial_buffer;
  return s;
}
