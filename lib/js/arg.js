  ...
  while(current$1[0] < l) {
    ...
    if (s.length >= 1 && Caml_string.get(s, 0) === /* "-" */45) {
      ...
      try {
        ...
        var exn$3 = Js_exn.internalToOCamlException(exn$2);
        if (exn$3[0] === Bad) {
          stop(/* Message */Block.__(3, [exn$3[1]]));
        } else if (exn$3[0] === Stop) {
          stop(exn$3[1]);
        } else {
          throw exn$3;
        }
      ...
      try {
        ...
        var exn$5 = Js_exn.internalToOCamlException(exn$4);
        if (exn$5[0] === Bad) {
          stop(/* Message */Block.__(3, [exn$5[1]]));
        } else {
          throw exn$5;
        }
      }
