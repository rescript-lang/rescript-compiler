...
function parse_argv_dynamic($staropt$star, argv, speclist, anonfun, errmsg) {
  ...
  var stop = function (error) {
    var progname = initpos < l ? Caml_io.caml_array_safe_get(argv, initpos) : "(?)";
    switch (error.tag | 0) {
      case 0 : 
          var s = error[0];
          switch (s) {
  ...
  while(current$1[0] < l) {
    var s = Caml_io.caml_array_safe_get(argv, current$1[0]);
          ...
          switch (param.tag | 0) {
            ...
            case 1 : 
                if ((current$1[0] + 1 | 0) < l) {
                  var arg = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  try {
            ...
            case 4 : 
                if ((current$1[0] + 1 | 0) < l) {
                  Curry._1(param[0], Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0));
                  return current$1[0] = current$1[0] + 1 | 0;
                }
                else {
                  throw [
            ...
            case 5 : 
                if ((current$1[0] + 1 | 0) < l) {
                  param[0][0] = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  return current$1[0] = current$1[0] + 1 | 0;
                }
                else {
                  throw [
            ...
            case 6 : 
                if ((current$1[0] + 1 | 0) < l) {
                  var arg$1 = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  try {
            ...
            case 7 : 
                if ((current$1[0] + 1 | 0) < l) {
                  var arg$2 = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  try {
            ...
            case 8 : 
                if ((current$1[0] + 1 | 0) < l) {
                  var arg$3 = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  try {
            ...
            case 9 : 
                if ((current$1[0] + 1 | 0) < l) {
                  var arg$4 = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  try {
            ...
            case 11 : 
                if ((current$1[0] + 1 | 0) < l) {
                  var symb = param[0];
                  var arg$5 = Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0);
                  if (List.mem(arg$5, symb)) {
                    Curry._1(param[1], Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0));
                    return current$1[0] = current$1[0] + 1 | 0;
                  }
                  else {
                    throw [
            ...
            case 12 : 
                ...
                while(current$1[0] < (l - 1 | 0)) {
                  Curry._1(f, Caml_io.caml_array_safe_get(argv, current$1[0] + 1 | 0));
                  current$1[0] = current$1[0] + 1 | 0;
                };
                return /* () */0;
