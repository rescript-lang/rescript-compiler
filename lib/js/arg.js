        ...
        return function treat_action(param) {
          switch (param.tag | 0) {
            ...
            case /* Clear */3 :
                ...
                return ;
            case /* String */4 :
                var arg$1 = get_arg(void 0);
                Curry._1(param[0], arg$1);
                return consume_arg(void 0);
            case /* Set_string */5 :
                param[0].contents = get_arg(void 0);
                return consume_arg(void 0);
            case /* Int */6 :
                var arg$2 = get_arg(void 0);
...
function parse_argv_dynamic(currentOpt, argv, speclist, anonfun, errmsg) {
  var current$1 = currentOpt !== void 0 ? currentOpt : current;
...
function parse(l, f, msg) {
  try {
    return parse_argv(void 0, Sys.argv, l, f, msg);
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn[0] === Bad) {
...
function parse_dynamic(l, f, msg) {
  try {
    return parse_argv_dynamic(void 0, Sys.argv, l, f, msg);
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn[0] === Bad) {
...
function align(limitOpt, speclist) {
  var limit = limitOpt !== void 0 ? limitOpt : Pervasives.max_int;
