...
function parse_and_expand_argv_dynamic_aux(allow_expand, current, argv, speclist, anonfun, errmsg) {
  ...
  var convert_error = function (error) {
    ...
    if (Caml_obj.caml_equal(error, /* Unknown */Block.__(0, ["-help"])) || Caml_obj.caml_equal(error, /* Unknown */Block.__(0, ["--help"]))) {
      return {
              ExceptionID: Help.ExceptionID,
              _1: $$Buffer.contents(b),
              Debug: Help.Debug
            };
    } else {
      return {
              ExceptionID: Bad.ExceptionID,
              _1: $$Buffer.contents(b),
              Debug: Bad.Debug
            };
    }
  ...
  while(current.contents < argv.contents.length) {
    try {
      ...
      if (m.ExceptionID === Bad.ExceptionID) {
        throw convert_error(/* Message */Block.__(3, [m._1]));
      }
      if (m.ExceptionID === Stop.ExceptionID) {
...
function parse(l, f, msg) {
  try {
    ...
    if (msg$1.ExceptionID === Bad.ExceptionID) {
    ...
    if (msg$1.ExceptionID === Help.ExceptionID) {
