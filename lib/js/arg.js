...
function max_arg_len(cur, param) {
  var kwd = param[0];
  if (param[1].tag === 11) {
    return Caml_obj.caml_int_max(cur, kwd.length);
  } else {
    return Caml_obj.caml_int_max(cur, kwd.length + second_word(param[2]) | 0);
  }
}
...
function align($staropt$star, speclist) {
  ...
  return List.map((function (param) {
                ...
                if (ksd[2] === "") {
                  ...
                  var n = Caml_obj.caml_int_max(0, len$2 - cutcol | 0) + 3 | 0;
