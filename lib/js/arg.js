...
function parse_argv_dynamic($staropt$star, argv, speclist, anonfun, errmsg) {
  ...
  var l = argv.length;
  var b = $$Buffer.create(200);
  var initpos = current$1.contents;
  ...
  Pervasives.incr(current$1);
  while(current$1.contents < l) {
    var s = Caml_array.caml_array_get(argv, current$1.contents);
    if (s.length >= 1 && Caml_string.get(s, 0) === /* "-" */45) {
      var action;
      try {
        action = assoc3(s, speclist.contents);
      }
      catch (exn){
        if (exn === Caml_builtin_exceptions.not_found) {
      ...
      try {
        ...
        return function treat_action(param) {
          switch (param.tag | 0) {
            ...
            case /* Bool */1 :
                if ((current$1.contents + 1 | 0) < l) {
                  var arg = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  try {
                  ...
                  return Pervasives.incr(current$1);
                } else {
                  throw [
                        Stop,
            ...
            case /* String */4 :
                if ((current$1.contents + 1 | 0) < l) {
                  Curry._1(param[0], Caml_array.caml_array_get(argv, current$1.contents + 1 | 0));
                  return Pervasives.incr(current$1);
                } else {
                  throw [
                        Stop,
            ...
            case /* Set_string */5 :
                if ((current$1.contents + 1 | 0) < l) {
                  param[0].contents = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  return Pervasives.incr(current$1);
                } else {
                  throw [
                        Stop,
            ...
            case /* Int */6 :
                if ((current$1.contents + 1 | 0) < l) {
                  var arg$1 = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  try {
            ...
            case /* Set_int */7 :
                if ((current$1.contents + 1 | 0) < l) {
                  var arg$2 = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  try {
                    param[0].contents = Caml_format.caml_int_of_string(arg$2);
                  }
                  catch (raw_exn$2){
            ...
            case /* Float */8 :
                if ((current$1.contents + 1 | 0) < l) {
                  var arg$3 = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  try {
            ...
            case /* Set_float */9 :
                if ((current$1.contents + 1 | 0) < l) {
                  var arg$4 = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  try {
                    param[0].contents = Caml_format.caml_float_of_string(arg$4);
                  }
                  catch (raw_exn$4){
            ...
            case /* Symbol */11 :
                var symb = param[0];
                if ((current$1.contents + 1 | 0) < l) {
                  var arg$5 = Caml_array.caml_array_get(argv, current$1.contents + 1 | 0);
                  if (List.mem(arg$5, symb)) {
                    Curry._1(param[1], Caml_array.caml_array_get(argv, current$1.contents + 1 | 0));
                    return Pervasives.incr(current$1);
                  } else {
                    throw [
                          Stop,
            ...
            case /* Rest */12 :
                var f = param[0];
                while(current$1.contents < (l - 1 | 0)) {
                  Curry._1(f, Caml_array.caml_array_get(argv, current$1.contents + 1 | 0));
                  Pervasives.incr(current$1);
                };
                return /* () */0;
