...
function parse_and_expand_argv_dynamic_aux(allow_expand, current, argv, speclist, anonfun, errmsg) {
  var initpos = current[/* contents */0];
  var convert_error = function (error) {
    var b = $$Buffer.create(200);
    var progname = initpos < argv[/* contents */0].length ? Caml_array.caml_array_get(argv[/* contents */0], initpos) : "(?)";
    switch (error.tag | 0) {
      case /* Unknown */0 :
          var s = error[0];
          switch (s) {
    ...
    usage_b(b, speclist[/* contents */0], errmsg);
  ...
  current[/* contents */0] = current[/* contents */0] + 1 | 0;
  while(current[/* contents */0] < argv[/* contents */0].length) {
    try {
      var s = Caml_array.caml_array_get(argv[/* contents */0], current[/* contents */0]);
      if (s.length >= 1 && Caml_string.get(s, 0) === /* "-" */45) {
        var match;
        try {
          match = /* tuple */[
            assoc3(s, speclist[/* contents */0]),
            undefined
          ];
        }
        catch (exn){
          if (exn === Caml_builtin_exceptions.not_found) {
            try {
              var match$1 = split(s);
              match = /* tuple */[
                assoc3(match$1[0], speclist[/* contents */0]),
                match$1[1]
              ];
            }
            catch (exn$1){
        ...
        return function get_arg(param) {
          if (follow !== undefined) {
            return follow;
          } else if ((current[/* contents */0] + 1 | 0) < argv[/* contents */0].length) {
            return Caml_array.caml_array_get(argv[/* contents */0], current[/* contents */0] + 1 | 0);
          } else {
            throw [
                  Stop,
        ...
        return function treat_action(param) {
          switch (param.tag | 0) {
            ...
            case /* Set */2 :
                no_arg(/* () */0);
                param[0][/* contents */0] = true;
                return /* () */0;
            case /* Clear */3 :
                no_arg(/* () */0);
                param[0][/* contents */0] = false;
                return /* () */0;
            case /* String */4 :
                var arg$1 = get_arg(/* () */0);
            ...
            case /* Rest */12 :
                var f = param[0];
                while(current[/* contents */0] < (argv[/* contents */0].length - 1 | 0)) {
                  Curry._1(f, Caml_array.caml_array_get(argv[/* contents */0], current[/* contents */0] + 1 | 0));
                  consume_arg(/* () */0);
                };
                return /* () */0;
            case /* Expand */13 :
                ...
                consume_arg(/* () */0);
                var before = $$Array.sub(argv[/* contents */0], 0, current[/* contents */0] + 1 | 0);
                var after = $$Array.sub(argv[/* contents */0], current[/* contents */0] + 1 | 0, (argv[/* contents */0].length - current[/* contents */0] | 0) - 1 | 0);
                argv[/* contents */0] = Caml_array.caml_array_concat(/* :: */[
                      before,
                      /* :: */[
                        newarg,
                        /* :: */[
...
function parse_argv_dynamic($staropt$star, argv, speclist, anonfun, errmsg) {
  ...
  return parse_and_expand_argv_dynamic_aux(false, current$1, [/* contents */argv], speclist, anonfun, errmsg);
}

function parse_argv($staropt$star, argv, speclist, anonfun, errmsg) {
  var current$1 = $staropt$star !== undefined ? $staropt$star : current;
  return parse_argv_dynamic(current$1, argv, [/* contents */speclist], anonfun, errmsg);
}
...
function parse_expand(l, f, msg) {
  try {
    var argv = [/* contents */Sys.argv];
    var spec = [/* contents */l];
    var current$1 = [/* contents */current[/* contents */0]];
...
function replace_leading_tab(s) {
  var seen = [/* contents */false];
  return $$String.map((function (c) {
                if (c !== 9 || seen[/* contents */0]) {
                  return c;
                } else {
                  seen[/* contents */0] = true;
                  return /* " " */32;
                }
              }), s);
}
...
function read_aux(trim, sep, file) {
  ...
  return $$Array.of_list(List.rev(words[/* contents */0]));
}
