  ...
  if (typeof prec === "number") {
    if (prec !== 0) {
      ...
      if (typeof match$1 === "number") {
        throw Type_mismatch;
      } else if (match$1.tag === /* NotFound */2) {
    ...
    switch (fmt.tag | 0) {
      ...
      case /* String */2 :
          ...
          if (typeof match$3 === "number") {
            throw Type_mismatch;
          } else if (match$3.tag === /* NotFound */1) {
      ...
      case /* Caml_string */3 :
          ...
          if (typeof match$6 === "number") {
            throw Type_mismatch;
          } else if (match$6.tag === /* NotFound */1) {
      ...
      case /* Int */4 :
          ...
          if (typeof match$9 === "number") {
            throw Type_mismatch;
          } else if (match$9.tag === /* NotFound */2) {
      ...
      case /* Int32 */5 :
          ...
          if (typeof match$12 === "number") {
            throw Type_mismatch;
          } else if (match$12.tag === /* NotFound */3) {
      ...
      case /* Nativeint */6 :
          ...
          if (typeof match$15 === "number") {
            throw Type_mismatch;
          } else if (match$15.tag === /* NotFound */4) {
      ...
      case /* Int64 */7 :
          ...
          if (typeof match$18 === "number") {
            throw Type_mismatch;
          } else if (match$18.tag === /* NotFound */5) {
      ...
      case /* Float */8 :
          ...
          if (typeof match$21 === "number") {
            throw Type_mismatch;
          } else if (match$21.tag === /* NotFound */6) {
          ...
          if (typeof ign === "number") {
            if (ign === /* Ignored_reader */3) {
              if (typeof fmtty$1 === "number") {
                throw Type_mismatch;
              } else if (fmtty$1.tag === /* NotFound */14) {
...
function fmt_ebb_of_string(legacy_behavior, str) {
  ...
  var parse_after_padding = function (pct_ind, str_ind, end_ind, minus, plus, sharp, space, ign, pad) {
    ...
    if (symb !== 46) {
      ...
      if (exit === /* NotFound */2 && legacy_behavior$1) {
