...
function type_format_gen(fmt, fmtty) {
  ...
  switch (fmt.tag | 0) {
    ...
    case /* Nativeint */6 :
        ...
        if (match$15.tag === /* Nativeint_ty */4) {
    ...
    case /* Formatting_gen */18 :
        ...
        if (formatting_gen.tag) {
          ...
          var match$35 = type_format_gen(match$34[0], fmtty);
        ...
        var match$38 = type_format_gen(match$37[0], fmtty);
    ...
    case /* Ignored_param */23 :
        ...
        if (typeof ign === "number") {
          ...
          if (fmtty.tag === /* Ignored_reader_ty */14) {
            var match$43 = type_format_gen(fmt$1, fmtty[0]);
            return /* Fmt_fmtty_EBB */[
          ...
          switch (ign.tag | 0) {
            ...
            case /* Ignored_format_subst */9 :
                var match$44 = type_ignored_format_substitution(ign[1], fmt$1, fmtty);
...
function make_printf(_k, o, _acc, _fmt) {
  while(true) {
    ...
    switch (fmt.tag | 0) {
      ...
      case /* Custom */24 :
          return make_custom(k, o, acc, fmt[2], fmt[0], Curry._1(fmt[1], void 0));
...
function strput_acc(b, _acc) {
  while(true) {
    ...
    switch (acc.tag | 0) {
      ...
      case /* Acc_delay */6 :
          strput_acc(b, acc[0]);
          return $$Buffer.add_string(b, Curry._1(acc[1], void 0));
      case /* Acc_flush */7 :
          _acc = acc[0];
          continue ;
      case /* Acc_invalid_arg */8 :
...
function failwith_message(param) {
  ...
  return make_printf(k, void 0, /* End_of_acc */0, param[0]);
}
...
function fmt_ebb_of_string(legacy_behavior, str) {
  var legacy_behavior$1 = legacy_behavior !== void 0 ? legacy_behavior : true;
        ...
        switch (c - 32 | 0) {
          ...
          case 27 :
              ...
              try {
                ...
                if (exit === 1) {
                  var match$9 = parse_integer(str_ind_1, end_ind);
                  var width = match$9[1];
                  var str_ind_3 = parse_spaces(match$9[0], end_ind);
                  ...
                  if (switcher > 12 || switcher < 0) {
                    ...
                    var match$11 = parse_integer(str_ind_3, end_ind);
                    var str_ind_5 = parse_spaces(match$11[0], end_ind);
              ...
              var match$12 = parse_literal(next_ind, next_ind, end_ind);
              return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                          match$7[1],
                          match$12[0]
                        ])];
          case 28 :
              ...
              try {
                ...
                if (exit$1 === 1) {
                  var match$15 = parse_integer(str_ind_1$1, end_ind);
                  var str_ind_3$1 = parse_spaces(match$15[0], end_ind);
              ...
              if (match$13 !== void 0) {
                ...
                var match$17 = parse_literal(next_ind$1, next_ind$1, end_ind);
                return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                            match$16[1],
                            match$17[0]
                          ])];
              }
              var match$18 = parse_literal(str_ind$2, str_ind$2, end_ind);
              return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
    ...
    switch (exit$2) {
      case 7 :
          ...
          if (ign_used.contents = true, ign) {
            ...
            var match$19 = make_padprec_fmt_ebb(get_int_pad(void 0), (prec_used.contents = true, prec), fmt_rest$9);
    ...
    switch (exit$1) {
      case 2 :
          ...
          if (ign_used.contents = true, ign) {
            ...
            var ignored_001$1 = get_prec_opt(void 0);
      ...
      case 6 :
          if (symb >= 108) {
              ...
              switch (symb - 108 | 0) {
                case 0 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      var match$27 = make_padprec_fmt_ebb(get_int_pad(void 0), (prec_used.contents = true, prec), fmt_rest$13);
                ...
                case 2 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      var match$29 = make_padprec_fmt_ebb(get_int_pad(void 0), (prec_used.contents = true, prec), fmt_rest$14);
            ...
            if (ign_used.contents = true, ign) {
              ...
              var match$31 = make_padprec_fmt_ebb(get_int_pad(void 0), (prec_used.contents = true, prec), fmt_rest$15);
...
function format_of_string_fmtty(str, fmtty) {
  var match = fmt_ebb_of_string(void 0, str);
  try {
    return /* Format */[
