...
function type_padding(pad, fmtty) {
  ...
  if (typeof fmtty === "number") {
    throw {
          ExceptionID: Type_mismatch.ExceptionID,
          Debug: Type_mismatch.Debug
        };
  }
...
function type_ignored_format_substitution(sub_fmtty, fmt, fmtty) {
  ...
  switch (sub_fmtty.tag | 0) {
    case /* Char_ty */0 :
        if (typeof fmtty !== "number" && !fmtty.tag) {
        ...
        break;
    case /* String_ty */1 :
        if (typeof fmtty !== "number" && fmtty.tag === /* String_ty */1) {
        ...
        break;
    case /* Int_ty */2 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Int_ty */2) {
        ...
        break;
    case /* Int32_ty */3 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Int32_ty */3) {
        ...
        break;
    case /* Nativeint_ty */4 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Nativeint_ty */4) {
        ...
        break;
    case /* Int64_ty */5 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Int64_ty */5) {
        ...
        break;
    case /* Float_ty */6 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Float_ty */6) {
        ...
        break;
    case /* Bool_ty */7 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Bool_ty */7) {
        ...
        break;
    case /* Format_arg_ty */8 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Format_arg_ty */8) {
        ...
        break;
    case /* Format_subst_ty */9 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Format_subst_ty */9) {
        ...
        break;
    case /* Alpha_ty */10 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Alpha_ty */10) {
        ...
        break;
    case /* Theta_ty */11 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Theta_ty */11) {
    ...
    case /* Any_ty */12 :
        break;
    case /* Reader_ty */13 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Reader_ty */13) {
        ...
        break;
    case /* Ignored_reader_ty */14 :
        if (typeof fmtty !== "number" && fmtty.tag === /* Ignored_reader_ty */14) {
        ...
        switch (c - 32 | 0) {
          ...
          case 27 :
              ...
              try {
                ...
                var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
                if (exn.ExceptionID === /* Not_found */-6 || exn.ExceptionID === /* Failure */-2) {
                  match = /* tuple */[
                    str_ind$1,
                    /* Break */Block.__(0, [
                        "@;",
          ...
          case 28 :
              ...
              try {
                ...
                if (exn$1.ExceptionID === /* Not_found */-6 || exn$1.ExceptionID === /* Failure */-2) {
                  match$5 = undefined;
                } else {
                  throw exn$1;
                }
...
function format_of_string_fmtty(str, fmtty) {
  ...
  try {
    ...
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn.ExceptionID === Type_mismatch.ExceptionID) {
      return Curry._2(failwith_message(/* Format */[
                      /* String_literal */Block.__(11, [
