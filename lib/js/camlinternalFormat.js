...
function fmt_ebb_of_string(legacy_behavior, str) {
  ...
  var parse_after_at = function (str_ind, end_ind) {
    ...
    if (c >= 65) {
        ...
        switch (c - 32 | 0) {
          ...
          case 28 :
              ...
              if (match$13 !== undefined) {
                var next_ind$1 = match$13[0];
                var match$16 = parse_literal(next_ind$1, next_ind$1, end_ind);
                return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                            match$13[1],
                            match$16[0]
                          ])];
              }
              var match$17 = parse_literal(str_ind$2, str_ind$2, end_ind);
              return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
          ...
          case 31 :
              ...
              var match$18 = parse_literal(beg_ind$6, beg_ind$6, end_ind);
              return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                          /* FFlush */2,
                          match$18[0]
                        ])];
          case 32 :
              ...
              var match$19 = parse_literal(beg_ind$7, beg_ind$7, end_ind);
              return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                          /* Escaped_at */5,
                          match$19[0]
                        ])];
      ...
      var match$20 = parse_literal(beg_ind$8, beg_ind$8, end_ind);
      return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                  /* Force_newline */3,
                  match$20[0]
                ])];
    ...
    var match$21 = parse_literal(beg_ind$9, beg_ind$9, end_ind);
    return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
    ...
    switch (exit$2) {
      case 7 :
          ...
          if (ign_used.contents = true, ign) {
            ...
            var match$19 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used.contents = true, prec), fmt_rest$9);
      ...
      case 6 :
          if (symb >= 108) {
              ...
              switch (symb - 108 | 0) {
                case 0 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      var match$27 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used.contents = true, prec), fmt_rest$13);
                ...
                case 2 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      var match$29 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used.contents = true, prec), fmt_rest$14);
            ...
            if (ign_used.contents = true, ign) {
              ...
              var match$31 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used.contents = true, prec), fmt_rest$15);
