          ...
          switch (c - 32 | 0) {
            ...
            case 27 : 
                ...
                try {
                  ...
                  var match$7 = Caml_string.get(str, str_ind_1);
                  var exit$2 = 0;
                  if (match$7 >= 48) {
                    if (match$7 >= 58) {
                      throw Caml_builtin_exceptions.not_found;
                  ...
                  if (exit$2 === 2) {
                    var match$8 = parse_integer(str_ind_1, end_ind$1);
                    var width = match$8[1];
                    var str_ind_3 = parse_spaces(match$8[0], end_ind$1);
                    var match$9 = Caml_string.get(str, str_ind_3);
                    var switcher = match$9 - 45 | 0;
                    if (switcher > 12 || switcher < 0) {
                      if (switcher !== 17) {
                        throw Caml_builtin_exceptions.not_found;
                      } else {
                        var s = $$String.sub(str, str_ind$1 - 2 | 0, (str_ind_3 - str_ind$1 | 0) + 3 | 0);
                        var formatting_lit$1 = /* Break */Block.__(0, [
                            s,
                            width,
                            0
                          ]);
                        var next_ind$1 = str_ind_3 + 1 | 0;
                        formatting_lit = formatting_lit$1;
                        next_ind = next_ind$1;
                        exit$1 = 1;
                      }
                      ...
                      var match$10 = parse_integer(str_ind_3, end_ind$1);
                      var str_ind_5 = parse_spaces(match$10[0], end_ind$1);
                      if (Caml_string.get(str, str_ind_5) !== /* ">" */62) {
                        throw Caml_builtin_exceptions.not_found;
                      }
                      var s$1 = $$String.sub(str, str_ind$1 - 2 | 0, (str_ind_5 - str_ind$1 | 0) + 3 | 0);
                      var formatting_lit_002 = match$10[1];
                      var formatting_lit$2 = /* Break */Block.__(0, [
                          s$1,
                          width,
                          formatting_lit_002
                        ]);
                      var next_ind$2 = str_ind_5 + 1 | 0;
                      formatting_lit = formatting_lit$2;
                      next_ind = next_ind$2;
                      exit$1 = 1;
                    }
                  }
                  ...
                  if (exn === Caml_builtin_exceptions.not_found || exn[0] === Caml_builtin_exceptions.failure) {
                    formatting_lit = /* Break */Block.__(0, [
                        "@;",
                        1,
                        0
                      ]);
                ...
                if (exit$1 === 1) {
                  var match$11 = parse_literal(next_ind, next_ind, end_ind$1);
                  return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                              formatting_lit,
                              match$11[0]
                            ])];
                ...
                try {
                  ...
                  var match$13 = Caml_string.get(str, str_ind_1$1);
                  var exit$3 = 0;
                  if (match$13 >= 48) {
                    if (match$13 >= 58) {
                      match$12 = undefined;
                  ...
                  if (exit$3 === 1) {
                    var match$14 = parse_integer(str_ind_1$1, end_ind$2);
                    var str_ind_3$1 = parse_spaces(match$14[0], end_ind$2);
                ...
                if (match$12 !== undefined) {
                  var match$15 = match$12;
                  var next_ind$3 = match$15[0];
                  var match$16 = parse_literal(next_ind$3, next_ind$3, end_ind$2);
                  return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
                              match$15[1],
                              match$16[0]
                            ])];
                } else {
                  var match$17 = parse_literal(str_ind$2, str_ind$2, end_ind$2);
                  return /* Fmt_EBB */[/* Formatting_lit */Block.__(17, [
