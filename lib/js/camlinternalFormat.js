...
function string_to_caml_string(str) {
  ...
  Caml_string.caml_blit_string(str$1, 0, res, 1, l);
  return Caml_string.bytes_to_string(res);
}
...
function convert_float(fconv, prec, x) {
  if (fconv >= 16) {
    ...
    var str = Caml_missing_polyfill.not_implemented("caml_hexstring_of_float");
    if (fconv >= 19) {
      return Caml_string.bytes_to_string(Bytes.uppercase_ascii(Caml_string.bytes_of_string(str)));
    } else {
      return str;
    }
  } else {
...
function format_caml_char(c) {
  ...
  Caml_string.caml_blit_string(str, 0, res, 1, l);
  return Caml_string.bytes_to_string(res);
}
