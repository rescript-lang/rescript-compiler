        ...
        switch (c - 32 | 0) {
          ...
          case 27 :
              ...
              try {
                ...
                var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
                if (exn.ExceptionID === "Not_found" || exn.ExceptionID === "Failure") {
                  match = /* tuple */[
                    str_ind$1,
                    /* Break */Block.__(0, [
                        "@;",
          ...
          case 28 :
              ...
              try {
                ...
                if (exn$1.ExceptionID === "Not_found" || exn$1.ExceptionID === "Failure") {
                  match$5 = undefined;
                } else {
                  throw exn$1;
                }
...
function format_of_string_fmtty(str, fmtty) {
  ...
  try {
    ...
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn.ExceptionID === Type_mismatch) {
      return Curry._2(failwith_message(/* Format */[
                      /* String_literal */Block.__(11, [
