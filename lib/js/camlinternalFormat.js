    ...
    switch (exit$2) {
      case 7 :
          ...
          if (ign_used.contents = true, ign) {
            ...
            var match$19 = make_padprec_fmt_ebb(pad$3, (prec_used.contents = true, prec), fmt_rest$9);
    ...
    switch (exit$1) {
      case 2 :
          ...
          if (ign_used.contents = true, ign) {
            ...
            pad_used = true;
            var match$22 = make_padprec_fmt_ebb(pad, (prec_used.contents = true, prec), fmt_rest$11);
      ...
      case 6 :
          if (symb >= 108) {
              ...
              switch (symb - 108 | 0) {
                case 0 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      pad_used = true;
                      var match$26 = make_padprec_fmt_ebb(pad, (prec_used.contents = true, prec), fmt_rest$13);
                ...
                case 2 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      pad_used = true;
                      var match$28 = make_padprec_fmt_ebb(pad, (prec_used.contents = true, prec), fmt_rest$14);
            ...
            if (ign_used.contents = true, ign) {
              ...
              pad_used = true;
              var match$30 = make_padprec_fmt_ebb(pad, (prec_used.contents = true, prec), fmt_rest$15);
