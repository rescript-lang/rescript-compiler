...
function prec_of_prec_opt(prec_opt) {
  if (prec_opt !== /* None */0) {
    return /* Lit_precision */[prec_opt[/* None */0]];
  } else {
...
function bprint_pad_opt(buf, pad_opt) {
  if (pad_opt !== /* None */0) {
    return buffer_add_string(buf, String(pad_opt[/* None */0]));
  } else {
    return /* () */0;
  }
}
...
function fmt_ebb_of_string(legacy_behavior, str) {
  var legacy_behavior$1 = legacy_behavior !== /* None */0 ? legacy_behavior[/* None */0] : true;
