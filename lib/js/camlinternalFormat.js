...
function fmt_ebb_of_string(legacy_behavior, str) {
  ...
  var parse_flags = function (pct_ind, str_ind, end_ind, ign) {
    ...
    var set_flag = function (str_ind, flag) {
      if (flag[/* contents */0] && !legacy_behavior$1) {
    ...
    while(true) {
      ...
      var end_ind$1 = end_ind;
      var zero$1 = zero[/* contents */0];
      var minus$1 = minus[/* contents */0];
      var plus$1 = plus[/* contents */0];
      var hash$1 = hash[/* contents */0];
      var space$1 = space[/* contents */0];
      var ign$1 = ign;
  ...
  var parse_conversion = function (pct_ind, str_ind, end_ind, plus, hash, space, ign, pad, prec, padprec, symb) {
    ...
    var get_int_pad = function (param) {
      pad_used[/* contents */0] = true;
      prec_used[/* contents */0] = true;
      if (typeof prec === "number" && prec === 0) {
        return pad;
      }
      if (typeof pad === "number") {
    ...
    if (symb >= 124) {
      ...
      switch (symb) {
        ...
        case 40 :
            ...
            if (ign_used[/* contents */0] = true, ign) {
              var ignored_000 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
              ...
              fmt_result = /* Fmt_EBB */[/* Format_subst */Block.__(14, [
                    opt_of_pad(/* "(" */40, (pad_used[/* contents */0] = true, pad)),
                    sub_fmtty,
                    fmt_rest
                  ])];
            }
        ...
        case 67 :
            ...
            fmt_result = (ign_used[/* contents */0] = true, ign) ? /* Fmt_EBB */[/* Ignored_param */Block.__(23, [
                    /* Ignored_caml_char */1,
                    fmt_rest$1
        ...
        case 78 :
            ...
            break;
        case 83 :
            var pad$1 = check_no_0(symb, (pad_used[/* contents */0] = true, padprec));
            var match$5 = parse_literal(str_ind, str_ind, end_ind);
            var fmt_rest$3 = match$5[0];
            if (ign_used[/* contents */0] = true, ign) {
              var ignored$2 = /* Ignored_caml_string */Block.__(1, [opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, padprec))]);
              fmt_result = /* Fmt_EBB */[/* Ignored_param */Block.__(23, [
                    ignored$2,
                    fmt_rest$3
                  ])];
        ...
        case 91 :
            ...
            if (ign_used[/* contents */0] = true, ign) {
              var ignored_000$1 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
              ...
              fmt_result = /* Fmt_EBB */[/* Scan_char_set */Block.__(20, [
                    opt_of_pad(/* "[" */91, (pad_used[/* contents */0] = true, pad)),
                    char_set,
                    fmt_rest$4
                  ])];
            }
        ...
        case 99 :
            ...
            var match$11 = opt_of_pad(/* "c" */99, (pad_used[/* contents */0] = true, pad));
        ...
        case 114 :
            ...
            break;
        case 115 :
            var pad$2 = check_no_0(symb, (pad_used[/* contents */0] = true, padprec));
            var match$13 = parse_literal(str_ind, str_ind, end_ind);
            var fmt_rest$7 = match$13[0];
            if (ign_used[/* contents */0] = true, ign) {
              var ignored$4 = /* Ignored_string */Block.__(0, [opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, padprec))]);
              fmt_result = /* Fmt_EBB */[/* Ignored_param */Block.__(23, [
                    ignored$4,
                    fmt_rest$7
                  ])];
        ...
        case 123 :
            ...
            if (ign_used[/* contents */0] = true, ign) {
              var ignored_000$2 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
              ...
              fmt_result = /* Fmt_EBB */[/* Format_arg */Block.__(13, [
                    opt_of_pad(/* "{" */123, (pad_used[/* contents */0] = true, pad)),
                    sub_fmtty$1,
                    fmt_rest$8
                  ])];
            }
    ...
    switch (exit$2) {
      case 7 :
          ...
          if (ign_used[/* contents */0] = true, ign) {
            var ignored_001 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
            ...
            var match$19 = make_padprec_fmt_ebb(get_int_pad(/* () */0), (prec_used[/* contents */0] = true, prec), fmt_rest$9);
    ...
    switch (exit$1) {
      case 2 :
          ...
          if (ign_used[/* contents */0] = true, ign) {
            var ignored_000$3 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
            ...
            var match$22 = make_padprec_fmt_ebb((pad_used[/* contents */0] = true, pad), (prec_used[/* contents */0] = true, prec), fmt_rest$11);
          ...
          break;
      case 3 :
          var pad$3 = check_no_0(symb, (pad_used[/* contents */0] = true, padprec));
          var match$23 = parse_literal(str_ind, str_ind, end_ind);
          var fmt_rest$12 = match$23[0];
          if (ign_used[/* contents */0] = true, ign) {
            var ignored$9 = /* Ignored_bool */Block.__(7, [opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, padprec))]);
            fmt_result = /* Fmt_EBB */[/* Ignored_param */Block.__(23, [
                  ignored$9,
                  fmt_rest$12
                ])];
      ...
      case 6 :
          if (symb >= 108) {
            if (symb >= 111) {
              ...
              switch (symb - 108 | 0) {
                case 0 :
                    ...
                    if (ign_used[/* contents */0] = true, ign) {
                      var ignored_001$2 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
                      ...
                      var match$27 = make_padprec_fmt_ebb(get_int_pad(/* () */0), (prec_used[/* contents */0] = true, prec), fmt_rest$13);
                ...
                case 2 :
                    ...
                    if (ign_used[/* contents */0] = true, ign) {
                      var ignored_001$3 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
                      ...
                      var match$29 = make_padprec_fmt_ebb(get_int_pad(/* () */0), (prec_used[/* contents */0] = true, prec), fmt_rest$14);
            ...
            if (ign_used[/* contents */0] = true, ign) {
              var ignored_001$4 = opt_of_pad(/* "_" */95, (pad_used[/* contents */0] = true, pad));
              ...
              var match$31 = make_padprec_fmt_ebb(get_int_pad(/* () */0), (prec_used[/* contents */0] = true, prec), fmt_rest$15);
    ...
    if (!legacy_behavior$1) {
      ...
      if (!pad_used[/* contents */0] && Caml_obj.caml_notequal(/* Padding_EBB */[pad], /* Padding_EBB */[/* No_padding */0])) {
        incompatible_flag(pct_ind, str_ind, symb, "`padding'");
      }
      if (!prec_used[/* contents */0] && Caml_obj.caml_notequal(/* Precision_EBB */[prec], /* Precision_EBB */[/* No_precision */0])) {
