...
function Make(H) {
    ...
    return $$Array.iteri(function (param, param$1) {
                ...
                while(true) {
                  ...
                  if (i >= (b.length - 1 | 0)) {
                    ...
                    if (match !== 0) {
                      Curry._3(f, b, Caml_io.caml_array_safe_get(t[/* hashes */1], j), i);
                      _i = i + 1 | 0;
                      continue ;
  ...
  var test_shrink_bucket = function (t) {
    var bucket = Caml_io.caml_array_safe_get(t[/* table */0], t[/* rover */4]);
    var hbucket = Caml_io.caml_array_safe_get(t[/* hashes */1], t[/* rover */4]);
        ...
        while(true) {
          ...
          if (j >= prev_len) {
            if (Caml_weak.caml_weak_check(bucket, i)) {
              ...
              hbucket[i] = Caml_io.caml_array_safe_get(hbucket, j);
              _j = j - 1 | 0;
              _i = i + 1 | 0;
              continue ;
  ...
  var add_aux = function (t, setter, d, h, index) {
    var bucket = Caml_io.caml_array_safe_get(t[/* table */0], index);
    var hashes = Caml_io.caml_array_safe_get(t[/* hashes */1], index);
        ...
        if (t[/* oversize */3] > (t[/* table */0].length >> 1)) {
          ...
          if (newlen > oldlen) {
            ...
            return function add_weak(ob, oh, oi) {
              ...
              var h = Caml_io.caml_array_safe_get(oh, oi);
  ...
  var find_or = function (t, d, ifnotfound) {
    ...
    while(true) {
      ...
      else if (h === Caml_io.caml_array_safe_get(hashes, i)) {
  ...
  var stats = function (t) {
    ...
    return /* tuple */[
            ...
            count(t),
            totlen,
            Caml_io.caml_array_safe_get(lens, 0),
            Caml_io.caml_array_safe_get(lens, len / 2 | 0),
            Caml_io.caml_array_safe_get(lens, len - 1 | 0)
          ];
  };
  return /* module */[
          /* create */create,
