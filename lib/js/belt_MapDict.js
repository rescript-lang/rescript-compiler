...
function updateU(t, newK, f, cmp) {
  ...
  if (match !== /* None */0) {
    ...
    if (match$4 !== /* None */0) {
      return Belt_internalAVLtree.singleton(newK, match$4[/* None */0]);
    } else {
      return t;
    }
  }
...
function splitAuxPivot(n, x, pres, cmp) {
  ...
  if (c === 0) {
    ...
    var match = l === null ? /* None */0 : [l];
    if (match !== /* None */0) {
      var match$1 = splitAuxPivot(l, x, pres, cmp);
      return /* tuple */[
              match$1[0],
              Belt_internalAVLtree.join(match$1[1], v, d, r)
            ];
    } else {
      return /* tuple */[
    ...
    if (match$2 !== /* None */0) {
      var match$3 = splitAuxPivot(r, x, pres, cmp);
      return /* tuple */[
  ...
  if (match !== /* None */0) {
    if (match$1 !== /* None */0) {
      if (s1.height >= s2.height) {
        ...
        var r1 = s1.right;
        var d2 = [/* None */0];
        var match$2 = splitAuxPivot(s2, v1, d2, cmp);
        var d2$1 = d2[0];
        var newLeft = mergeU(l1, match$2[0], f, cmp);
        var newD = f(v1, /* Some */[d1], d2$1);
        var newRight = mergeU(r1, match$2[1], f, cmp);
        ...
        var r2 = s2.right;
        var d1$1 = [/* None */0];
        var match$3 = splitAuxPivot(s1, v2, d1$1, cmp);
        var d1$2 = d1$1[0];
        var newLeft$1 = mergeU(match$3[0], l2, f, cmp);
        var newD$1 = f(v2, d1$2, /* Some */[d2$2]);
        var newRight$1 = mergeU(match$3[1], r2, f, cmp);
