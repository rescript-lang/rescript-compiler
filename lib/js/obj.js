...
function double_field(x, i) {
  return Caml_missing_polyfill.not_implemented("caml_floatarray_get");
}

function set_double_field(x, i, v) {
  return Caml_missing_polyfill.not_implemented("caml_floatarray_set");
}
...
function Ephemeron_000(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_create");
}

function Ephemeron_002(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_get_key");
}

function Ephemeron_003(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_get_key_copy");
}

function Ephemeron_004(prim, prim$1, prim$2) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_set_key");
}

function Ephemeron_005(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_unset_key");
}

function Ephemeron_006(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_check_key");
}

function Ephemeron_007(prim, prim$1, prim$2, prim$3, prim$4) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_blit_key");
}

function Ephemeron_008(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_get_data");
}

function Ephemeron_009(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_get_data_copy");
}

function Ephemeron_010(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_set_data");
}

function Ephemeron_011(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_unset_data");
}

function Ephemeron_012(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_check_data");
}

function Ephemeron_013(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_ephe_blit_data");
}
