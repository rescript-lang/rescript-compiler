...
function marshal(obj) {
  return Caml_external_polyfill.resolve("caml_output_value_to_string")(obj, "[]");
}
...
function extension_slot(x) {
  var slot = typeof x !== "number" && /* XXX */x.tag !== 248 && x.length >= 1 ? x[0] : x;
  var name;
  if (typeof slot !== "number" && /* XXX */slot.tag === 248) {
    name = slot[0];
  } else {
