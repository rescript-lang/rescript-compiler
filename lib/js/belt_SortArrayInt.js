  ...
  var loop = function (_i1, _s1, _i2, _s2, _d) {
    while(true) {
      ...
      if (s1 <= s2) {
        ...
        Belt_Array.blitUnsafe(src2, i2, dst, d + 1 | 0, src2r - i2 | 0);
        return ;
      }
      dst[d] = s2;
      var i2$1 = i2 + 1 | 0;
      ...
      Belt_Array.blitUnsafe(src, i1, dst, d + 1 | 0, src1r - i1 | 0);
      return ;
    };
  };
  loop(src1ofs, src[src1ofs], src2ofs, src2[src2ofs], dstofs);
}
