...
function tuple_3_to_value(k0, k1, k2) {
  return function (param) {
    return /* Tuple */Block.__(9, [/* array */[
                k0(param[0]),k1(param[1]),k2(param[2])
              ]]);
  };
}
...
function tuple_4_to_value(k0, k1, k2, k3) {
  return function (param) {
    return /* Tuple */Block.__(9, [/* array */[
                k0(param[0]),k1(param[1]),k2(param[2]),k3(param[3])
              ]]);
  };
}
...
function tuple_5_to_value(k0, k1, k2, k3, k4) {
  return function (param) {
    return /* Tuple */Block.__(9, [/* array */[
                k0(param[0]),k1(param[1]),k2(param[2]),k3(param[3]),k4(param[4])
              ]]);
  };
}
...
function tuple_6_to_value(k0, k1, k2, k3, k4, k5) {
  return function (param) {
    return /* Tuple */Block.__(9, [/* array */[
                k0(param[0]),k1(param[1]),k2(param[2]),k3(param[3]),k4(param[4]),k5(param[5])
              ]]);
  };
}
...
function shape_of_variant(constructors, arities) {
  return /* record */[
          /* constructors */constructors,/* arities */arities
        ];
}
