...
function concat(sep, l) {
  if (l) {
    ...
    var dst = Caml_string.caml_create_bytes(sum_lengths(0, seplen, l));
    var _pos = 0;
    var sep$1 = sep;
    var seplen$1 = seplen;
    var _param = l;
    while(true) {
      ...
      if (param) {
        ...
        var hd = param[0];
        if (tl) {
          Caml_string.caml_blit_bytes(hd, 0, dst, pos, hd.length);
          Caml_string.caml_blit_bytes(sep$1, 0, dst, pos + hd.length | 0, seplen$1);
          _param = tl;
