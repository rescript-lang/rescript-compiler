...
function reduceReverseU(l, accu, f) {
  if (l) {
    return f(l[0], reduceReverseU(l[1], accu, f));
  } else {
    return accu;
  }
}
...
function reduceReverse2U(l1, l2, accu, f) {
  if (l1 && l2) {
    return f(l1[0], l2[0], reduceReverse2U(l1[1], l2[1], accu, f));
  } else {
    return accu;
  }
}
...
function assoc(xs, x, eq) {
  return assocU(xs, x, Curry.__2(eq));
}
