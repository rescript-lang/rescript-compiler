...
function reverseAppend(_l1, _l2) {
  while(true) {
    var l2 = _l2;
    var l1 = _l1;
    if (l1) {
...
function reduceFromTail(l, accu, f) {
  if (l) {
    return f(l[0], reduceFromTail(l[1], accu, f));
  } else {
    return accu;
  }
}
...
function reduceFromTail2(l1, l2, accu, f) {
  if (l1 && l2) {
    return f(l1[0], l2[0], reduceFromTail2(l1[1], l2[1], accu, f));
  } else {
    return accu;
  }
}
...
exports.reduceFromTail2 = reduceFromTail2;
exports.every = every;
exports.some = some;
