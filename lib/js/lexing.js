...
let Caml_lexer = require("./caml_lexer.js");
...
function from_function(f) {
  return {
    refill_buff: (function (a) {
      let aux_buffer = Caml_bytes.create(512);
      let read = f(aux_buffer, aux_buffer.length);
      let n = read > 0 ? read : (a.lex_eof_reached = true, 0);
      if ((a.lex_buffer_len + n | 0) > a.lex_buffer.length) {
        if (((a.lex_buffer_len - a.lex_start_pos | 0) + n | 0) <= a.lex_buffer.length) {
          Bytes.blit(a.lex_buffer, a.lex_start_pos, a.lex_buffer, 0, a.lex_buffer_len - a.lex_start_pos | 0);
        } else {
          let newlen = (a.lex_buffer.length << 1);
          if (((a.lex_buffer_len - a.lex_start_pos | 0) + n | 0) > newlen) {
            throw {
              RE_EXN_ID: "Failure",
          ...
          Bytes.blit(a.lex_buffer, a.lex_start_pos, newbuf, 0, a.lex_buffer_len - a.lex_start_pos | 0);
          a.lex_buffer = newbuf;
        }
        let s = a.lex_start_pos;
        a.lex_abs_pos = a.lex_abs_pos + s | 0;
        a.lex_curr_pos = a.lex_curr_pos - s | 0;
        a.lex_start_pos = 0;
        a.lex_last_pos = a.lex_last_pos - s | 0;
        a.lex_buffer_len = a.lex_buffer_len - s | 0;
        let t = a.lex_mem;
      ...
      Bytes.blit(aux_buffer, 0, a.lex_buffer, a.lex_buffer_len, n);
      a.lex_buffer_len = a.lex_buffer_len + n | 0;
    }),
