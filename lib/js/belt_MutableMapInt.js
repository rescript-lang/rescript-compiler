...
function $dot$colon$lbrack$rbrack(t, x) {
  return Belt_internalMapInt.get(t.data, x);
}

var $dot$colon$lbrack$rbrack$less$neg = set;
...
exports.$dot$colon$lbrack$rbrack = $dot$colon$lbrack$rbrack;
exports.$dot$colon$lbrack$rbrack$less$neg = $dot$colon$lbrack$rbrack$less$neg;
/* No side effect */
