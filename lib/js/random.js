...
function make(seed) {
  var result = /* record */[
    /* st */Caml_array.caml_make_vect(55, 0),/* idx */0
  ];
...
function $$int(s, bound) {
  if (bound > 1073741823 || bound <= 0) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Random.int"
        ];
  }
  else {
    var s$1 = s;
...
function int32(s, bound) {
  if (bound <= 0) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"Random.int32"
        ];
  }
  else {
    var s$1 = s;
...
function int64(s, bound) {
  if (Caml_int64.le(bound, /* int64 */[
    ...
    throw [
          Caml_builtin_exceptions.invalid_argument,"Random.int64"
        ];
  }
  else {
    var s$1 = s;
...
var State = [
  make,make_self_init,copy,bits,$$int,int32,nativeint,int64,$$float,bool
];
