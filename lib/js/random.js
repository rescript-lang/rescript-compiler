...
function full_init(s, seed) {
  ...
  for(var i$1 = 0 ,i_finish = 54 + Pervasives.max(55, l) | 0; i$1 <= i_finish; ++i$1){
    var j = i$1 % 55;
    var k = i$1 % l;
    accu = combine(accu, Caml_io.caml_array_safe_get(seed$1, k));
    s[/* st */0][j] = (Caml_io.caml_array_safe_get(s[/* st */0], j) ^ extract(accu)) & 1073741823;
  }
  s[/* idx */1] = 0;
  return /* () */0;
}
...
function bits(s) {
  ...
  var curval = Caml_io.caml_array_safe_get(s[/* st */0], s[/* idx */1]);
  var newval = Caml_io.caml_array_safe_get(s[/* st */0], (s[/* idx */1] + 24 | 0) % 55) + (curval ^ (curval >>> 25) & 31) | 0;
