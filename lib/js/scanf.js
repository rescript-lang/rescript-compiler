...
function scanf_bad_input(ib, x) {
  var s;
  if (x.ExceptionID === Scan_failure || x.ExceptionID === "Failure") {
    s = x._1;
  } else {
    throw x;
  }
...
function kscanf(ib, ef, param) {
  ...
  var k = function (readers, f) {
    ...
    try {
      ...
      if (exc.ExceptionID === Scan_failure || exc.ExceptionID === "Failure" || exc.ExceptionID === "End_of_file") {
        args = /* Exc */Block.__(1, [exc]);
      } else {
        if (exc.ExceptionID === "Invalid_argument") {
