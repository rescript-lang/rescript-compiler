...
function create(iname, next) {
  return /* record */[
          /* eof : false */0,/* current_char : "\000" */0,/* current_char_is_valid : false */0,/* char_count */0,/* line_count */0,/* token_count */0,/* get_next_char */next,/* tokbuf */Buffer.create(1024),/* input_name */iname
        ];
}
...
function bad_input_escape(c) {
  var s = Curry._1(Printf.sprintf(/* Format */[
            /* String_literal */Block.__(11, [
                "illegal escape character ",/* Caml_char */Block.__(1, [/* End_of_format */0])
...
function bad_token_length(message) {
  var s = Curry._1(Printf.sprintf(/* Format */[
            /* String_literal */Block.__(11, [
                "scanning of ",/* String */Block.__(2, [
                    /* No_padding */0,/* String_literal */Block.__(11, [
                        " failed: the specified length was too short for token",/* End_of_format */0
                      ])
                  ])
...
function character_mismatch_err(c, ci) {
  return Curry._2(Printf.sprintf(/* Format */[
                  /* String_literal */Block.__(11, [
                      "looking for ",/* Caml_char */Block.__(1, [/* String_literal */Block.__(11, [
                              ", found ",/* Caml_char */Block.__(1, [/* End_of_format */0])
                            ])])
  ...
  switch (s) {
    ...
    default:
      var s$1 = Curry._1(Printf.sprintf(/* Format */[
                /* String_literal */Block.__(11, [
                    "invalid boolean ",/* Caml_string */Block.__(3, [
...
function scan_decimal_digits_plus(width, ib) {
  if (width) {
    ...
    if (c > 57 || c < 48) {
      var s = Curry._1(Printf.sprintf(/* Format */[
                /* String_literal */Block.__(11, [
                    "character ",/* Caml_char */Block.__(1, [/* String_literal */Block.__(11, [
                            " is not a decimal digit",/* End_of_format */0
                          ])])
  ...
  if (width) {
    ...
    if (Curry._1(digitp, c)) {
      ...
      var s = Curry._2(Printf.sprintf(/* Format */[
                /* String_literal */Block.__(11, [
                    "character ",/* Caml_char */Block.__(1, [/* String_literal */Block.__(11, [
                            " is not a valid ",/* String */Block.__(2, [
                                /* No_padding */0,/* String_literal */Block.__(11, [
                                    " digit",/* End_of_format */0
                                  ])
                              ])
                          ])])
...
function scan_float(width, precision, ib) {
  ...
  if (width$1) {
    ...
    if (ib[/* eof */0]) {
      ...
      return /* tuple */[
              scan_exp_part(width$1, ib),precision
            ];
    }
    else {
      ...
      return /* tuple */[
              scan_exp_part(width$3, ib),precision$1
            ];
    }
  }
  else {
...
function scan_caml_float(width, precision, ib) {
  ...
  if (width$1) {
    ...
    if (ib[/* eof */0]) {
      throw [
            Scan_failure,"no dot or exponent part found in float token"
          ];
    }
    else {
      var switcher = c - 69 | 0;
...
function char_for_decimal_code(c0, c1, c2) {
  ...
  if (c < 0 || c > 255) {
    var s = Curry._3(Printf.sprintf(/* Format */[
              /* String_literal */Block.__(11, [
                  "bad character decimal encoding \\",/* Char */Block.__(0, [/* Char */Block.__(0, [/* Char */Block.__(0, [/* End_of_format */0])])])
...
function char_for_hexadecimal_code(c1, c2) {
  ...
  if (c < 0 || c > 255) {
    var s = Curry._2(Printf.sprintf(/* Format */[
              /* String_literal */Block.__(11, [
                  "bad character hexadecimal encoding \\",/* Char */Block.__(0, [/* Char */Block.__(0, [/* End_of_format */0])])
    ...
    if (ib[/* eof */0]) {
      ...
      var s = Curry._1(Printf.sprintf(/* Format */[
                /* String_literal */Block.__(11, [
                    "scanning of ",/* String */Block.__(2, [
                        /* No_padding */0,/* String_literal */Block.__(11, [
                            " failed: premature end of file occurred before end of token",/* End_of_format */0
                          ])
                      ])
...
function scan_bool(ib) {
  ...
  if (c !== 102) {
    if (c !== 116) {
      var s = Curry._1(Printf.sprintf(/* Format */[
                /* String_literal */Block.__(11, [
                    "the character ",/* Caml_char */Block.__(1, [/* String_literal */Block.__(11, [
                            " cannot start a boolean",/* End_of_format */0
                          ])])
...
function scanf_bad_input(ib, x) {
  ...
  if (exit === 1) {
    ...
    var s$1 = Curry._2(Printf.sprintf(/* Format */[
              /* String_literal */Block.__(11, [
                  "scanf: bad input at char number ",/* Int */Block.__(4, [
    ...
    if (typeof fmt === "number") {
      ...
      switch (fmt.tag | 0) {
        case 0 : 
            ...
            var c = token_char(ib);
            return /* Cons */[
                    c,make_scanf(ib, fmt[0], readers)
                  ];
        case 1 : 
            scan_caml_char(0, ib);
            var c$1 = token_char(ib);
            return /* Cons */[
                    c$1,make_scanf(ib, fmt[0], readers)
                  ];
        case 2 : 
            var rest = fmt[1];
            var pad = fmt[0];
        ...
        case 10 : 
            if (end_of_input(ib)) {
              ...
              throw [
                    Scan_failure,"end of input not found"
                  ];
            }
            break;
        case 11 : 
            ...
            return /* Cons */[
                    fmt$1,make_scanf(ib, fmt[2], readers)
                  ];
        case 14 : 
            var fmtty = fmt[1];
            scan_caml_string(width_of_pad_opt(fmt[0]), ib);
            ...
            try {
              ...
              match$2 = /* tuple */[
                CamlinternalFormat.type_format(match$3[0], CamlinternalFormatBasics.erase_rel(fmtty)),CamlinternalFormat.type_format(match$4[0], CamlinternalFormatBasics.erase_rel(CamlinternalFormat.symm(fmtty)))
              ];
            }
            catch (exn$1){
              if (exn$1[0] === Caml_builtin_exceptions.failure) {
                throw [
                      Scan_failure,exn$1[1]
                    ];
              }
              else {
                throw exn$1;
        ...
        case 15 : 
            throw [
                  Caml_builtin_exceptions.invalid_argument,'scanf: bad conversion "%a"'
                ];
        case 16 : 
            throw [
                  Caml_builtin_exceptions.invalid_argument,'scanf: bad conversion "%t"'
                ];
        case 17 : 
        ...
        case 19 : 
            ...
            return /* Cons */[
                    x,make_scanf(ib, fmt[0], readers[1])
                  ];
        case 20 : 
            var rest$1 = fmt[2];
            var char_set = fmt[1];
            ...
            if (typeof rest$1 === "number") {
              ...
              var str_rest$1 = /* String_literal */Block.__(11, [
                  str_rest_000$1,str_rest_001$1
                ]);
              return /* Cons */[
                      s$3,make_scanf(ib, str_rest$1, readers)
                    ];
            }
            else {
              exit$1 = 1;
            ...
            if (exit$1 === 1) {
              ...
              var s$4 = token(ib);
              return /* Cons */[
                      s$4,make_scanf(ib, rest$1, readers)
                    ];
            }
            break;
        case 21 : 
            ...
            return /* Cons */[
                    count,make_scanf(ib, fmt[1], readers)
                  ];
        case 22 : 
            var c$6 = checked_peek_char(ib);
            return /* Cons */[
                    c$6,make_scanf(ib, fmt[0], readers)
                  ];
        case 23 : 
        ...
        case 24 : 
            throw [
                  Caml_builtin_exceptions.invalid_argument,'scanf: bad conversion "%?" (custom converter)'
                ];
...
function pad_prec_scanf(ib, fmt, readers, pad, prec, scan, token) {
  if (typeof pad === "number") {
    if (typeof prec === "number") {
      if (prec !== 0) {
        throw [
              Caml_builtin_exceptions.invalid_argument,'scanf: bad conversion "%*"'
            ];
      }
      else {
...
function unescaped(s) {
  return Curry._1(sscanf('"' + (s + '"'), /* Format */[
                  /* Caml_string */Block.__(3, [
                      /* No_padding */0,/* Flush */Block.__(10, [/* End_of_format */0])
                    ]),"%S%!"
                ]), function (x) {
              return x;
            });
...
var Scanning = [
  stdin,open_in,open_in_bin,close_in,open_in,open_in_bin,from_string,from_function,from_channel,end_of_input,beginning_of_input,name_of_input,stdin
];
