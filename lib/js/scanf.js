...
function bad_input(s) {
  throw {
        ExceptionID: Scan_failure.ExceptionID,
        _1: s,
        Debug: Scan_failure.Debug
      };
}

function bad_input_escape(c) {
  return bad_input(Curry._1(Printf.sprintf(/* Format */[
...
function bad_hex_float(param) {
  return bad_input("not a valid float in hexadecimal notation");
}
...
function check_char(ib, c) {
  if (c !== 10) {
    ...
    if (ci !== 10) {
      if (ci !== 13) {
        return bad_input(character_mismatch_err(/* "\n" */10, ci));
      } else {
        ib.ic_current_char_is_valid = false;
...
function scan_digit_plus(basis, digitp, width, ib) {
  ...
  if (!Curry._1(digitp, c)) {
    return bad_input(Curry._2(Printf.sprintf(/* Format */[
                        /* String_literal */Block.__(11, [
                            "character ",
                            /* Caml_char */Block.__(1, [/* String_literal */Block.__(11, [
                                    " is not a valid ",
...
function scan_caml_float(width, precision, ib) {
  ...
  if (exit === 1) {
    ...
    if (switcher > 32 || switcher < 0) {
      if (switcher !== -34) {
        width$6 = bad_input("no dot or exponent part found in float token");
      } else {
      ...
      width$6 = switcher > 31 || switcher < 1 ? width$5 : bad_input("no dot or exponent part found in float token");
    }
    if (width$6 === 0 || end_of_input(ib)) {
      return width$6;
    }
...
function char_for_decimal_code(c0, c1, c2) {
  ...
  if (c < 0 || c > 255) {
    return bad_input(Curry._3(Printf.sprintf(/* Format */[
                        /* String_literal */Block.__(11, [
...
function scan_caml_char(width, ib) {
  var find_stop = function (width) {
    var c = check_next_char("a Char", width, ib);
    if (c !== 39) {
      return bad_input(character_mismatch_err(/* "'" */39, c));
    } else {
      return ignore_char(width, ib);
    }
  };
...
function scan_caml_string(width, ib) {
  ...
  var c = checked_peek_char(ib);
  if (c !== 34) {
    return bad_input(character_mismatch_err(/* "\"" */34, c));
  } else {
...
function scan_chars_in_char_set(char_set, scan_indic, width, ib) {
  ...
  if (scan_indic === ci) {
    ...
    return bad_input(character_mismatch_err(scan_indic, ci));
  }
}
    ...
    switch (fmt.tag | 0) {
      ...
      case /* Bool */9 :
          var scan$9 = function (param, param$1, ib) {
            var c = checked_peek_char(ib);
            var m = c !== 102 ? (
                c !== 116 ? bad_input(Curry._1(Printf.sprintf(/* Format */[
                                /* String_literal */Block.__(11, [
                                    "the character ",
                                    /* Caml_char */Block.__(1, [/* String_literal */Block.__(11, [
...
function kscanf(ib, ef, param) {
  ...
  var k = function (readers, f) {
    ...
    try {
      ...
      if (exc.ExceptionID === Scan_failure.ExceptionID || exc.ExceptionID === /* Failure */-2 || exc.ExceptionID === /* End_of_file */-4) {
        args = /* Exc */Block.__(1, [exc]);
      } else {
        if (exc.ExceptionID === /* Invalid_argument */-3) {
