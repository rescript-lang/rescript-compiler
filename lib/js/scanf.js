...
function from_string(s) {
  ...
  var next = function (param) {
    ...
    var c = Caml_string.get(s, i[/* contents */0]);
...
var file_buffer_size = [/* contents */1024];
...
function from_ic(scan_close_ic, iname, ic) {
  var len = file_buffer_size[/* contents */0];
  var buf = Caml_bytes.caml_create_bytes(len);
  var i = [/* contents */0];
  var lim = [/* contents */0];
  var eof = [/* contents */false];
  var next = function (param) {
    if (i[/* contents */0] < lim[/* contents */0]) {
      var c = Caml_bytes.get(buf, i[/* contents */0]);
      i[/* contents */0] = i[/* contents */0] + 1 | 0;
      return c;
    } else {
      if (eof[/* contents */0]) {
      ...
      lim[/* contents */0] = Pervasives.input(ic, buf, 0, len);
      if (lim[/* contents */0] === 0) {
        eof[/* contents */0] = true;
...
function memo_from_ic(scan_close_ic, ic) {
  try {
    return List.assq(ic, memo[/* contents */0]);
  }
  catch (exn){
