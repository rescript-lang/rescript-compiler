    ...
    if (typeof fmt === "number") {
      ...
      switch (fmt.tag | 0) {
        ...
        case 14 : 
            ...
            var fmt$2;
            try {
              var match$2 = CamlinternalFormat.fmt_ebb_of_string(undefined, s$1);
              var match$3 = CamlinternalFormat.fmt_ebb_of_string(undefined, s$1);
              var fmt$prime$1 = CamlinternalFormat.type_format(match$3[0], CamlinternalFormatBasics.erase_rel(CamlinternalFormat.symm(fmtty)));
              var fmt$3 = CamlinternalFormat.type_format(match$2[0], CamlinternalFormatBasics.erase_rel(fmtty));
              fmt$prime = fmt$prime$1;
              fmt$2 = fmt$3;
              exit$1 = 1;
            }
            catch (raw_exn$1){
            ...
            if (exit$1 === 1) {
              return /* Cons */[
                      ...
                      make_scanf(ib, CamlinternalFormatBasics.concat_fmt(fmt$prime, fmt[2]), readers)
                    ];
            }
            break;
        case 15 : 
        ...
        case 23 : 
            var match$6 = CamlinternalFormat.param_format_of_ignored_format(fmt[0], fmt[1]);
            var match$7 = make_scanf(ib, match$6[0], readers);
            if (match$7) {
              return match$7[1];
            } else {
              throw [
