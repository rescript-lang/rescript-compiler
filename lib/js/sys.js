...
function getenv_opt(s) {
  try {
    return Caml_sys.caml_sys_getenv(s);
  }
  catch (exn){
...
function enable_runtime_warnings(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ml_enable_runtime_warnings");
}

function runtime_warnings_enabled(prim) {
  return Caml_missing_polyfill.not_implemented("caml_ml_runtime_warnings_enabled");
}
