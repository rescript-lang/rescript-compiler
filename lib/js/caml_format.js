    ...
    switch (match) {
      ...
      case "g" :
          ...
          if (exp < -4 || x$1 >= 1e21 || x$1.toFixed().length > prec$1) {
            var i$1 = j - 1 | 0;
            while(s.charCodeAt(i$1) === /* '0' */48) {
              i$1 = i$1 - 1 | 0;
            };
            if (s.charCodeAt(i$1) === /* '.' */46) {
              i$1 = i$1 - 1 | 0;
            }
            s = s.slice(0, i$1 + 1 | 0) + s.slice(j);
            var i$2 = s.length;
            if (s.charCodeAt(i$2 - 3 | 0) === /* 'e' */101) {
            ...
            if (p !== 0) {
              var k = s.length - 1 | 0;
              while(s.charCodeAt(k) === /* '0' */48) {
                k = k - 1 | 0;
              };
              if (s.charCodeAt(k) === /* '.' */46) {
                k = k - 1 | 0;
              }
              s = s.slice(0, k + 1 | 0);
            }
