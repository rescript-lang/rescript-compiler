...
function caml_int_of_string(s) {
  ...
  if (d < 0 || d >= base) {
    throw [
          Caml_builtin_exceptions.failure,"int_of_string"
        ];
  }
...
function caml_int64_of_string(s) {
  ...
  if (Caml_int64.lt(d, /* int64 */[
    ...
    throw [
          Caml_builtin_exceptions.failure,"int64_of_string"
        ];
  }
  var aux = function (_acc, _k) {
    while(true) {
...
function parse_format(fmt) {
  ...
  if (len > 31) {
    throw [
          Caml_builtin_exceptions.invalid_argument,"format_int: format too long"
        ];
  }
  var f = /* record */[
    /* justify */"+",/* signstyle */"-",/* filter */" ",/* alternate : false */0,/* base : Dec */2,/* signedconv : false */0,/* width */0,/* uppercase : false */0,/* sign */1,/* prec */-1,/* conv */"f"
  ];
  var _i = 0;
  while(true) {
    var i = _i;
