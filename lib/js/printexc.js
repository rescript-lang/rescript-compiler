...
function to_string(x) {
  ...
  while(true) {
    ...
    if (x.CamlExt === Caml_builtin_exceptions.out_of_memory) {
      return "Out of memory";
    }
    if (x.CamlExt === Caml_builtin_exceptions.stack_overflow) {
      return "Stack overflow";
    }
    if (x.CamlExt === Caml_builtin_exceptions.match_failure) {
      var match = x._1;
      var $$char = match[2];
      return Curry._5(Printf.sprintf(locfmt), match[0], match[1], $$char, $$char + 5 | 0, "Pattern matching failed");
    }
    if (x.CamlExt === Caml_builtin_exceptions.assert_failure) {
      var match$1 = x._1;
      var $$char$1 = match$1[2];
      return Curry._5(Printf.sprintf(locfmt), match$1[0], match$1[1], $$char$1, $$char$1 + 6 | 0, "Assertion failed");
    }
    if (x.CamlExt === Caml_builtin_exceptions.undefined_recursive_module) {
      var match$2 = x._1;
