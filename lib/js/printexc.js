...
function raw_backtrace_length(prim) {
  return Caml_missing_polyfill.not_implemented("caml_raw_backtrace_length");
}

function get_raw_backtrace_slot(prim, prim$1) {
  return Caml_missing_polyfill.not_implemented("caml_raw_backtrace_slot");
}

function get_raw_backtrace_next_slot(prim) {
  return Caml_missing_polyfill.not_implemented("caml_raw_backtrace_next_slot");
}
