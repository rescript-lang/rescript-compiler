...
function bal(l, x, d, r) {
  var match = l === null ? /* None */0 : [l];
  var hl = match !== /* None */0 ? l.height : 0;
  var match$1 = r === null ? /* None */0 : [r];
  var hr = match$1 !== /* None */0 ? r.height : 0;
  if (hl > (hr + 2 | 0)) {
    var ll = l.left;
    var lv = l.key;
    var ld = l.value;
...
function concat(t1, t2) {
  var match = t1 === null ? /* None */0 : [t1];
  var match$1 = t2 === null ? /* None */0 : [t2];
  if (match !== /* None */0) {
    if (match$1 !== /* None */0) {
      var kr = [t2.key];
      var vr = [t2.value];
...
function keepMapU(n, p) {
  ...
  if (match !== /* None */0) {
    ...
    if (pvd !== /* None */0) {
      return join(newLeft, v, pvd[/* None */0], newRight);
    } else {
      return concat(newLeft, newRight);
    }
  } else {
...
function partitionSharedU(n, p) {
  ...
  if (match !== /* None */0) {
    var key = n.key;
    var value = n.value;
    var match$1 = partitionSharedU(n.left, p);
    var lf = match$1[1];
    var lt = match$1[0];
    var pvd = p(key, value);
    var match$2 = partitionSharedU(n.right, p);
    var rf = match$2[1];
    var rt = match$2[0];
    if (pvd) {
      return /* tuple */[
...
function lengthNode(n) {
  ...
  var r = n.right;
  var match = l === null ? /* None */0 : [l];
  var sizeL = match !== /* None */0 ? lengthNode(l) : 0;
  var match$1 = r === null ? /* None */0 : [r];
  var sizeR = match$1 !== /* None */0 ? lengthNode(r) : 0;
...
function fillArrayKey(_n, _i, arr) {
  while(true) {
    ...
    var r = n.right;
    var match = l === null ? /* None */0 : [l];
    var next = match !== /* None */0 ? fillArrayKey(l, i, arr) : i;
    arr[next] = v;
    var rnext = next + 1 | 0;
    var match$1 = r === null ? /* None */0 : [r];
    if (match$1 !== /* None */0) {
...
function fillArrayValue(_n, _i, arr) {
  while(true) {
    ...
    var r = n.right;
    var match = l === null ? /* None */0 : [l];
    var next = match !== /* None */0 ? fillArrayValue(l, i, arr) : i;
    arr[next] = n.value;
    var rnext = next + 1 | 0;
    var match$1 = r === null ? /* None */0 : [r];
    if (match$1 !== /* None */0) {
...
function fillArray(_n, _i, arr) {
  while(true) {
    ...
    var r = n.right;
    var match = l === null ? /* None */0 : [l];
    var next = match !== /* None */0 ? fillArray(l, i, arr) : i;
    arr[next] = /* tuple */[
      v,
      n.value
    ];
