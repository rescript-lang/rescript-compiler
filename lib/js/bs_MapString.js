  ...
  if (hl > (hr + 2 | 0)) {
    if (l) {
      ...
      if (height(ll) >= height(lr)) {
        ...
        throw new Error("File \"bs_MapString.ml\", line 29, characters 21-27");
      }
    } else {
      throw new Error("File \"bs_MapString.ml\", line 23, characters 17-23");
    }
  } else if (hr > (hl + 2 | 0)) {
    if (r) {
      var rr = r[3];
      ...
      if (height(rr) >= height(rl)) {
        ...
        throw new Error("File \"bs_MapString.ml\", line 41, characters 21-27");
      }
    } else {
      throw new Error("File \"bs_MapString.ml\", line 35, characters 17-23");
    }
  } else {
    return /* Node */[
            l,
...
function min_bindingAssert(_param) {
  while(true) {
    ...
    if (param) {
      ...
      throw new Error("File \"bs_MapString.ml\", line 78, characters 15-21");
    }
  };
}
...
function remove_min_binding(param) {
  if (param) {
    ...
    throw new Error("File \"bs_MapString.ml\", line 93, characters 15-21");
  }
}
...
function merge(f, s1, s2) {
  ...
  if (exit === 1) {
    if (s2) {
      ...
      throw new Error("File \"bs_MapString.ml\", line 220, characters 6-12");
    }
  }
