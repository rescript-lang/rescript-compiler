...
function filterMapInplaceBucket(f, h, i, _prec, _cell) {
  while(true) {
    ...
    if (match !== /* None */0) {
      var match$1 = prec === undefined ? /* None */0 : [prec];
      if (match$1 !== /* None */0) {
        cell.next = cell;
      } else {
        h.buckets[i] = cell;
      }
      cell.value = match[/* None */0];
      var match$2 = n === undefined ? /* None */0 : [n];
      if (match$2 !== /* None */0) {
        _cell = n;
        _prec = cell;
        continue ;
      ...
      h.size = h.size - 1 | 0;
      var match$3 = n === undefined ? /* None */0 : [n];
      if (match$3 !== /* None */0) {
        _cell = n;
        continue ;
      } else {
        var match$4 = prec === undefined ? /* None */0 : [prec];
        if (match$4 !== /* None */0) {
          prec.next = n;
          return /* () */0;
        } else {
...
function keepMapInPlaceU(h, f) {
  ...
  for(var i = 0 ,i_finish = h_buckets.length - 1 | 0; i <= i_finish; ++i){
    var v = h_buckets[i];
    var match = v === undefined ? /* None */0 : [v];
    if (match !== /* None */0) {
