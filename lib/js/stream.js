  ...
  while(true) {
    ...
    if (typeof d === "string") {
      ...
      switch (/* XXX */d.tag) {
        ...
        case "Sapp" :
            var d2 = d.Arg1;
            var match = get_data(count, d.Arg0);
        ...
        case "Slazy" :
            _d = CamlinternalLazy.force(d.Arg0);
            continue ;
        case "Sgen" :
            var g = d.Arg0;
            ...
            if (match$1 !== undefined) {
              ...
              if (match$2 !== undefined) {
                ...
                return /* constructor */{
                        tag: "Scons",
                        Arg0: Caml_option.valFromOption(match$2),
                        Arg1: d
                      };
              } else {
                return "Sempty";
              ...
              if (match$3 !== undefined) {
                return /* constructor */{
                        tag: "Scons",
                        Arg0: Caml_option.valFromOption(match$3),
                        Arg1: d
                      };
              } else {
  ...
  while(true) {
    ...
    if (typeof match === "string") {
      ...
      switch (/* XXX */match.tag) {
        case "Scons" :
            return Caml_option.some(match.Arg0);
        case "Sapp" :
            ...
            if (typeof d === "string") {
              ...
              s[1] = d;
              return Caml_option.some(d.Arg0);
            } else {
              throw [
                    Caml_builtin_exceptions.assert_failure,
                    /* tuple */[
        ...
        case "Slazy" :
            s[1] = CamlinternalLazy.force(match.Arg0);
            continue ;
        case "Sgen" :
            var g = match.Arg0;
            var match$1 = g[/* curr */0];
...
function lapp(f, s) {
  return /* record */[
          ...
          /* data : constructor */{
            tag: "Slazy",
            Arg0: Caml_obj.caml_lazy_make((function (param) {
                    return /* constructor */{
                            tag: "Sapp",
                            Arg0: Curry._1(f, /* () */0)[/* data */1],
                            Arg1: s[/* data */1]
                          };
                  }))
          }
