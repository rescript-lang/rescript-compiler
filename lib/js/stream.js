...
function from(f) {
  return /* record */[
          /* count */0,/* data : Sgen */Block.__(3, [/* record */[
                /* curr : None */0,/* func */f
              ]])
        ];
}
...
function of_list(l) {
  return /* record */[
          /* count */0,/* data */List.fold_right(function (x, l) {
                return /* Scons */Block.__(0, [
                          x,l
                        ]);
              }, l, /* Sempty */0)
...
function of_channel(ic) {
  return /* record */[
          /* count */0,/* data : Sbuffio */Block.__(4, [/* record */[
                /* ic */ic,/* buff */new Array(4096),/* len */0,/* ind */0
              ]])
        ];
}
...
function lapp(f, s) {
  return /* record */[
          /* count */0,/* data : Slazy */Block.__(2, [Block.__(246, [function () {
                    return /* Sapp */Block.__(1, [
                              Curry._1(f, /* () */0)[/* data */1],s[/* data */1]
                            ]);
                  }])])
        ];
}
