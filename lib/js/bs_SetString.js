  ...
  if (hl > (hr + 2 | 0)) {
    if (l) {
      ...
      if (height(ll) >= height(lr)) {
        ...
        throw new Error("File \"set.cppo.ml\", line 44, characters 21-27");
      }
    } else {
      throw new Error("File \"set.cppo.ml\", line 38, characters 17-23");
    }
  } else if (hr > (hl + 2 | 0)) {
    if (r) {
      var rr = r[2];
      ...
      if (height(rr) >= height(rl)) {
        ...
        throw new Error("File \"set.cppo.ml\", line 56, characters 21-27");
      }
    } else {
      throw new Error("File \"set.cppo.ml\", line 50, characters 17-23");
    }
  } else {
    return /* Node */[
            l,
...
function min_eltAssert(_param) {
  while(true) {
    ...
    if (param) {
      ...
      throw new Error("File \"set.cppo.ml\", line 106, characters 15-21");
    }
  };
}
...
function remove_min_elt(param) {
  if (param) {
    ...
    throw new Error("File \"set.cppo.ml\", line 124, characters 15-21");
  }
}
...
function merge(t1, t2) {
  if (t1) {
    if (t2) {
      return bal(t1, min_eltAssert(t2), remove_min_elt(t2));
    } else {
      return t1;
    }
  } else {
...
function concat(t1, t2) {
  if (t1) {
    if (t2) {
      return join(t1, min_eltAssert(t2), remove_min_elt(t2));
    } else {
      return t1;
    }
  } else {
...
exports.join            = join;
exports.min_eltAssert   = min_eltAssert;
exports.min             = min;
exports.max             = max;
