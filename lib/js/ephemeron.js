...
function MakeSeeded(H) {
  ...
  var prng = Caml_obj.caml_lazy_make((function (param) {
          return Random.State.make_self_init(void 0);
        }));
  var create$1 = function (randomOpt, initial_size) {
    var random = randomOpt !== void 0 ? randomOpt : Hashtbl.is_randomized(void 0);
  ...
  var fold = function (f, h, init) {
    var do_bucket = function (_b, _accu) {
      while(true) {
        ...
        var match = get_key(c);
        var match$1 = get_data(c);
        var accu$1 = match !== void 0 && match$1 !== void 0 ? Curry._3(f, Caml_option.valFromOption(match), Caml_option.valFromOption(match$1), accu) : accu;
        _accu = accu$1;
        _b = b[2];
        continue ;
      };
...
function MakeSeeded$2(H) {
  ...
  var equal = function (c, k) {
    ...
    while(true) {
      ...
      var match = Obj.Ephemeron.get_key(c, i);
      if (match === void 0) {
        return /* EDead */2;
      }
      if (!Curry._2(H.equal, Caml_array.caml_array_get(k, i), Caml_option.valFromOption(match))) {
        return /* EFalse */1;
      }
      _i = i - 1 | 0;
      continue ;
  ...
  var get_key = function (c) {
    ...
    while(true) {
      ...
      Caml_array.caml_array_set(a, i, Caml_option.valFromOption(match$1));
      _i = i - 1 | 0;
      continue ;
    };
  };
...
function Make$2(H) {
  ...
  var equal$1 = function (c, k) {
    ...
    while(true) {
      ...
      if (!Curry._2(equal, Caml_array.caml_array_get(k, i), Caml_option.valFromOption(match))) {
        return /* EFalse */1;
      }
      _i = i - 1 | 0;
      continue ;
