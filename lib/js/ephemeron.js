...
function MakeSeeded(H) {
  ...
  var equal = function (c, k) {
    var match = get_key(c);
    if (match !== undefined) {
      if (Curry._2(H[/* equal */0], k, Js_primitive.valFromOption(match))) {
        return /* ETrue */0;
      } else {
        return /* EFalse */1;
      }
    ...
    var do_bucket = function (_param) {
      while(true) {
        ...
        if (param) {
          ...
          if (match !== undefined) {
            if (match$1 !== undefined) {
              Curry._2(f, Js_primitive.valFromOption(match), Js_primitive.valFromOption(match$1));
            }
    ...
    var do_bucket = function (_b, _accu) {
      while(true) {
        ...
        if (b) {
          ...
          var match = get_key(c);
          var match$1 = get_data(c);
          var accu$1 = match !== undefined && match$1 !== undefined ? Curry._3(f, Js_primitive.valFromOption(match), Js_primitive.valFromOption(match$1), accu) : accu;
          _accu = accu$1;
          _b = b[2];
          continue ;
        } else {
        ...
        if (param) {
          ...
          if (match !== undefined) {
            if (match$1 !== undefined) {
              ...
              var match$2 = Curry._2(f, k, Js_primitive.valFromOption(match$1));
              if (match$2 !== undefined) {
                set_key_data(c, k, Js_primitive.valFromOption(match$2));
                return /* Cons */[
                        param[0],
                        c,
                        do_bucket(rest)
...
function Make(H) {
  ...
  var equal$1 = function (c, k) {
    var match = get_key(c);
    if (match !== undefined) {
      if (Curry._2(equal, k, Js_primitive.valFromOption(match))) {
        return /* ETrue */0;
      } else {
        return /* EFalse */1;
      }
...
function MakeSeeded$1(H1, H2) {
  ...
  var equal = function (c, param) {
    ...
    if (match !== undefined && match$1 !== undefined) {
      if (Curry._2(H1[/* equal */0], param[0], Js_primitive.valFromOption(match)) && Curry._2(H2[/* equal */0], param[1], Js_primitive.valFromOption(match$1))) {
        return /* ETrue */0;
      } else {
        return /* EFalse */1;
      }
...
function Make$1(H1, H2) {
  ...
  var include = (function (param) {
        ...
        var equal$2 = function (c, param$1) {
          ...
          var match$1 = get_key2(c);
          if (match !== undefined && match$1 !== undefined) {
            if (Curry._2(/* equal */equal, param$1[0], Js_primitive.valFromOption(match)) && Curry._2(param[/* equal */0], param$1[1], Js_primitive.valFromOption(match$1))) {
              return /* ETrue */0;
            } else {
              return /* EFalse */1;
            }
              ...
              if (param) {
                ...
                if (match !== undefined) {
                  if (match$1 !== undefined) {
                    ...
                    var match$2 = Curry._2(f, k, Js_primitive.valFromOption(match$1));
                    if (match$2 !== undefined) {
                      Curry._3(H[/* set_key_data */5], c, k, Js_primitive.valFromOption(match$2));
                      return /* Cons */[
                              param[0],
                              c,
                              do_bucket(rest)
...
function MakeSeeded$2(H) {
    ...
    if (len !== len$prime) {
      ...
      while(true) {
        ...
        if (i < 0) {
          ...
          if (match !== undefined) {
            if (Curry._2(H[/* equal */0], Caml_array.caml_array_get(k$1, i), Js_primitive.valFromOption(match))) {
              _i = i - 1 | 0;
              continue ;
            } else {
              return /* EFalse */1;
  ...
  var get_key$2 = function (c) {
    ...
    if (len === 0) {
      ...
      if (match !== undefined) {
        var a = Caml_array.caml_make_vect(len, Js_primitive.valFromOption(match));
        var a$1 = a;
        var _i = len - 1 | 0;
        while(true) {
          var i = _i;
          if (i < 1) {
            ...
            if (match$1 !== undefined) {
              Caml_array.caml_array_set(a$1, i, Js_primitive.valFromOption(match$1));
              _i = i - 1 | 0;
              continue ;
            } else {
              return undefined;
    ...
    if (len !== len$prime) {
      ...
      while(true) {
        ...
        if (i < 0) {
          ...
          var match = get_key$1(c$1, i);
          if (match !== undefined) {
            if (Curry._2(equal, Caml_array.caml_array_get(k$1, i), Js_primitive.valFromOption(match))) {
              _i = i - 1 | 0;
              continue ;
            } else {
              return /* EFalse */1;
            ...
            if (param) {
              ...
              if (match !== undefined) {
                if (match$1 !== undefined) {
                  ...
                  var match$2 = Curry._2(f, k, Js_primitive.valFromOption(match$1));
                  if (match$2 !== undefined) {
                    Curry._3(H_005, c, k, Js_primitive.valFromOption(match$2));
                    return /* Cons */[
                            param[0],
                            c,
                            Curry._1(do_bucket, rest)
