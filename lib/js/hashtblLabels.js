...
function MakeSeeded(H) {
  ...
  var add$1 = function (tbl, key, data) {
    Curry._3(add, tbl, key, data);
    
  };
  var replace$1 = function (tbl, key, data) {
    Curry._3(replace, tbl, key, data);
    
  };
  var iter$1 = function (f, tbl) {
    Curry._2(iter, (function (key, data) {
            Curry._2(f, key, data);
