...
function iter(f, tbl) {
  return Hashtbl.iter(Curry.__2(f), tbl);
}

function filter_map_inplace(f, tbl) {
  return Hashtbl.filter_map_inplace(Curry.__2(f), tbl);
}
...
function MakeSeeded(H) {
  ...
  var iter$1 = function (f, tbl) {
    return Curry._2(iter, Curry.__2(f), tbl);
  };
  var filter_map_inplace$1 = function (f, tbl) {
    return Curry._2(filter_map_inplace, Curry.__2(f), tbl);
  };
