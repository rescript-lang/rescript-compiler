...
function mul(x, y) {
  return /* float array */[
          x[/* re */0] * y[/* re */0] - x[/* im */1] * y[/* im */1],x[/* re */0] * y[/* im */1] + x[/* im */1] * y[/* re */0]
        ];
}
...
function div(x, y) {
  if (Math.abs(y[/* re */0]) >= Math.abs(y[/* im */1])) {
    ...
    return /* float array */[
            (x[/* re */0] + r * x[/* im */1]) / d,(x[/* im */1] - r * x[/* re */0]) / d
          ];
  }
  else {
    ...
    return /* float array */[
            (r$1 * x[/* re */0] + x[/* im */1]) / d$1,(r$1 * x[/* im */1] - x[/* re */0]) / d$1
          ];
  }
}
...
function exp(x) {
  ...
  return /* float array */[
          e * Math.cos(x[/* im */1]),e * Math.sin(x[/* im */1])
        ];
}

function log(x) {
  return /* float array */[
          Math.log(norm(x)),Math.atan2(x[/* im */1], x[/* re */0])
        ];
}
