...
function filterMap(h, f) {
  Bs_internalBuckets.filterMapInplace0(h, f);
  return h;
}
...
var forEach = Bs_internalBuckets.iter0;

var reduce = Bs_internalBuckets.fold0;

var filterMapDone = Bs_internalBuckets.filterMapInplace0;
