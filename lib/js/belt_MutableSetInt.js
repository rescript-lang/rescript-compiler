...
function intersect(dataa, datab) {
  ...
  if (dataa$1 !== null) {
    if (datab$1 !== null) {
      ...
      var tmp = (dataa$1.value, new Array(totalSize));
      ...
      if (tmp[sizea - 1 | 0] < tmp[sizea] || tmp[totalSize - 1 | 0] < tmp[0]) {
        ...
        var tmp2 = (dataa$1.value, new Array(sizea < sizeb ? sizea : sizeb));
  ...
  if (dataa$1 !== null) {
    if (datab$1 !== null) {
      ...
      if (tmp[sizea - 1 | 0] < tmp[sizea] || tmp[totalSize - 1 | 0] < tmp[0]) {
        ...
        var tmp2 = (dataa$1.value, new Array(sizea));
  ...
  if (dataa$1 !== null) {
    if (datab$1 !== null) {
      ...
      if (tmp[sizea - 1 | 0] < tmp[sizea]) {
        ...
        var tmp2 = (dataa$1.value, new Array(totalSize));
