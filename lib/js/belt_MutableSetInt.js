...
function removeCheck0(nt, x, removed) {
  ...
  if (x === k) {
    ...
    if ((
      ...
      nt.left = removeCheck0(match$2, x, removed);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
    ...
    if ((
      ...
      nt.right = removeCheck0(match$3, x, removed);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
...
function intersect(dataa, datab) {
  ...
  var match = dataa$1 === null ? /* None */0 : [dataa$1];
  var match$1 = datab$1 === null ? /* None */0 : [datab$1];
  if (match !== /* None */0) {
    if (match$1 !== /* None */0) {
