...
function splitAux(x, n) {
  ...
  if (x === v) {
    ...
    if (match !== /* None */0) {
      var match$1 = splitAux(x, l);
      return /* tuple */[
              match$1[0],
              match$1[1],
              Belt_internalAVLtree.join(match$1[2], v, d, r)
            ];
    } else {
      return /* tuple */[
    ...
    var match$2 = r === null ? /* None */0 : [r];
    if (match$2 !== /* None */0) {
      var match$3 = splitAux(x, r);
      return /* tuple */[
              Belt_internalAVLtree.join(l, v, d, match$3[0]),
              match$3[1],
              match$3[2]
            ];
    } else {
...
function mergeU(s1, s2, f) {
  ...
  var exit = 0;
  if (match !== /* None */0) {
    var match$2 = s2 === null ? /* None */0 : [s2];
    if (s1.height >= (
        match$2 !== /* None */0 ? s2.height : 0
      )) {
      var l1 = s1.left;
      var v1 = s1.key;
      var d1 = s1.value;
      var r1 = s1.right;
      var match$3 = split(v1, s2);
      return Belt_internalAVLtree.concatOrJoin(mergeU(l1, match$3[0], f), v1, f(v1, /* Some */[d1], match$3[1]), mergeU(r1, match$3[2], f));
    } else {
      exit = 1;
    }
  ...
  if (exit === 1) {
    if (match$1 !== /* None */0) {
      ...
      var d2 = s2.value;
      var r2 = s2.right;
      var match$4 = split(v2, s1);
      return Belt_internalAVLtree.concatOrJoin(mergeU(match$4[0], l2, f), v2, f(v2, match$4[1], /* Some */[d2]), mergeU(match$4[2], r2, f));
    } else {
