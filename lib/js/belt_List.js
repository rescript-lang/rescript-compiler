...
function copyAuxWithMap2(f, _cellX, _cellY, _prec) {
  while(true) {
    ...
    let next = {
      hd: Curry._2(f, cellX.hd, cellY.hd),
      tl: /* [] */0
    };
    prec.tl = next;
    _prec = next;
...
function reduceReverseUnsafeU(l, accu, f) {
  if (l) {
    return Curry._2(f, reduceReverseUnsafeU(l.tl, accu, f), l.hd);
  } else {
    return accu;
  }
}
...
function reduceWithIndexU(l, acc, f) {
  ...
  while(true) {
    ...
    _i = i + 1 | 0;
    _acc = Curry._3(f, acc$1, l$1.hd, i);
    _l = l$1.tl;
    continue;
  };
}
...
function reduceReverse2UnsafeU(l1, l2, accu, f) {
  if (l1 && l2) {
    return Curry._3(f, reduceReverse2UnsafeU(l1.tl, l2.tl, accu, f), l1.hd, l2.hd);
  } else {
    return accu;
  }
}
