...
"use strict";
define(["require", "exports", './caml_string', './caml_exceptions'], function (require, exports, caml_string_1, caml_exceptions_1) {
    ...
    function caml_sys_open(name, flags /* open_flag list*/, _perms) {
        return;
        //var f = {};
        //while(flags){
        //  switch(flags[1]){
    ...
    function caml_std_output(chan, s) {
        ...
        if (offset + slen >= clen) {
            var new_str = caml_string_1.caml_create_string(offset + slen);
            caml_string_1.caml_blit_string(chan.file.data, 0, new_str, 0, clen);
            caml_string_1.caml_blit_string(str, 0, new_str, offset, slen);
    ...
    function caml_ml_input(chan, s, i, l) {
        ...
        if (l2 < l)
            l = l2;
        caml_string_1.caml_blit_string(chan.file.data, chan.offset, s, i, l);
        chan.offset += l;
        return l;
    }
    ...
    function caml_ml_flush(oc) {
        if (!oc.opened)
            caml_exceptions_1.caml_raise_sys_error("Cannot flush a closed channel");
        if (oc.buffer == "")
            return 0;
        if (oc.output) {
    ...
    function caml_ml_output(oc, buffer, offset, len) {
        ...
        if (typeof buffer === 'string') {
            ...
            string = caml_string_1.bytes_to_string(buffer);
        }
