...
'use strict';
define(["exports", "../stdlib/caml_obj", "../stdlib/caml_builtin_exceptions", "./bytes", "../stdlib/caml_exceptions", "./pervasives", "../stdlib/caml_format", "../stdlib/block", "./sys", "../stdlib/curry", "./printf", "./buffer", "./string", "./list", "../stdlib/caml_string"],
