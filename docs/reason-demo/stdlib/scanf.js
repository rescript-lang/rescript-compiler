...
'use strict';
define(["exports", "../stdlib/caml_builtin_exceptions", "./bytes", "./pervasives", "../stdlib/caml_exceptions", "../stdlib/caml_format", "../stdlib/caml_int32", "../stdlib/block", "../stdlib/curry", "./printf", "./camlinternalFormatBasics", "./buffer", "./string", "../stdlib/caml_string", "./list", "./camlinternalFormat"],
