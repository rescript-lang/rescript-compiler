...
rule optc
    command = BS_NATIVE=${!!process.env.BS_NATIVE} $ocamlopt -safe-string -I +compiler-libs -opaque ${includes} -g -linscan -w A-4-9-27-40..42-30-48-50 -warn-error A -absname -c $in
    description = $out : $in
rule archive
